...
class TestPanoRenderPreviewConsumers(unittest.TestCase):
    def test_runtime_preview_uses_render_core_descriptor(self):
        ...
        self.assertIn("if (!node.__panoDomRuntimeCore) node.__panoDomRuntimeCore = createPanoramaRenderCore();", runtime_js)
        ...
        self.assertIn("node.__panoDomRuntimeCore.syncState(", runtime_js)
