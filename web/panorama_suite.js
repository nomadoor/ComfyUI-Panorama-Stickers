...
const st = {}, yi = [], $n = () => {
}, qf = () => !1, es = (e) => e.charCodeAt(0) === 111 && e.charCodeAt(1) === 110 && // uppercase letter
(e.charCodeAt(2) > 122 || e.charCodeAt(2) < 97), ts = (e) => e.startsWith("onUpdate:"), Yt = Object.assign, Zl = (e, t) => {
  const n = e.indexOf(t);
  n > -1 && e.splice(n, 1);
}, gg = Object.prototype.hasOwnProperty, Ze = (e, t) => gg.call(e, t), Oe = Array.isArray, _i = (e) => ka(e) === "[object Map]", Yf = (e) => ka(e) === "[object Set]", Vu = (e) => ka(e) === "[object Date]", je = (e) => typeof e == "function", wt = (e) => typeof e == "string", Bn = (e) => typeof e == "symbol", rt = (e) => e !== null && typeof e == "object", Xf = (e) => (rt(e) || je(e)) && je(e.then) && je(e.catch), Zf = Object.prototype.toString, ka = (e) => Zf.call(e), vg = (e) => ka(e).slice(8, -1), Jf = (e) => ka(e) === "[object Object]", Jl = (e) => wt(e) && e !== "NaN" && e[0] !== "-" && "" + parseInt(e, 10) === e, na = /* @__PURE__ */ Xl(
...
let Hu;
const is = () => Hu || (Hu = typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : typeof window < "u" ? window : typeof global < "u" ? global : {});
function Nt(e) {
  if (Oe(e)) {
    const t = {};
    for (let n = 0; n < e.length; n++) {
      const i = e[n], a = wt(i) ? Ng(i) : Nt(i);
      if (a)
        for (const c in a)
          t[c] = a[c];
    }
...
function Ng(e) {
  const t = {};
  return e.replace(Sg, "").split(xg).forEach((n) => {
    if (n) {
      const i = n.split(wg);
...
const Mg = "itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly", kg = /* @__PURE__ */ Xl(Mg);
function ed(e) {
  return !!e || e === "";
}
function Pg(e, t) {
...
const td = (e) => !!(e && e.__v_isRef === !0), Mt = (e) => wt(e) ? e : e == null ? "" : Oe(e) || rt(e) && (e.toString === Zf || !je(e.toString)) ? td(e) ? Mt(e.value) : JSON.stringify(e, nd, 2) : String(e), nd = (e, t) => td(t) ? nd(e, t.value) : _i(t) ? {
...
} : Bn(t) ? il(t) : rt(t) && !Oe(t) && !Jf(t) ? String(t) : t, il = (e, t = "") => {
  var n;
  return (
...
class rd {
  ...
  run() {
    if (!(this.flags & 1))
      return this.fn();
    this.flags |= 2, ju(this), od(this);
    const t = ct, n = An;
    ct = this, An = !0;
    try {
      return this.fn();
    } finally {
      sd(this), ct = t, An = n, this.flags &= -3;
    }
  }
  stop() {
    if (this.flags & 1) {
      for (let t = this.deps; t; t = t.nextDep)
        nc(t);
      this.deps = this.depsTail = void 0, ju(this), this.onStop && this.onStop(), this.flags &= -2;
    }
  }
  trigger() {
...
function sd(e) {
  ...
  for (; i; ) {
    const a = i.prevDep;
    i.version === -1 ? (i === n && (n = a), nc(i), Tg(i)) : t = i, i.dep.activeLink = i.prevActiveLink, i.prevActiveLink = void 0, i = a;
  }
...
function ld(e) {
  if (e.flags & 4 && !(e.flags & 16) || (e.flags &= -17, e.globalVersion === ma) || (e.globalVersion = ma, !e.isSSR && e.flags & 128 && (!e.deps && !e._dirty || !Cl(e))))
    return;
  e.flags |= 2;
  const t = e.dep, n = ct, i = An;
  ct = e, An = !0;
  try {
    od(e);
...
class rc {
  ...
  track(t) {
    if (!ct || !An || ct === this.computed)
      return;
    let n = this.activeLink;
    if (n === void 0 || n.sub !== ct)
      n = this.activeLink = new Ig(ct, this), ct.deps ? (n.prevDep = ct.depsTail, ct.depsTail.nextDep = n, ct.depsTail = n) : ct.deps = ct.depsTail = n, ud(n);
...
function ui(e) {
  ...
  return t === e ? t : (Kt(t, "iterate", ga), /* @__PURE__ */ yn(e) ? t : t.map(Tn));
}
function as(e) {
...
const Eg = {
  __proto__: null,
  [Symbol.iterator]() {
    return ol(this, Symbol.iterator, (e) => On(this, e));
  },
  concat(...e) {
  ...
  entries() {
    return ol(this, "entries", (e) => (e[1] = On(this, e[1]), e));
  },
  every(e, t) {
  ...
  values() {
    return ol(this, "values", (e) => On(this, e));
  }
};
function ol(e, t, n) {
  const i = as(e), a = i[t]();
...
const Lg = /* @__PURE__ */ Xl("__proto__,__v_isRef,__isVue"), fd = new Set(
...
class dd {
  ...
  get(t, n, i) {
    ...
    if (n === "__v_isShallow")
      return c;
    if (n === "__v_raw")
      return i === (a ? c ? Kg : gd : c ? md : pd).get(t) || // receiver is not the reactive proxy, but has the same prototype
    ...
    if ((Bn(n) ? fd.has(n) : Lg(n)) || (a || Kt(t, "get", n), c))
      return d;
    if (/* @__PURE__ */ qt(d)) {
...
class hd extends dd {
  ...
  has(t, n) {
    ...
    return (!Bn(n) || !fd.has(n)) && Kt(t, "has", n), i;
  }
  ownKeys(t) {
    return Kt(
      t,
...
const Fg = /* @__PURE__ */ new hd(), Vg = /* @__PURE__ */ new Og(), Hg = /* @__PURE__ */ new hd(!0);
const Il = (e) => e, Qa = (e) => Reflect.getPrototypeOf(e);
function jg(e, t, n) {
  return function(...i) {
    const a = this.__v_raw, c = /* @__PURE__ */ Xe(a), f = _i(c), d = e === "entries" || e === Symbol.iterator && f, h = e === "keys" && f, v = a[e](...i), y = n ? Il : t ? Mi : Tn;
    return !t && Kt(
      c,
      "iterate",
      h ? Tl : jr
...
function zg(e, t) {
  const n = {
    get(a) {
      ...
      const { has: h } = Qa(f), v = t ? Il : e ? Mi : Tn;
      if (h.call(f, a))
        return v(c.get(a));
      if (h.call(f, d))
        return v(c.get(d));
    ...
    forEach(a, c) {
      const f = this, d = f.__v_raw, h = /* @__PURE__ */ Xe(d), v = t ? Il : e ? Mi : Tn;
...
const pd = /* @__PURE__ */ new WeakMap(), md = /* @__PURE__ */ new WeakMap(), gd = /* @__PURE__ */ new WeakMap(), Kg = /* @__PURE__ */ new WeakMap();
function Gg(e) {
  switch (e) {
    case "Object":
    case "Array":
...
function Wg(e) {
  return e.__v_skip || !Object.isExtensible(e) ? 0 : Gg(vg(e));
}
// @__NO_SIDE_EFFECTS__
function os(e) {
...
function Yg(e) {
  return !Ze(e, "__v_skip") && Object.isExtensible(e) && Qf(e, "__v_skip", !0), e;
}
const Tn = (e) => rt(e) ? /* @__PURE__ */ os(e) : e, Mi = (e) => rt(e) ? /* @__PURE__ */ El(e) : e;
// @__NO_SIDE_EFFECTS__
function qt(e) {
...
function Xg(e, t) {
  return /* @__PURE__ */ qt(e) ? e : new Zg(e, t);
}
class Zg {
  constructor(t, n) {
    this.dep = new rc(), this.__v_isRef = !0, this.__v_isShallow = !1, this._rawValue = n ? t : /* @__PURE__ */ Xe(t), this._value = n ? t : Tn(t), this.__v_isShallow = n;
  }
  get value() {
...
function vd(e) {
  return /* @__PURE__ */ zr(e) ? e : new Proxy(e, Jg);
}
class Qg {
  constructor(t, n, i) {
    this.fn = t, this.setter = n, this._value = void 0, this.dep = new rc(this), this.__v_isRef = !0, this.deps = void 0, this.depsTail = void 0, this.flags = 16, this.globalVersion = ma - 1, this.next = void 0, this.effect = this, this.__v_isReadonly = !n, this.isSSR = i;
  }
  /**
   * @internal
   */
...
let Fr;
function t0(e, t = !1, n = Fr) {
  if (n) {
    let i = Eo.get(n);
    i || Eo.set(n, i = []), i.push(e);
  }
}
function n0(e, t, n = st) {
  const { immediate: i, deep: a, once: c, scheduler: f, augmentJob: d, call: h } = n, v = (T) => a ? T : /* @__PURE__ */ yn(T) || a === !1 || a === 0 ? rr(T, 1) : rr(T);
  let y, p, w, S, C = !1, M = !1;
  if (/* @__PURE__ */ qt(e) ? (p = () => e.value, C = /* @__PURE__ */ yn(e)) : /* @__PURE__ */ zr(e) ? (p = () => v(e), C = !0) : Oe(e) ? (M = !0, C = e.some((T) => /* @__PURE__ */ zr(T) || /* @__PURE__ */ yn(T)), p = () => e.map((T) => {
    if (/* @__PURE__ */ qt(T))
      return T.value;
    if (/* @__PURE__ */ zr(T))
      return v(T);
  ...
  const I = (T) => {
    if (!(!(y.flags & 1) || !y.dirty && !T))
      if (t) {
        const $ = y.run();
        if (a || C || (M ? $.some((X, oe) => Hn(X, D[oe])) : Hn($, D))) {
          w && w();
          const X = Fr;
          Fr = y;
          try {
  ...
  return d && d(I), y = new rd(p), y.scheduler = f ? () => f(I, !1) : I, S = (T) => t0(T, !1, y), w = y.onStop = () => {
    const T = Eo.get(y);
    if (T) {
      if (h)
        h(T, 4);
...
function lc(e) {
  if (!(e.flags & 1)) {
    ...
    !(e.flags & 2) && t >= va(n) ? Jt.push(e) : Jt.splice(i0(t), 0, e), e.flags |= 1, yd();
  }
}
function yd() {
  Do || (Do = bd.then(xd));
...
function a0(e) {
  Oe(e) ? xi.push(...e) : br && e.id === -1 ? br.splice(hi + 1, 0, e) : e.flags & 1 || (xi.push(e), e.flags |= 1), yd();
}
function $u(e, t, n = Rn + 1) {
  for (; n < Jt.length; n++) {
    const i = Jt[n];
    if (i && i.flags & 2) {
      if (e && i.id !== e.uid)
...
function xd(e) {
  try {
    ...
    Rn = -1, Jt.length = 0, _d(), Do = null, (Jt.length || xi.length) && xd();
  }
}
let dn = null, wd = null;
function Lo(e) {
  const t = dn;
  return dn = e, wd = e && e.type.__scopeId || null, t;
}
function o0(e, t = dn, n) {
  if (!t || e._n)
    return e;
  const i = (...a) => {
    i._d && ef(-1);
...
const l0 = /* @__PURE__ */ Symbol.for("v-scx"), c0 = () => xo(l0);
function wi(e, t, n) {
  return Sd(e, t, n);
}
function Sd(e, t, n = st) {
  ...
  if (ya) {
    if (c === "sync") {
      ...
      return S.stop = $n, S.resume = $n, S.pause = $n, S;
    }
  }
  const y = Wt;
  d.call = (S, C, M) => Un(S, y, C, M);
  let p = !1;
  c === "post" ? d.scheduler = (S) => {
    rn(S, y && y.suspense);
  } : c !== "sync" && (p = !0, d.scheduler = (S, C) => {
    C ? S() : lc(S);
  }), d.augmentJob = (S) => {
...
function u0(e, t, n) {
  const i = this.proxy, a = wt(e) ? e.includes(".") ? Nd(i, e) : () => i[e] : e.bind(i, i);
  let c;
  je(t) ? c = t : (c = t.handler, n = t);
  const f = Ca(this), d = Sd(a, c.bind(i), n);
  return f(), d;
}
function Nd(e, t) {
  const n = t.split(".");
...
const f0 = /* @__PURE__ */ Symbol("_vte"), d0 = (e) => e.__isTeleport, h0 = /* @__PURE__ */ Symbol("_leaveCb");
function uc(e, t) {
...
function aa(e, t, n, i, a = !1) {
  ...
  const c = i.shapeFlag & 4 ? fs(i.component) : i.el, f = a ? null : c, { i: d, r: h } = e, v = t && t.r, y = d.refs === st ? d.refs = {} : d.refs, p = d.setupState, w = /* @__PURE__ */ Xe(p), S = p === st ? qf : (M) => Bu(y, M) ? !1 : Ze(w, M), C = (M, V) => !(V && Bu(y, V));
  if (v != null && v !== h) {
    if (Uu(t), wt(v))
      y[v] = null, S(v) && (p[v] = null);
    else if (/* @__PURE__ */ qt(v)) {
      const M = t;
      C(v, M.k) && (v.value = null), M.k && (y[M.k] = null);
    }
  }
  if (je(h))
    Pa(h, d, 12, [f, y]);
    ...
    if (M || V) {
      const R = () => {
        if (e.f) {
          const D = M ? S(h) ? p[h] : y[h] : C() || !e.k ? h.value : y[e.k];
          if (a)
            Oe(D) && Zl(D, c);
          else if (Oe(D))
            ...
            const I = [c];
            C(h, e.k) && (h.value = I), e.k && (y[e.k] = I);
          }
        } else M ? (y[h] = f, S(h) && (p[h] = f)) : V && (C(h, e.k) && (h.value = f), e.k && (y[e.k] = f));
      };
      if (f) {
        const D = () => {
          R(), Ro.delete(e);
...
const oa = (e) => !!e.type.__asyncLoader, kd = (e) => e.type.__isKeepAlive;
function p0(e, t) {
  Pd(e, "a", t);
}
function m0(e, t) {
...
function Pd(e, t, n = Wt) {
  ...
  if (ls(t, i, n), n) {
    let a = n.parent;
    for (; a && a.parent; )
      kd(a.parent.vnode) && g0(i, t, n, a), a = a.parent;
  }
}
function g0(e, t, n, i) {
  const a = ls(
...
const N0 = "components", Td = /* @__PURE__ */ Symbol.for("v-ndc");
function M0(e) {
  return wt(e) ? k0(N0, e, !1) || e : e || Td;
}
function k0(e, t, n = !0, i = !1) {
  const a = dn || Wt;
  if (a) {
    const c = a.type;
    {
    ...
    const f = (
      ...
      Ku(a[e] || c[e], t) || // global registration
      Ku(a.appContext[e], t)
    );
    return !f && i ? c : f;
  }
...
const Dl = (e) => e ? Jd(e) ? fs(e) : Dl(e.parent) : null, sa = (
...
), ll = (e, t) => e !== st && !e.__isScriptSetup && Ze(e, t), P0 = {
  get({ _: e }, t) {
    if (t === "__v_skip")
      return !0;
...
let Ll = !0;
function C0(e) {
  const t = Ed(e), n = e.proxy, i = e.ctx;
  Ll = !1, t.beforeCreate && Wu(t.beforeCreate, e, "bc");
  const {
    // state
    data: a,
    computed: c,
  ...
  y && Wu(y, e, "c");
  function B(ne, K) {
    Oe(K) ? K.forEach((le) => ne(le.bind(n))) : K && ne(K.bind(n));
  }
  if (B(v0, p), B(Cd, w), B(b0, S), B(y0, C), B(p0, M), B(m0, V), B(S0, ie), B(w0, X), B(x0, oe), B(fc, D), B(Ad, T), B(_0, xe), Oe(A))
    if (A.length) {
  ...
  $ && e.render === $n && (e.render = $), be != null && (e.inheritAttrs = be), he && (e.components = he), fe && (e.directives = fe), xe && Md(e);
}
function A0(e, t, n = $n) {
  Oe(e) && (e = Rl(e));
  for (const i in e) {
...
function L0(e, t) {
  return function(i, a = null) {
    ...
    const c = Dd(), f = /* @__PURE__ */ new WeakSet(), d = [];
    let h = !1;
    const v = c.app = {
      _uid: D0++,
      _component: i,
...
let Si = null;
const R0 = (e, t) => t === "modelValue" || t === "model-value" ? e.modelModifiers : e[`${t}Modifiers`] || e[`${Qt(t)}Modifiers`] || e[`${Wr(t)}Modifiers`];
function O0(e, t, ...n) {
  if (e.isUnmounted) return;
  const i = e.vnode.props || st;
  let a = n;
  const c = t.startsWith("update:"), f = c && R0(i, t.slice(7));
  f && (f.trim && (a = n.map((y) => wt(y) ? y.trim() : y)), f.number && (a = n.map(_g)));
  let d, h = i[d = nl(t)] || // also try camelCase event handler (#2249)
  i[d = nl(Qt(t))];
  !h && c && (h = i[d = nl(Wr(t))]), h && Un(
    h,
    e,
    6,
    a
...
function Ld(e, t, n = !1) {
  const i = n ? F0 : t.emitsCache, a = i.get(e);
  if (a !== void 0)
    return a;
  const c = e.emits;
  let f = {}, d = !1;
  ...
  return !c && !d ? (rt(e) && i.set(e, null), null) : (Oe(c) ? c.forEach((h) => f[h] = null) : Yt(f, c), rt(e) && i.set(e, f), f);
}
function cs(e, t) {
...
function j0(e, t, n) {
  ...
  if (n && h >= 0) {
    ...
    return (a || d) && (!d || !d.$stable) ? !0 : i === f ? !1 : i ? f ? Zu(i, f, v) : !0 : !!f;
  return !1;
}
function Zu(e, t, n) {
...
const Od = {}, Fd = () => Object.create(Od), Vd = (e) => Object.getPrototypeOf(e) === Od;
function $0(e, t, n, i = !1) {
  const a = {}, c = Fd();
  e.propsDefaults = /* @__PURE__ */ Object.create(null), Hd(e, t, a, c);
  for (const f in e.propsOptions[0])
    f in a || (a[f] = void 0);
  n ? e.props = i ? a : /* @__PURE__ */ qg(a) : e.type.props ? e.props = a : e.props = c, e.attrs = c;
}
function B0(e, t, n, i) {
  const {
    props: a,
...
function jd(e, t, n = !1) {
  const i = n ? U0 : t.propsCache, a = i.get(e);
  if (a)
    return a;
  const c = e.props, f = {}, d = [];
  let h = !1;
  ...
  if (Oe(c))
    ...
    for (const y in c) {
      const p = Qt(y);
      if (Ju(p)) {
        const w = c[y], S = f[p] = Oe(w) || je(w) ? { type: w } : Yt({}, w), C = S.type;
        let M = !1, V = !0;
        if (Oe(C))
          for (let R = 0; R < C.length; ++R) {
            const D = C[R], I = je(D) && D.name;
            if (I === "Boolean") {
              M = !0;
              break;
            } else I === "String" && (V = !1);
...
const dc = (e) => e === "_" || e === "_ctx" || e === "$stable", hc = (e) => Oe(e) ? e.map(Fn) : [Fn(e)], K0 = (e, t, n) => {
  if (t._n)
    return t;
  const i = o0((...a) => hc(t(...a)), n);
  return i._c = !1, i;
}, zd = (e, t, n) => {
  const i = e._ctx;
  for (const a in e) {
  ...
  if (e.vnode.shapeFlag & 32) {
    const a = t._;
    a ? (Bd(i, t, n), n && Qf(i, "_", a, !0)) : zd(t, i);
  } else t && $d(e, t);
}, W0 = (e, t, n) => {
  ...
  if (i.shapeFlag & 32) {
    const d = t._;
    d ? n && d === 1 ? c = !1 : Bd(a, t, n) : (c = !t.$stable, zd(t, a)), f = t;
  } else t && ($d(e, t), f = { default: 1 });
  if (c)
    for (const d in a)
...
function Y0(e, t) {
  ...
  const {
    ...
    if (u === O)
      return;
    u && !Bi(u, O) && (de = Ht(u), De(u, E, G, !0), u = null), O.patchFlag === -2 && (te = !1, O.dynamicChildren = null);
    ...
    if (te = u.el = f(
      ...
      Y,
      U
    ), Se && Dr(u, null, de, "created"), oe(te, u, u.scopeId, Y, de), me) {
      for (const Te in me)
    ...
    const ke = X0(E, _e);
    ke && _e.beforeEnter(te), i(te, O, Q), ((J = me && me.onVnodeMounted) || ke || Se) && rn(() => {
      try {
        J && In(J, de, u), ke && _e.enter(te), Se && Dr(u, null, de, "mounted");
      } finally {
      }
    }, E);
  }, oe = (u, O, Q, de, E) => {
    ...
    if (E) {
      let G = E.subTree;
      if (O === G || Wd(G.type) && (G.ssContent === O || G.ssFallback === O)) {
        const Y = E.vnode;
        oe(
          u,
          Y,
    ...
    let Se;
    if (Q && Lr(Q, !1), (Se = _e.onVnodeBeforeUpdate) && In(Se, Q, O, u), me && Dr(O, u, Q, "beforeUpdate"), Q && Lr(Q, !0), (j.innerHTML && _e.innerHTML == null || j.textContent && _e.textContent == null) && y(U, ""), J ? A(
      u.dynamicChildren,
      J,
      U,
      Q,
      ...
      if (te & 16)
        ...
        for (let Te = 0; Te < ke.length; Te++) {
          const Fe = ke[Te], at = j[Fe], ft = _e[Fe];
          (ft !== at || Fe === "value") && c(U, Fe, at, ft, E, Q);
        }
      }
      te & 1 && u.children !== O.children && y(U, O.children);
    } else !Y && J == null && be(U, j, _e, Q, E);
    ((Se = _e.onVnodeUpdated) || me) && rn(() => {
      Se && In(Se, Q, O, u), me && Dr(O, u, Q, "updated");
    }, de);
  }, A = (u, O, Q, de, E, G, Y) => {
    ...
    Se && (U = U ? U.concat(Se) : Se), u == null ? (i(J, Q, de), i(me, Q, de), ie(
      // #10007
    ...
    const U = u.component = o1(
      u,
      de,
      E
    );
    if (kd(u) && (U.ctx.renderer = sn), l1(U, !1, Y), U.asyncDep) {
    ...
    const U = () => {
      if (u.isMounted) {
        ...
        let Fe = j, at;
        Lr(u, !1), j ? (j.el = Te.el, ne(u, j, Y)) : j = Te, _e && rl(_e), (at = j.props && j.props.onVnodeBeforeUpdate) && In(at, ke, j, Te), Lr(u, !0);
        const ft = Xu(u), Ce = u.subTree;
        u.subTree = ft, M(
          Ce,
          ft,
          ...
          E,
          G
        ), j.el = ft.el, Fe === null && z0(u, ft.el), Se && rn(Se, E), (at = j.props && j.props.onVnodeUpdated) && rn(
          () => In(at, ke, j, Te),
          E
        );
      } else {
        let j;
        const { el: _e, props: Se } = O, { bm: ke, m: Te, parent: Fe, root: at, type: ft } = u, Ce = oa(O);
        Lr(u, !1), ke && rl(ke), !Ce && (j = Se && Se.onVnodeBeforeMount) && In(j, Fe, O), Lr(u, !0);
        {
          at.ce && at.ce._hasShadowRoot() && at.ce._injectChildStyle(
            ft,
            u.parent ? u.parent.type : void 0
          );
          const qe = u.subTree = Xu(u);
          M(
            null,
            qe,
            Q,
        ...
        (O.shapeFlag & 256 || Fe && oa(Fe.vnode) && Fe.vnode.shapeFlag & 256) && u.a && rn(u.a, E), u.isMounted = !0, O = Q = de = null;
      }
    };
    u.scope.on();
    const te = u.effect = new rd(U);
    u.scope.off();
    const J = u.update = te.run.bind(te), me = u.job = te.runIfDirty.bind(te);
    me.i = u, me.id = u.uid, te.scheduler = () => lc(me), Lr(u, !0), J();
  }, ne = (u, O, Q) => {
    O.component = u;
    const de = u.vnode.props;
    u.vnode = O, u.next = null, B0(u, O.props, de, Q), W0(u, O.children, Q), ir(), $u(u), ar();
  }, K = (u, O, Q, de, E, G, Y, U, te = !1) => {
    const J = u && u.children, me = u ? u.shapeFlag : 0, j = O.children, { patchFlag: _e, shapeFlag: Se } = O;
    if (_e > 0) {
      if (_e & 128) {
        we(
          J,
    ...
    Se & 8 ? (me & 16 && it(J, E, G), j !== J && y(Q, j)) : me & 16 ? Se & 16 ? we(
      J,
      j,
      Q,
      de,
    ...
    let _e;
    for (_e = 0; _e < j; _e++) {
      const Se = O[_e] = te ? tr(O[_e]) : Fn(O[_e]);
      M(
        u[_e],
        Se,
        Q,
    ...
    for (; J <= j && J <= _e; ) {
      const Se = u[J], ke = O[J] = te ? tr(O[J]) : Fn(O[J]);
      if (Bi(Se, ke))
        M(
          Se,
          ke,
    ...
    for (; J <= j && J <= _e; ) {
      const Se = u[j], ke = O[_e] = te ? tr(O[_e]) : Fn(O[_e]);
      if (Bi(Se, ke))
        M(
          Se,
          ke,
    ...
    if (J > j) {
      if (J <= _e) {
        const Se = _e + 1, ke = Se < me ? O[Se].el : de;
        for (; J <= _e; )
          M(
            null,
      ...
      for (J = Se; J <= j; J++) {
        ...
        if (jt.key != null)
          ...
          for (Fe = ke; Fe <= _e; Fe++)
            if (ln[Fe - ke] === 0 && Bi(jt, O[Fe])) {
              cn = Fe;
              break;
            }
        cn === void 0 ? De(jt, E, G, !0) : (ln[cn - ke] = J + 1, cn >= qe ? qe = cn : Ce = !0, M(
          jt,
          O[cn],
          Q,
          null,
      ...
      const vt = Ce ? Z0(ln) : yi;
      for (Fe = vt.length - 1, J = ft - 1; J >= 0; J--) {
        ...
        ln[J] === 0 ? M(
          ...
          U,
          te
        ) : Ce && (Fe < 0 || J !== vt[Fe] ? Ee(cn, Q, Ei, 2) : Fe--);
      }
    }
  }, Ee = (u, O, Q, de, E = null) => {
    ...
    if (j === -2 && (E = !1), U != null && (ir(), aa(U, null, Q, u, !0), ar()), Se != null && (O.renderCache[Se] = void 0), me & 256) {
      O.ctx.deactivate(u);
      return;
    }
    const Te = me & 1 && _e, Fe = !oa(u);
    let at;
    if (Fe && (at = Y && Y.onVnodeBeforeUnmount) && In(at, O, u), me & 6)
      Qe(u.component, Q, de);
    else {
      if (me & 128) {
      ...
      (G !== et || j > 0 && j & 64) ? it(
        ...
        !1,
        !0
      ) : (G === et && j & 384 || !E && me & 16) && it(te, O, Q), de && Ue(u);
    }
    const ft = ke != null && Se == null;
    (Fe && (at = Y && Y.onVnodeUnmounted) || Te || ft) && rn(() => {
    ...
    Qu(te), Qu(J), de && rl(de), E.stop(), G && (G.flags |= 8, De(Y, u, O, Q)), U && rn(U, O), rn(() => {
      u.isUnmounted = !0;
    }, O);
    ...
    const O = w(u.anchor || u.el), Q = O && O[f0];
    return Q ? w(Q) : O;
  };
  let Ct = !1;
  const pn = (u, O, Q) => {
    ...
    u == null ? O._vnode && (De(O._vnode, null, null, !0), de = O._vnode.component) : M(
      ...
      null,
      Q
    ), O._vnode = u, Ct || (Ct = !0, $u(de), _d(), Ct = !1);
  }, sn = {
    p: M,
    um: De,
    m: Ee,
...
function Ud(e, t, n = !1) {
  ...
  if (Oe(i) && Oe(a))
    for (let c = 0; c < i.length; c++) {
      const f = i[c];
      let d = a[c];
      d.shapeFlag & 1 && !d.dynamicChildren && ((d.patchFlag <= 0 || d.patchFlag === 32) && (d = a[c] = tr(a[c]), d.el = f.el), !n && d.patchFlag !== -2 && Ud(f, d)), d.type === us && (d.patchFlag === -1 && (d = a[c] = tr(d)), d.el = f.el), d.type === Mr && !d.el && (d.el = f.el);
    }
}
function Z0(e) {
  const t = e.slice(), n = [0];
...
function qd(e) {
  return e.dynamicChildren = ba > 0 ? hn || yi : null, Q0(), ba > 0 && hn && hn.push(e), e;
}
...
const Xd = ({ key: e }) => e ?? null, So = ({
  ref: e,
  ref_key: t,
  ref_for: n
}) => (typeof e == "number" && (e = "" + e), e != null ? wt(e) || /* @__PURE__ */ qt(e) || je(e) ? { i: dn, r: e, k: t, f: !!n } : e : null);
...
const xt = e1;
function e1(e, t = null, n = null, i = 0, a = null, c = !1) {
  if ((!e || e === Td) && (e = Mr), Yd(e)) {
    const d = ki(
      e,
      t,
  ...
  if (h1(e) && (e = e.__vccOpts), t) {
    ...
    d && !wt(d) && (t.class = gt(d)), rt(h) && (/* @__PURE__ */ oc(h) && !Oe(h) && (h = Yt({}, h)), t.style = Nt(h));
  }
  const f = wt(e) ? 1 : Wd(e) ? 128 : d0(e) ? 64 : rt(e) ? 4 : je(e) ? 2 : 0;
  return ue(
    e,
    t,
    n,
...
function t1(e) {
  return e ? /* @__PURE__ */ oc(e) || Vd(e) ? Yt({}, e) : e : null;
}
function ki(e, t, n = !1, i = !1) {
  const { props: a, ref: c, patchFlag: f, children: d, transition: h } = e, v = t ? Zd(a || {}, t) : a, y = {
    __v_isVNode: !0,
    __v_skip: !0,
    type: e.type,
    props: v,
    ...
    ref: t && t.ref ? (
      ...
      n && c ? Oe(c) ? c.concat(So(t)) : [c, So(t)] : So(t)
    ) : c,
    scopeId: e.scopeId,
...
function Fn(e) {
  return e == null || typeof e == "boolean" ? xt(Mr) : Oe(e) ? xt(
    et,
    null,
    // #3666, avoid reference pollution when reusing vnode
    e.slice()
  ) : Yd(e) ? tr(e) : xt(us, null, String(e));
}
function tr(e) {
...
function pc(e, t) {
  ...
  if (t == null)
    ...
    if (i & 65) {
      ...
      n = 32;
      const a = t._;
      !a && !Vd(t) ? t._ctx = dn : a === 3 && dn && (dn.slots._ === 1 ? t._ = 1 : (t._ = 2, e.patchFlag |= 1024));
    }
  else je(t) ? (t = { default: t, _ctx: dn }, n = 32) : (t = String(t), i & 64 ? (n = 16, t = [n1(t)]) : n = 8);
  ...
  for (let n = 0; n < e.length; n++) {
    ...
    for (const a in i)
      if (a === "class")
        ...
        const c = t[a], f = i[a];
        f && c !== f && !(Oe(c) && c.includes(f)) ? t[a] = c ? [].concat(c, f) : f : f == null && c == null && // mergeProps({ 'onUpdate:modelValue': undefined }) should not retain
        // the model listener.
        !ts(a) && (t[a] = f);
      } else a !== "" && (t[a] = i[a]);
  }
...
let a1 = 0;
function o1(e, t, n) {
  const i = e.type, a = (t ? t.appContext : e.appContext) || i1, c = {
    uid: a1++,
    vnode: e,
    type: i,
    parent: t,
  ...
  return c.ctx = { _: c }, c.root = t ? t.root : c, c.emit = O0.bind(null, c), e.ce && e.ce(c), c;
}
let Wt = null;
const s1 = () => Wt || dn;
let Fo, Fl;
...
function l1(e, t = !1, n = !1) {
  ...
  $0(e, i, c, t), G0(e, a, n || t);
  const f = c ? c1(e, t) : void 0;
  return t && Fl(!1), f;
}
function c1(e, t) {
  const n = e.type;
  ...
  if (i) {
    ir();
    const a = e.setupContext = i.length > 1 ? f1(e) : null, c = Ca(e), f = Pa(
      i,
      e,
      0,
      [
...
function nf(e, t, n) {
  je(t) ? e.type.__ssrInlineRender ? e.ssrRender = t : e.render = t : rt(t) && (e.setupState = vd(t)), Qd(e);
}
function Qd(e, t, n) {
  const i = e.type;
...
function fs(e) {
  return e.exposed ? e.exposeProxy || (e.exposeProxy = new Proxy(vd(Yg(e.exposed)), {
    get(t, n) {
      if (n in t)
        return t[n];
      if (n in sa)
...
const Pt = (e, t) => /* @__PURE__ */ e0(e, t, ya), p1 = "3.5.32";
/**
...
if (rf)
  try {
    Vl = /* @__PURE__ */ rf.createPolicy("vue", {
      createHTML: (e) => e
    });
  } catch {
  }
const eh = Vl ? (e) => Vl.createHTML(e) : (e) => e, m1 = "http://www.w3.org/2000/svg", g1 = "http://www.w3.org/1998/Math/MathML", Qn = typeof document < "u" ? document : null, af = Qn && /* @__PURE__ */ Qn.createElement("template"), v1 = {
  insert: (e, t, n) => {
  ...
  createElement: (e, t, n, i) => {
    const a = t === "svg" ? Qn.createElementNS(m1, e) : t === "mathml" ? Qn.createElementNS(g1, e) : n ? Qn.createElement(e, { is: n }) : Qn.createElement(e);
...
}, b1 = /* @__PURE__ */ Symbol("_vtc");
function y1(e, t, n) {
  const i = e[b1];
  i && (t = (t ? [t, ...i] : [...i]).join(" ")), t == null ? e.removeAttribute("class") : n ? e.setAttribute("class", t) : e.className = t;
}
const Vo = /* @__PURE__ */ Symbol("_vod"), th = /* @__PURE__ */ Symbol("_vsh"), mc = {
...
function Ui(e, t) {
  e.style.display = t ? e[Vo] : "none", e[th] = !t;
}
const _1 = /* @__PURE__ */ Symbol(""), x1 = /(?:^|;)\s*display\s*:/;
function w1(e, t, n) {
  ...
  if (n && !a) {
    ...
    if (t !== n) {
      const f = i[_1];
      f && (n += ";" + f), i.cssText = n, c = x1.test(n);
    }
  } else t && e.removeAttribute("style");
  Vo in e && (e[Vo] = c ? i.display : "", e[th] && (i.display = "none"));
}
...
function cf(e, t, n, i, a, c = kg(t)) {
  i && t.startsWith("xlink:") ? n == null ? e.removeAttributeNS(lf, t.slice(6, t.length)) : e.setAttributeNS(lf, t, n) : n == null || c && !ed(n) ? e.removeAttribute(t) : e.setAttribute(
    t,
    c ? "" : Bn(n) ? String(n) : n
  );
}
function uf(e, t, n, i, a) {
  ...
  if (n === "" || n == null) {
    const d = typeof e[t];
    d === "boolean" ? n = ed(n) : n == null && d === "string" ? (n = "", f = !0) : d === "number" && (n = 0, f = !0);
  }
  try {
    e[t] = n;
  } catch {
...
function k1(e, t, n, i, a = null) {
  const c = e[ff] || (e[ff] = {}), f = c[t];
  if (i && f)
    f.value = i;
  else {
    const [d, h] = P1(t);
...
let fl = 0;
const C1 = /* @__PURE__ */ Promise.resolve(), A1 = () => fl || (C1.then(() => fl = 0), fl = Date.now());
function T1(e, t) {
  const n = (i) => {
    if (!i._vts)
      i._vts = Date.now();
...
const hf = (e) => e.charCodeAt(0) === 111 && e.charCodeAt(1) === 110 && // lowercase letter
e.charCodeAt(2) > 96 && e.charCodeAt(2) < 123, E1 = (e, t, n, i, a, c) => {
  const f = a === "svg";
  t === "class" ? y1(e, i, f) : t === "style" ? w1(e, n, i) : es(t) ? ts(t) || k1(e, t, n, i, c) : (t[0] === "." ? (t = t.slice(1), !0) : t[0] === "^" ? (t = t.slice(1), !1) : D1(e, t, i, f)) ? (uf(e, t, i), !e.tagName.includes("-") && (t === "value" || t === "checked" || t === "selected") && cf(e, t, i, f, c, t !== "value")) : /* #11081 force set props for possible async custom element */ e._isVueCE && // #12408 check if it's declared prop or it's async custom element
  (L1(e, t) || // @ts-expect-error _def is private
  e._def.__asyncLoader && (/[A-Z]/.test(t) || !wt(i))) ? uf(e, Qt(t), i, c, t) : (t === "true-value" ? e._trueValue = i : t === "false-value" && (e._falseValue = i), cf(e, t, i, f));
};
function D1(e, t, n, i) {
  if (i)
    return !!(t === "innerHTML" || t === "textContent" || t in e && hf(t) && je(n));
...
const R1 = ["ctrl", "shift", "alt", "meta"], O1 = {
  ...
  exact: (e, t) => R1.some((n) => e[`${n}Key`] && !t.includes(n))
}, nh = (e, t) => {
  if (!e) return e;
...
}, F1 = /* @__PURE__ */ Yt({ patchProp: E1 }, v1);
let pf;
function V1() {
  return pf || (pf = q0(F1));
}
...
const mt = Math.PI / 180, rh = Math.PI * 2, $1 = 2048;
function ot(e, t, n) {
...
function ko(e, t, n = 0) {
  ...
  let c = Ji(mf(a, i)), f = Ji(mf(i, c));
  const d = Number(n || 0) * mt, h = Math.cos(d), v = Math.sin(d), y = Ho(vi(c, h), vi(f, v)), p = Ho(vi(c, -v), vi(f, h));
  return c = Ji(y), f = Ji(p), { fwd: i, right: c, up: f };
}
function U1(e, t) {
  const n = (Number(e || 0) - 0.5) * rh, i = (0.5 - Number(t || 0)) * Math.PI, a = Math.cos(i);
  return kr(a * Math.sin(n), Math.sin(i), a * Math.cos(n));
}
function gf(e, t, n = 1) {
  const i = Math.max(1, Math.round(Number(e || 1))), a = Math.max(1, Math.round(Number(t || 1))), c = Math.max(1, Number(n || 1)), f = Math.max(512, $1), d = Math.min(1, f / Math.max(i, a));
  return {
    sourceWidth: i,
    sourceHeight: a,
    sourceDpr: c,
...
function Y1(e = {}) {
  ...
  let n = null, i = null, a = null, c = null, f = null, d = null, h = null, v = null, y = null, p = null, w = null, S = !1, C = gf(1, 1, 1), M = null, V = null, R = null, D = null, I = null;
  ...
  function xe() {
    ...
    try {
      ...
      }), n ? (i = dl(n, hl, K1), a = dl(n, hl, G1), c = dl(n, hl, W1), M = {
  ...
  function be(E, G, Y = 1) {
    C = gf(E, G, Y), (t.width !== C.width || t.height !== C.height) && (t.width = C.width, t.height = C.height);
  }
  function he(E) {
  ...
  function se(E, G, Y = [], U = { width: 0, height: 0 }, te = !1) {
    ...
    for (const _e of j) {
      const Se = Math.max(0, Math.floor(Number(_e.x || 0))), ke = Math.max(0, Math.floor(Number(_e.y || 0))), Te = Math.min(J - Se, Math.ceil(Number(_e.w || 0))), Fe = Math.min(me - ke, Math.ceil(Number(_e.h || 0)));
      if (!(Te <= 0 || Fe <= 0)) {
        if (D.width !== Te || D.height !== Fe) {
          if (D.width = Te, D.height = Fe, I = D.getContext("2d"), !I)
            return n.texImage2D(n.TEXTURE_2D, 0, n.RGBA, n.RGBA, n.UNSIGNED_BYTE, G), n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL, 0), !0;
        } else
          I.clearRect(0, 0, Te, Fe);
        I.drawImage(G, Se, ke, Te, Fe, 0, 0, Te, Fe), n.texSubImage2D(n.TEXTURE_2D, 0, Se, ke, n.RGBA, n.UNSIGNED_BYTE, D);
      }
    }
  ...
  function B(E, G, Y, U, te = null, J = !1) {
    ...
    if (!Y)
      return he(E), !1;
    const me = String(U ?? ""), j = E === "background" ? y : E === "paint" ? p : w, _e = X[E], Se = Number(Y.width || Y.videoWidth || Y.naturalWidth || 0), ke = Number(Y.height || Y.videoHeight || Y.naturalHeight || 0), Te = _e.width !== Se || _e.height !== ke;
  ...
  function it(E, G = {}) {
    if (!y) return null;
    n.disable(n.BLEND), Qe(i), n.activeTexture(n.TEXTURE0), n.bindTexture(n.TEXTURE_2D, d), n.uniform1i(M.background, 0), n.uniform2f(M.viewport, Math.max(1, C.width), Math.max(1, C.height)), n.uniform1i(M.mode, (E == null ? void 0 : E.mode) === "unwrap" ? 0 : (E == null ? void 0 : E.mode) === "cutout" ? 2 : 1);
    const Y = Ki(E, C.width, C.height) || {
      yawDeg: 0,
      pitchDeg: 0,
      rollDeg: 0,
      hFovDeg: 90,
  ...
  function Ht(E, G = {}) {
    ...
    const te = Ki(E, C.width, C.height) || {
      yawDeg: 0,
      pitchDeg: 0,
      rollDeg: 0,
      hFovDeg: 90,
  ...
  function Ct(E, G) {
    var _e, Se, ke, Te, Fe, at, ft;
    const Y = Array.isArray(E == null ? void 0 : E.objects) ? E.objects : [];
    if (!Y.length) {
      fe(), Ee(/* @__PURE__ */ new Set());
      return;
    }
    const U = (G == null ? void 0 : G.mode) === "unwrap" ? 0 : (G == null ? void 0 : G.mode) === "cutout" ? 2 : 1, te = Ki(G, C.width, C.height) || {
      yawDeg: 0,
      pitchDeg: 0,
      rollDeg: 0,
      hFovDeg: 90,
      ...
      if (!(!Ce || Ce.visible === !1)) {
        if (Ce.type === "sticker") {
          ...
          const vt = q1({
            ...
            hFovDeg: ((Fe = Ce == null ? void 0 : Ce.transform) == null ? void 0 : Fe.hFovDeg) || 30,
  ...
  function Q(E, G, Y) {
    const U = Math.max(1, Number((E == null ? void 0 : E.viewportWidth) || C.sourceWidth || C.width || 1)), te = Math.max(1, Number((E == null ? void 0 : E.viewportHeight) || C.sourceHeight || C.height || 1)), J = Number(G), me = Number(Y);
    if (!Number.isFinite(J) || !Number.isFinite(me)) return null;
    if ((E == null ? void 0 : E.mode) === "unwrap")
      return { u: (J / U % 1 + 1) % 1, v: ot(me / te, 0, 1) };
    const j = Ki(E, U, te);
    if (!j) return null;
    const _e = ko(j.yawDeg, j.pitchDeg, j.rollDeg), Se = (J - U * 0.5) / (U * 0.5) * Math.tan(ot(j.hFovDeg, 1, 179) * mt * 0.5), ke = (te * 0.5 - me) / (te * 0.5) * Math.tan(ot(j.vFovDeg, 0.1, 179) * mt * 0.5), Te = Ji(Ho(Ho(vi(_e.right, Se), vi(_e.up, ke)), _e.fwd));
    return {
      u: (Math.atan2(Te.x, Te.z) / rh + 0.5 + 1) % 1,
      v: ot(0.5 - Math.asin(ot(Te.y, -1, 1)) / Math.PI, 0, 1)
    };
  }
  function de(E, G, Y) {
    const U = Math.max(1, Number((E == null ? void 0 : E.viewportWidth) || C.sourceWidth || C.width || 1)), te = Math.max(1, Number((E == null ? void 0 : E.viewportHeight) || C.sourceHeight || C.height || 1));
    if ((E == null ? void 0 : E.mode) === "unwrap")
      return {
    ...
    const me = ko(J.yawDeg, J.pitchDeg, J.rollDeg), j = U1(G, Y), _e = Mo(j, me.right), Se = Mo(j, me.up), ke = Mo(j, me.fwd);
    if (ke <= 1e-5) return { x: 0, y: 0, visible: !1 };
    const Te = U * 0.5 + _e / ke * (U * 0.5 / Math.tan(ot(J.hFovDeg, 1, 179) * mt * 0.5)), Fe = te * 0.5 - Se / ke * (te * 0.5 / Math.tan(ot(J.vFovDeg, 0.1, 179) * mt * 0.5));
    return { x: Te, y: Fe, visible: Te >= 0 && Te <= U && Fe >= 0 && Fe <= te };
  }
  return {
    init: xe,
    dispose: A,
...
function ev(e = {}) {
  const t = J1.has(String((e == null ? void 0 : e.type) || "")) ? String(e.type) : "erp_image", n = Number((e == null ? void 0 : e.opacity) ?? 1);
  return {
    type: t,
...
function tv(e = {}) {
  ...
  return {
    ...
    coverageAware: Q1(t, e == null ? void 0 : e.coverageAware),
...
function nv(e = {}) {
  return {
    objects: (Array.isArray(e == null ? void 0 : e.objects) ? e.objects : []).map((i) => tv(i)).filter((i) => !!i && i.visible !== !1).sort((i, a) => {
...
function Pi(e = {}) {
  return {
    ...
    background: ev((e == null ? void 0 : e.background) || {}),
    objectPass: nv((e == null ? void 0 : e.objectPass) || {}),
...
function gc(e = {}, t = "paint") {
  ...
  return {
    ...
    revision: String((e == null ? void 0 : e.revision) || ""),
    zIndex: Number.isFinite(i) ? i : 0,
    opacity: Number.isFinite(a) ? rv(a, 0, 1) : 1,
    visible: (e == null ? void 0 : e.visible) !== !1,
    coverageAware: !1,
    transform: e != null && e.transform && typeof e.transform == "object" ? { ...e.transform } : null,
    params: e != null && e.params && typeof e.params == "object" ? { ...e.params } : {}
...
function ah(e = {}) {
  const t = [], n = iv(e == null ? void 0 : e.paintSource, e == null ? void 0 : e.paintRevision, e == null ? void 0 : e.paintOptions), i = av(e == null ? void 0 : e.maskSource, e == null ? void 0 : e.maskRevision, e == null ? void 0 : e.maskOptions), a = Array.isArray(e == null ? void 0 : e.rasterEntries) ? e.rasterEntries : [];
...
function Qi(e = {}) {
  const t = (e == null ? void 0 : e.scene) || { stickers: [], selectedId: null, hoveredId: null }, n = Array.isArray(e == null ? void 0 : e.textures) ? e.textures : [], i = vc(t, n), a = ah({
...
function sv(e = {}) {
  ...
  if (e != null && e.background || e != null && e.objectPass || e != null && e.overlay) {
    const S = Pi(e), C = Array.isArray((c = S.objectPass) == null ? void 0 : c.objects) ? S.objectPass.objects : [], M = {
      stickers: C.filter((I) => I.type === "sticker").map((I) => {
    ...
    }, V = C.filter((I) => I.type === "sticker").map((I) => {
      var T, $;
      return {
        assetId: String(((T = I == null ? void 0 : I.params) == null ? void 0 : T.assetId) || (($ = I == null ? void 0 : I.params) == null ? void 0 : $.asset_id) || (I == null ? void 0 : I.id) || ""),
    ...
    }).filter((I) => I.assetId && I.source), R = C.find((I) => I.type === "paint") || null, D = C.find((I) => I.type === "mask") || null;
    return {
      stateRevision: String((e == null ? void 0 : e.stateRevision) || ""),
...
function Ur(e = {}) {
  const t = typeof (e == null ? void 0 : e.rendererFactory) == "function" ? e.rendererFactory : (V) => Y1(V), n = typeof (e == null ? void 0 : e.targetPoolFactory) == "function" ? e.targetPoolFactory : () => X1(), i = typeof (e == null ? void 0 : e.stateControllerFactory) == "function" ? e.stateControllerFactory : (V) => lv(V), a = t(e), c = (e == null ? void 0 : e.targetCanvas) || null, f = n();
  let d = null;
  const h = i({
    syncState(V = {}) {
...
let pl = null, ml = null, _f = null, xf = null, _t = null, Gi = null, Xt = null, mr = null;
function uv() {
  if (ml) return ml;
  const e = 6, t = 17, n = document.createElement("canvas");
  n.width = t, n.height = t;
  const i = n.getContext("2d");
  return i.fillStyle = "rgba(0, 0, 0, 0.25)", i.fillRect(0, 0, t, t), i.strokeStyle = "rgba(0, 0, 0, 0.5)", i.lineWidth = e, i.lineCap = "square", i.beginPath(), i.moveTo(0, 0), i.lineTo(t, t), i.moveTo(-t / 2, t / 2), i.lineTo(t / 2, t + t / 2), i.moveTo(t / 2, -t / 2), i.lineTo(t + t / 2, t / 2), i.stroke(), ml = n, n;
}
function gl(e, t) {
  if (!e || !t) return;
  ...
  pl = er(pl, n, i);
  const a = pl;
  dt(a), a.ctx.drawImage(t, 0, 0), a.ctx.globalCompositeOperation = "source-in", xf !== a.ctx && (_f = a.ctx.createPattern(uv(), "repeat"), xf = a.ctx), a.ctx.fillStyle = _f, a.ctx.fillRect(0, 0, n, i), a.ctx.globalCompositeOperation = "source-over", e.save(), e.globalCompositeOperation = "source-over", e.drawImage(a.canvas, 0, 0), e.restore();
}
function fv(e) {
...
function mv(e, t, n, i, a, c) {
  ...
  const v = f * 2 + 2, y = f + 1, p = bc(v, v), w = p.getContext("2d"), S = d * f, C = f + 1, M = `rgba(${n},${i},${a},${c})`, V = `rgba(${n},${i},${a},0)`, R = w.createRadialGradient(y, y, S, y, y, C);
  return R.addColorStop(0, M), R.addColorStop(1, V), w.fillStyle = R, w.fillRect(0, 0, v, v), ht.set(h, p), p;
}
function gv(e, t, n, i, a, c, f) {
  const { r: d, g: h, b: v, a: y } = i, p = Math.max(2, Math.ceil(e) * 2), w = Math.max(2, Math.ceil(t) * 2), S = Math.max(0, a), C = Math.max(0, Math.min(0.99, c)), M = Math.max(0, Math.min(1, f ?? 0)), V = `chisel:${p}:${w}:${n.toFixed(2)}:${d}:${h}:${v}:${y.toFixed(3)}:${S.toFixed(2)}:${C.toFixed(2)}:${M.toFixed(2)}`;
  if (ht.has(V)) {
    const ie = ht.get(V);
  ...
  for (let ie = 0; ie < w; ie++)
    for (let xe = 0; xe < p; xe++) {
      ...
      if (H >= 1) continue;
      const se = H <= X ? 1 : Math.max(0, (1 - H) / Math.max(1e-4, 1 - X)), B = 1 - H, ne = 1 + S * (1 - B) * (1 - B), K = 1 - C * B * B, le = ne * K / oe;
      let we = 1;
      if (M > 0) {
...
function vv(e, t, n, i, a, c, f) {
  ...
  if (S >= 1) return 0;
  const C = S <= a ? 1 : Math.max(0, (1 - S) / Math.max(1e-4, 1 - a)), M = bv(e, t, d, h, n, i), V = c * 0.55;
  if (M < V) return 0;
  const D = 0.45 + 0.55 * ((M - V) / Math.max(1e-4, 1 - V));
  return Math.round(255 * Math.min(1, f * C * D));
}
function bv(e, t, n, i, a, c) {
...
function yv(e, t, n, i, a) {
  ...
  ht.size >= yc && ht.delete(ht.keys().next().value);
  const S = bc(v, y), C = S.getContext("2d"), M = C.createImageData(v, y), V = M.data, R = Math.max(0, Math.min(1, n));
  for (let D = 0; D < y; D++)
    for (let I = 0; I < v; I++) {
      const T = vv(I, D, e, t, R, p, h);
      if (T <= 0) continue;
      const $ = (D * v + I) * 4;
      V[$] = c, V[$ + 1] = f, V[$ + 2] = d, V[$ + 3] = T;
    }
  return C.putImageData(M, 0, 0), ht.set(w, S), S;
}
function oh(e, t, n) {
  var M, V;
  const i = String((t == null ? void 0 : t.stampKind) || "round"), a = hv(t, n), c = Math.max(0, Math.min(1, Number((t == null ? void 0 : t.hardness) ?? 0.9))), f = _v(t), d = Math.max(0.1, Number((t == null ? void 0 : t.aspect) ?? 1)), h = Number(((M = t == null ? void 0 : t.angle) == null ? void 0 : M.value) ?? 0), v = pv(t, a), y = String(((V = t == null ? void 0 : t.targetSpace) == null ? void 0 : V.viewMode) || ""), p = (n == null ? void 0 : n.kind) === "ERP_GLOBAL" && y !== "unwrap", w = t == null ? void 0 : t.scatter, S = w ? { radius: Number(w.radius ?? 1.5), count: Math.max(1, Math.round(w.count ?? 6)) } : null;
  let C;
  if (i === "chisel") {
    ...
    C = mv(a, c, f.r, f.g, f.b, f.a);
  return { ctx: e, stampTex: C, radiusPx: a, spacingPx: v, desc: n, aspect: d, angle: h, stampKind: i, scatter: S, latitudeCorrection: p };
}
function _v(e) {
...
function _c(e, t, n, i) {
  ...
  if (e.scatter) {
    ...
    for (let S = 0; S < y; S++) {
      const C = $r(w + S * 2) * Math.PI * 2, M = Math.sqrt($r(w + S * 2 + 1)) * p, V = t + Math.cos(C) * M, R = n + Math.sin(C) * M, D = Math.max(0.5, e.radiusPx * a * 0.48), I = (0.5 - R / Math.max(1, e.desc.height)) * Math.PI, T = e.latitudeCorrection ? 1 / Math.max(0.05, Math.cos(I)) : 1, $ = D * e.aspect * T;
      wf(e, V, R, D, $);
    }
    return;
  }
...
function Sf(e, t, n) {
  ...
  const a = n.width, c = n.height, f = oh(e, t, n);
  e.save(), e.globalCompositeOperation = "source-over";
  const d = [];
  for (let w = 0; w < i.length; w++) {
    let S = Number(i[w].u || 0) * a;
    const C = Number(i[w].v || 0) * c;
    w > 0 && Math.abs(S - d[w - 1].x) > a * 0.5 && (S += S < d[w - 1].x ? a : -a), d.push({ x: S, y: C });
  }
  ...
  for (let w = 1; w < d.length; w++) {
    const S = d[w], C = { x: (v.x + S.x) * 0.5, y: (v.y + S.y) * 0.5 };
    w === 1 ? p = _a(f, y.x, y.y, C.x, C.y, p) : p = jo(f, h, y, C, S, p), h = v, v = S, y = C;
  }
...
function Po(e, t, n) {
  ...
  const a = n.width, c = n.height, f = xv(t), d = [];
  let h = 1 / 0, v = -1 / 0;
  for (let w = 0; w < i.length; w++) {
    const S = fv(i[w]);
    let C = Number(S.x || 0) * a;
    w > 0 && Math.abs(C - d[w - 1].x) > a * 0.5 && (C += C < d[w - 1].x ? a : -a), d.push({ x: C, y: Number(S.y || 0) * c }), C < h && (h = C), C > v && (v = C);
  }
  function y(w) {
...
function no(e, t, n) {
  ...
  c >= 0.999 ? Sf(e, t, n) : (Gi = er(Gi, n.width, n.height), dt(Gi), Sf(Gi.ctx, t, n), e.save(), e.globalAlpha = c, e.drawImage(Gi.canvas, 0, 0), e.restore());
}
function Rr(e, t) {
...
function jo(e, t, n, i, a, c) {
  const d = Math.sqrt(Math.hypot(n.x - t.x, n.y - t.y)) + 1e-4, h = Math.sqrt(Math.hypot(i.x - n.x, i.y - n.y)) + 1e-4, v = Math.sqrt(Math.hypot(a.x - i.x, a.y - i.y)) + 1e-4, y = 0, p = d, w = p + h, S = w + v, C = w - p, M = 16;
  let V = c, R = n.x, D = n.y;
  for (let I = 1; I <= M; I++) {
    const T = p + C * I / M, $ = ((p - T) * t.x + (T - y) * n.x) / (p - y), X = ((p - T) * t.y + (T - y) * n.y) / (p - y), oe = ((w - T) * n.x + (T - p) * i.x) / (w - p), ie = ((w - T) * n.y + (T - p) * i.y) / (w - p), xe = ((S - T) * i.x + (T - w) * a.x) / (S - w), A = ((S - T) * i.y + (T - w) * a.y) / (S - w), be = ((w - T) * $ + (T - y) * oe) / (w - y), he = ((w - T) * X + (T - y) * ie) / (w - y), fe = ((S - T) * oe + (T - p) * xe) / (S - p), H = ((S - T) * ie + (T - p) * A) / (S - p), se = ((w - T) * be + (T - p) * fe) / (w - p), B = ((w - T) * he + (T - p) * H) / (w - p);
...
function wv(e, t, n, i) {
  ...
  if (h && Math.abs(v - h.prev.x) > f * 0.5 && (v += v < h.prev.x ? f : -f), !h) {
    const S = oh(a, i, c), C = Math.max(0, Math.min(1, Number((i == null ? void 0 : i.opacity) ?? 1))), M = Math.max(0, Number((i == null ? void 0 : i.velocityWidthFactor) ?? 0)), V = String((i == null ? void 0 : i.toolKind) || "") === "eraser", R = String((i == null ? void 0 : i.layerKind) || "paint");
...
function Hl(e = {}) {
  ...
  function D(A, be) {
    ...
    cv() && (String((A == null ? void 0 : A.toolKind) || ""), String((B == null ? void 0 : B.kind) || ""), Number((B == null ? void 0 : B.width) || 0), Number((B == null ? void 0 : B.height) || 0), String(((K = A == null ? void 0 : A.targetSpace) == null ? void 0 : K.viewMode) || ""), Number((A == null ? void 0 : A.aspect) ?? 1), yf(H.currentStroke.canvas), yf(ne.canvas), void 0), dt(H.currentStroke), H.activeStroke = null, H.displayDirty = !0, v = null, y = "", M([...a.keys()]);
  }
  function I(A) {
    if (y === "mask")
  ...
  function xe() {
    return mr = er(mr, t, n), dt(mr), gl(mr.ctx, f.committedMask.canvas), y === "mask" && f.activeStroke && (f.activeStroke.isEraser ? (_t = er(_t, t, n), dt(_t), _t.ctx.drawImage(f.committedMask.canvas, 0, 0), Rr(_t.ctx, c.canvas), dt(mr), gl(mr.ctx, _t.canvas)) : gl(mr.ctx, c.canvas)), mr.canvas;
  }
  return {
    rebuildCommitted: V,
    beginStroke: R,
    appendStrokePoint: wv,
...
const jl = Math.PI / 180, zl = 0.12, sh = 3, xc = 35, wc = 140, bi = 100, Nv = 0.4, Mv = 0.6, lh = 5.5, ch = 20, $l = 0.8;
function kv(e, t, n) {
...
function hs(e = {}) {
  ...
  function p(R, D, I = "pano", T = performance.now()) {
    ...
    if (I === "unwrap") {
      ...
      if (K > 1 && le > 1) {
        const we = q(Number(fe.fov || bi), 1, 179), Ee = q(kv(we, K, le), 0.1, 179);
  ...
  function w(R = performance.now()) {
    ...
    return h.inertia.active = T > ch, h.inertia.lastTs = D, v("drag", { phase: "end", speed: T, inertiaActive: h.inertia.active }), !0;
  }
  ...
  function C(R) {
    ...
    return I.fov = q(T + D * sh, xc, wc), n(I), f(), v("wheel", { deltaSign: D, fovBefore: T, fovAfter: I.fov }), !0;
  }
  function M(R) {
    return C(Math.sign(Pv(R)));
  }
  function V() {
...
const Nf = Math.PI / 180;
function Wi(e, t = 0) {
  const n = Number(e);
  return Number.isFinite(n) ? n : Number(t);
}
function Av(e) {
  const t = e || {}, n = Wi(t.yaw_deg, 0), i = Wi(t.pitch_deg, 0), a = Wi(t.roll_deg ?? t.rot_deg, 0), c = vl(Wi(t.hFOV_deg, 90), 1, 179), f = vl(Wi(t.vFOV_deg, 60), 1, 179), d = Math.tan(c * Nf * 0.5) / Math.max(1e-6, Math.tan(f * Nf * 0.5)), h = vl(d, 0.1, 10);
  return {
    yaw: n,
    pitch: i,
    roll: a,
...
function Iv(e, t = {}) {
  ...
  return {
    ...
    crop: Tv(e.crop),
    opacity: d ? uh : q(Number(e.opacity ?? 1), 0, 1),
...
function ps(e, t = {}) {
  ...
  return {
    stickers: n.map((f) => Iv(f, { includeHidden: i })).filter((f) => f && (i || f.visible !== !1)).sort((f, d) => Number(f.zIndex || 0) - Number(d.zIndex || 0)),
...
function fh(e, t, n = {}) {
  ...
  return i.stickers.forEach((d) => {
    ...
    !p || w <= 0 || S <= 0 || (f.add(v), c.push({
      assetId: v,
      source: p,
      revision: String(((C = n.revisionFor) == null ? void 0 : C.call(n, v, y, p)) ?? [
        v,
...
const Pr = Math.PI / 180, Dv = xc, Lv = wc, xa = { Nu: 14, Nv: 9 }, Rv = { Nu: 24, Nv: 14 }, Ov = 10, Mf = 0.16, Fv = 3, Vv = 220, Hv = "pano_suite.ui_settings.v1", jv = 120;
function zv() {
  var t;
  const e = {
    invert_view_x: !1,
  ...
  try {
    const n = String(((t = window == null ? void 0 : window.localStorage) == null ? void 0 : t.getItem(Hv)) || "").trim();
    if (!n) return e;
...
function ro(e, t, n = {}) {
  ...
  const i = e.__panoDomPreview, a = i == null ? void 0 : i.widget, c = i == null ? void 0 : i.root, f = (p = c == null ? void 0 : c.querySelector) == null ? void 0 : p.call(c, "div"), d = i == null ? void 0 : i.canvas, h = c == null ? void 0 : c.parentElement, v = h == null ? void 0 : h.parentElement, y = (w) => {
    var C;
    if (!w) return null;
    const S = (C = w.getBoundingClientRect) == null ? void 0 : C.call(w);
    return {
...
function ph(e, t, n) {
  $v(e) && (e.size = [Math.max(1, Number(t || 1)), Math.max(1, Number(n || 1))]);
}
function Bl(e) {
  var t;
...
function vh(e) {
  ...
  const t = {
    activeBackend: "none",
    attach(n = {}) {
      const i = String(n.mode || "stickers") === "cutout" ? "cutout" : "stickers", a = i === "cutout" ? "dom" : gh(i, e).chosenPath, c = Bl(e);
      ...
      c !== "none" && Nr(e, { keepMonitor: i === "stickers" }), Nb(e, { ...n, mode: i, __panoForcedPath: a }), this.activeBackend = Bl(e);
    },
    rebind(n = {}) {
...
function ms(e, t, n = 0) {
  ...
  let f = ao(Pf(i, c));
  const d = n * Pr, h = Math.cos(d), v = Math.sin(d), y = kf(io(c, h), io(f, v)), p = kf(io(c, -v), io(f, h));
  return { fwd: i, right: ao(y), up: ao(p) };
}
function Bv(e, t = "#00ff00") {
  const n = {
    version: 1,
...
function Nc(e) {
  var d, h;
  const t = Uv(e), n = Number((e == null ? void 0 : e.__panoLiveStateVersion) || 0), i = String(((d = wa(e, "bg_color")) == null ? void 0 : d.value) || "#1a1a1e"), a = Number(((h = wa(e, "coverage")) == null ? void 0 : h.value) || 360) === 180 ? 180 : 360, c = e.__panoStateCache;
...
function _h(e, t, n = null) {
  ...
  return !i && n != null && (i = Kv(e == null ? void 0 : e.graph, n)), i;
}
function Gv(e) {
...
function Wv(e, t = ["erp_image", "bg_erp"]) {
  var h;
  const n = Array.isArray(e == null ? void 0 : e.inputs) ? e.inputs : [];
  if (!n.length) return [];
  const a = gs(e, t).map((v) => n.findIndex((y) => String((y == null ? void 0 : y.name) || "") === String(v))).filter((v) => v >= 0), c = n.map((v, y) => ({ input: v, idx: y })).filter(({ input: v }) => String((v == null ? void 0 : v.type) || "").toUpperCase() === "IMAGE").map(({ idx: v }) => v), f = [.../* @__PURE__ */ new Set([...a, ...c])], d = [];
  for (const v of f) {
    const y = _h(e, v);
    ...
    if (p == null) continue;
    const w = bh(e == null ? void 0 : e.graph, p), { originId: S } = yh(w);
  ...
  ensureBound() {
    ...
    this.bound || !((e = bn) != null && e.addEventListener) || (this.listener = (t) => {
      ...
      [...this.nodes].forEach((c) => {
        ...
        Wv(c, ["erp_image", "bg_erp"]).some((C) => Uo(i, C)), !(String(c.__panoPreviewMode || "") === "cutout" && !f) && (Sa(c), (y = (v = c.__panoDomPreview) == null ? void 0 : v.requestDraw) == null || y.call(v), (p = c.setDirtyCanvas) == null || p.call(c, !0, !0), (S = (w = c.graph) == null ? void 0 : w.setDirtyCanvas) == null || S.call(w, !0, !0), String(c.__panoPreviewMode || ""), String(c.__panoPreviewMode || ""), void 0);
      });
...
function xh(e) {
  ...
  if (!t) return [];
  if (qv(t)) return [t];
  const { filename: n, subfolder: i } = Yv(t);
  if (!n) return [t];
...
function eb(e, t = null) {
  ...
  return v.addEventListener("loadedmetadata", S, { once: !0 }), v.addEventListener("canplay", S, { once: !0 }), p || v.addEventListener("timeupdate", C), v.addEventListener("play", M), v.addEventListener("pause", V), v.src = d, v.load(), h.src = d, h.video = v, v;
}
function tb(e, t = null) {
  ...
  for (const R of d)
    if (h = Cn(R), h) break;
  if (!h) return null;
  const v = Number((e == null ? void 0 : e.__panoOwnOutputRev) || 0), p = xh(h).map((R) => Mc(R, v));
  ...
  return C.onload = () => {
    var R;
    e.__panoOwnOutputImageCache === S && S.pendingImg === C && S.pendingSrc === w && (S.src = w, S.img = C, S.pendingSrc = "", S.pendingImg = null), t == null || t(), (R = e.setDirtyCanvas) == null || R.call(e, !0, !0);
  }, C.onerror = () => {
    if (M + 1 >= p.length) {
      e.__panoOwnOutputImageCache === S && S.pendingImg === C && (S.pendingSrc = "", S.pendingImg = null);
      return;
    }
    V();
  }, S.pendingSrc = w, S.pendingImg = C, V(), S.img && (S.img.complete || S.img.naturalWidth || S.img.width) ? S.img : C;
}
function nb(e, t = []) {
  var v, y;
  const n = Array.isArray(e == null ? void 0 : e.inputs) ? e.inputs : [];
  if (!n.length) return { src: "", sourceType: "", inputName: "" };
  const a = gs(e, t).map((p) => n.findIndex((w) => String((w == null ? void 0 : w.name) || "") === String(p))).filter((p) => p >= 0), c = n.map((p, w) => ({ input: p, idx: w })).filter(({ input: p }) => String((p == null ? void 0 : p.type) || "").toUpperCase() === "IMAGE").map(({ idx: p }) => p), f = [.../* @__PURE__ */ new Set([...a, ...c])];
  for (const p of f) {
    const w = n[p], S = w == null ? void 0 : w.link;
    if (S == null) continue;
    const C = bh(e.graph, S), { originId: M, originSlot: V } = yh(C);
    if (M == null) continue;
    const R = _h(e, p, M);
    if (!R) continue;
...
function rb(e, t = [], n = {}) {
  const i = nb(e, t), a = String((i == null ? void 0 : i.src) || "").trim();
  if (!a) return null;
  const c = xh(a);
  ...
  const w = () => {
    var C, M, V, R;
    if (p += 1, p >= c.length) {
      if (((M = (C = e.__panoLinkedInputImageCache) == null ? void 0 : C.get) == null ? void 0 : M.call(C, d)) === y && y.pendingImg === v && (y.pendingSrcRaw = "", y.pendingResolvedSrc = "", y.pendingImg = null, !y.img))
        try {
...
function gr(e, t, n = "") {
  ...
  return t ? (i.isLoading || (i.isLoading = !0, i.loadingSinceTs = a), !0) : i.isLoading ? a - Number(i.loadingSinceTs || 0) < jv ? !0 : (i.isLoading = !1, i.loadingSinceTs = 0, !1) : !1;
}
function qo(e, t) {
...
function Co(e) {
  const n = ob(e) + 2, i = 8, a = _n(e), c = Math.max(120, Number((a == null ? void 0 : a[0]) || 0) - 16), f = Math.max(84, Number((a == null ? void 0 : a[1]) || 0) - n - 8);
...
function Kl(e, t, n) {
  return fh(t, (i, a) => kh(e, i, a), { scene: n });
}
function lb(e, t) {
  var f;
  const n = Ah(e, t);
  if (!n) return [];
  const i = Th(t), a = Array.isArray((f = t == null ? void 0 : t.painting) == null ? void 0 : f.groups) ? t.painting.groups : [], c = new Map(
...
function If(e, t, n, i, a, c, f, d) {
  const h = n.x * (i.y - a.y) + i.x * (a.y - n.y) + a.x * (n.y - i.y);
  if (Math.abs(h) < 1e-6) return;
  const [v, y, p] = cb(c, f, d, Number(e.__panoTriExpandPx || 0.45));
  e.save(), e.beginPath(), e.moveTo(v.x, v.y), e.lineTo(y.x, y.y), e.lineTo(p.x, p.y), e.closePath(), e.clip();
  const w = (c.x * (i.y - a.y) + f.x * (a.y - n.y) + d.x * (n.y - i.y)) / h, S = (c.x * (a.x - i.x) + f.x * (n.x - a.x) + d.x * (i.x - n.x)) / h, C = (c.x * (i.x * a.y - a.x * i.y) + f.x * (a.x * n.y - n.x * a.y) + d.x * (n.x * i.y - i.x * n.y)) / h, M = (c.y * (i.y - a.y) + f.y * (a.y - n.y) + d.y * (n.y - i.y)) / h, V = (c.y * (a.x - i.x) + f.y * (n.x - a.x) + d.y * (i.x - n.x)) / h, R = (c.y * (i.x * a.y - a.x * i.y) + f.y * (a.x * n.y - n.x * a.y) + d.y * (n.x * i.y - i.x * n.y)) / h;
  e.transform(w, M, S, V, C, R), e.drawImage(t, 0, 0), e.restore();
}
function Ph(e, t, n, i) {
...
function Ch(e, t, n, i, a, c, f, d = 12, h = 9) {
  var H;
  const v = q(Number(f.hFOV_deg || 30), 1, 179) * Pr, y = q(Number(f.vFOV_deg || 30), 1, 179) * Pr, p = Math.tan(v * 0.5), w = Math.tan(y * 0.5), S = f.crop || {}, C = q(Number(S.x0 ?? 0), 0, 1), M = q(Number(S.y0 ?? 0), 0, 1), V = q(Number(S.x1 ?? 1), 0, 1), R = q(Number(S.y1 ?? 1), 0, 1), D = Math.max(1e-4, V - C), I = Math.max(1e-4, R - M), T = ms(Number(f.yaw_deg || 0), Number(f.pitch_deg || 0), Number(f.rot_deg || f.roll_deg || 0)), $ = [], X = [], oe = [], ie = [];
  for (let se = 0; se <= h; se++) {
    const B = se / h, K = (1 - (M + B * I) * 2) * w;
    for (let le = 0; le <= d; le++) {
      const we = le / d, De = ((C + we * D) * 2 - 1) * p, Ue = T.fwd.x + T.right.x * De + T.up.x * K, Je = T.fwd.y + T.right.y * De + T.up.y * K, Qe = T.fwd.z + T.right.z * De + T.up.z * K, it = Math.hypot(Ue, Je, Qe) || 1e-8, Ht = Ue / it, Ct = Je / it, pn = Qe / it, sn = Ht * i.right.x + Ct * i.right.y + pn * i.right.z, Kn = Ht * i.up.x + Ct * i.up.y + pn * i.up.z, u = Ht * i.fwd.x + Ct * i.fwd.y + pn * i.fwd.z;
      if (u <= 1e-4)
  ...
  const xe = (H = c.assets) == null ? void 0 : H[f.asset_id], A = kh(t, f.asset_id, xe);
  ...
  for (let se = 0; se < h; se++)
    for (let B = 0; B < d; B++) {
      ...
      const Qe = oe[se][B] * be, it = ie[se][B] * he, Ht = oe[se][B + 1] * be, Ct = ie[se][B + 1] * he, pn = oe[se + 1][B] * be, sn = ie[se + 1][B] * he, Kn = oe[se + 1][B + 1] * be, u = ie[se + 1][B + 1] * he;
      If(e, A, { x: Qe, y: it }, { x: Ht, y: Ct }, { x: Kn, y: u }, { x: ne, y: K }, { x: le, y: we }, { x: Ue, y: Je }), If(e, A, { x: Qe, y: it }, { x: Kn, y: u }, { x: pn, y: sn }, { x: ne, y: K }, { x: Ue, y: Je }, { x: Ee, y: De });
    }
}
function ub(e, t, n = null) {
  ...
  const c = ms(Number(e.__panoPreviewView.yaw || 0), Number(e.__panoPreviewView.pitch || 0), 0), f = Math.tan(Number(e.__panoPreviewView.fov || 100) * Pr * 0.5);
  ...
  ), h = !!(d && d.complete && (d.naturalWidth || d.width)), v = Cc(e), y = n != null && n.state ? n.state.inertia.active || n.state.drag.active : !1, p = v || y, w = xa, S = Ul(e, i), C = Kl(e, i, S), M = Sc(e.__panoPreviewView, i == null ? void 0 : i.coverage);
  let V = !1;
  if (e.__panoRuntimeCore || (e.__panoRuntimeCore = Ur()), h) {
    const T = ds({
      stateRevision: [
        ...
        Array.isArray(C) ? C.map((oe) => `${String((oe == null ? void 0 : oe.assetId) || "")}:${String((oe == null ? void 0 : oe.revision) || "")}`).join(",") : ""
      ].join("|"),
      backgroundSource: d,
      backgroundRevision: [
        String(d.currentSrc || d.src || ""),
  ...
  const R = p ? 8 : 12, D = p ? 6 : 9, I = sb(e, i);
  if (!h || I.length === 0) {
    const T = qo(t == null ? void 0 : t.canvas, a);
    Eh(t, a, c, f, T);
  }
  !V && h && Yo(e, t, a, c, f, d, w), !V && I.length > 0 && I.forEach((T) => Ch(t, e, a, c, f, i, T, R, D)), t.restore();
}
function fb(e, t, n, i, a = "preview_scene", c = "") {
  const f = String(
    c || [
...
function hb(e, t, n) {
  var a, c;
  const i = db(t, n || (nt == null ? void 0 : nt.canvas));
  return i ? {
...
function so(e) {
  ...
  e.__panoPreviewMode, String((e == null ? void 0 : e.comfyClass) || (e == null ? void 0 : e.type) || (e == null ? void 0 : e.title) || ""), _n(e), e.__panoLegacyPreviewHooked = !0, e.__panoPreviewHooked = !0, e.__panoActiveBackend = "legacy_draw", ph(e, 320, 180), jn(e);
  ...
  e.onDrawForeground = function() {
    ...
    try {
      const C = arguments[0];
      C && !((w = this.flags) != null && w.collapsed) && (i.stepInertia(performance.now()) && ((S = this.setDirtyCanvas) == null || S.call(this, !0, !1)), ub(this, C, i));
    } catch {
    }
    return p;
  }, e.onResize = function() {
    ...
    return this.__panoUserResized = !0, Ai(this, 150), (w = this.setDirtyCanvas) == null || w.call(this, !0, !0), Vh(this, 220, null), p;
  };
  const i = hs({
  ...
  e.onMouseWheel = function(p, w, S) {
    var C, M;
    try {
      if ((C = this.flags) != null && C.collapsed) return h ? h.apply(this, arguments) : void 0;
      const V = yl(this, p, w, S), R = Co(this);
      if (!V || !Cf(V.x, V.y, R)) return h ? h.apply(this, arguments) : void 0;
...
function Ah(e, t) {
  ...
  if (!a && !c) return null;
  const f = pb(e, t), d = `${f.width}x${f.height}`;
...
function bb(e, t, n, i, a, c) {
  ...
  const h = Ih(e, c, f.width, f.height).getContext("2d", { willReadFrequently: !0 });
  if (!h) {
    t.drawImage(n, 0, 0, i, a);
    return;
  }
  try {
    ...
    for (let C = 0; C < a; C += 1) {
      const M = (C + 0.5) * f.height / a - 0.5, V = q(Math.floor(M), 0, S), R = q(V + 1, 0, S), D = q(M - V, 0, 1);
      for (let I = 0; I < i; I += 1) {
...
function Lf(e, t, n, i) {
  ...
  if (!h || h.__revKey !== d || h.width !== a || h.height !== c) {
    ...
    v.clearRect(0, 0, a, c), v.drawImage(t, 0, 0, a, c), bb(e, v, n, a, c, "__panoPreviewOverlayScratch"), h.__revKey = d;
  }
  return h;
}
function yb(e, t, n, i = null) {
  ...
  if (w)
    if (a === "cutout") {
      ...
      ), M = !!(C && C.complete && (C.naturalWidth || C.width));
      (t.width !== y || t.height !== p) && (t.width = y, t.height = p);
      const V = { x: 0, y: 0, w: y, h: p }, R = M ? q(Number((C.naturalWidth || C.width) / Math.max(1, Number(C.naturalHeight || C.height || 1))), 0.05, 20) : 1, D = S ? xr(S) : null, I = q(Number((D == null ? void 0 : D.aspect) || R || 1), 0.05, 20), T = Mh(V, I);
      qo(t, V), w.setTransform(1, 0, 0, 1, 0, 0), w.fillStyle = "#070707", w.fillRect(0, 0, y, p);
      let $ = "none", X = "Open editor and add frame", oe = "";
      if (oe = String((C == null ? void 0 : C.src) || ""), S)
        if (C && !M)
          $ = "loading";
        else if (M) {
          const ie = Ul(e, c), xe = Kl(e, c, ie), A = lb(e, c), be = Qi({
            stateRevision: [
        ...
        if (M) {
          const ie = Df(e, c), xe = ie != null && ie.source ? Lf(e, C, ie.source, ie.revision || "") : C;
          ab(w, xe, V, 0.44);
        }
        $ = "empty", X = "Open editor and add frame";
      }
      $ === "loading" ? (oo(e, !1), gr(e, !0, oe)) : $ === "empty" ? (oo(e, !0, X), gr(e, !1, "")) : (oo(e, !1), gr(e, !1, ""));
    } else {
      oo(e, !1), (t.width !== y || t.height !== p) && (t.width = y, t.height = p);
      const S = { x: 0, y: 0, w: y, h: p }, C = qo(t, S);
      ...
      const I = Ul(e, c), T = Kl(e, c, I), $ = Sc(e.__panoPreviewView, c == null ? void 0 : c.coverage), X = Df(e, c), oe = (X == null ? void 0 : X.source) || null, ie = D && oe ? Lf(e, R, oe, (X == null ? void 0 : X.revision) || "") : R, xe = ie !== R ? String(ie.__revKey || "") : R ? [
      ...
      if (D) {
        const fe = e.__panoDomRuntimeCore.syncState(
          fb(ie, c, I, T, "runtime_dom_scene", xe)
      ...
      if (D && A)
        ...
        Yo(e, w, S, M, V, ie, xa), gr(e, !1, "");
      else if (oe)
        Yo(e, w, S, M, V, oe, xa), gr(e, !!R && !D, String((R == null ? void 0 : R.src) || ""));
      else {
        const he = !!R && !D;
        gr(e, he, String((R == null ? void 0 : R.src) || "")), he && Nh(w, S, C);
      }
      if ((!D || be.length === 0) && Eh(w, S, M, V, C), !A && be.length > 0) {
        const he = Cc(e), fe = i != null && i.state ? i.state.inertia.active || i.state.drag.active : !1, H = he || fe, se = H ? 8 : 12, B = H ? 6 : 9;
        be.forEach((ne) => Ch(w, e, S, M, V, c, ne, se, B));
      } else if (!R || !D) {
        const he = Math.max(14, Math.round(16 * C));
        w.fillStyle = "rgba(212,212,216,0.85)", w.font = `600 ${he}px Plus Jakarta Sans, Geist, sans-serif`, w.textAlign = "center", w.fillText("Open editor to add stickers", y * 0.5, p * 0.5 + 24 * C);
      }
    }
}
function Yo(e, t, n, i, a, c, f = Rv) {
...
function _b(e, t = performance.now()) {
  const n = Dh(e);
  if (n.lastFrameTs > 0) {
    const i = Math.max(1, t - n.lastFrameTs);
    n.frameEmaMs <= 0 ? n.frameEmaMs = i : n.frameEmaMs = n.frameEmaMs * (1 - Mf) + i * Mf;
  }
...
function Fh(e, t = 0, n = null, i = 1200) {
...
function Gl(e, t = null, n = 0) {
  return {
    ...
    afterResize() {
      e.__panoUserResized = !0, Ai(e, 150), t == null || t(), Vh(e, 180, t);
    }
  };
}
...
function Sb(e, t, n, i = "erp_image", a = xa) {
  var I, T, $;
  kc(e, "standalone");
  const c = qo(t == null ? void 0 : t.canvas, n), f = ea(e), d = ms(Number(f.yaw || 0), Number(f.pitch || 0), 0), h = Math.tan(Number(f.fov || 100) * Pr * 0.5), v = gs(e, [i, "erp_image", "bg_erp"]), p = mh(e) ? eb(e, () => {
    var X, oe;
  ...
  ), w = Jv(p), S = String((p == null ? void 0 : p.currentSrc) || (p == null ? void 0 : p.src) || ""), C = Number((($ = (T = (I = e == null ? void 0 : e.widgets) == null ? void 0 : I.find) == null ? void 0 : T.call(I, (X) => (X == null ? void 0 : X.name) === "coverage")) == null ? void 0 : $.value) || 360) === 180 ? 180 : 360, M = wh(p), V = String(e.__panoStandaloneLastFrameSrc || ""), R = !!e.__panoStandaloneLastFrameCanvas && !!S && S === V;
  if (e.__panoStandaloneCore || (e.__panoStandaloneCore = Ur()), w) {
    const X = ds({
      ...
      backgroundOpacity: 1,
      showMaskTint: !1
    }), ie = e.__panoStandaloneCore.syncState(X) ? e.__panoStandaloneCore.renderToTarget("preview_node", Ev(f, C), {
      width: n.w,
      height: n.h,
      dpr: window.devicePixelRatio || 1
    }) : null, xe = !!ie;
    if (ie) {
      ...
      const be = Ih(e, "__panoStandaloneLastFrameCanvas", n.w, n.h).getContext("2d");
...
function Nb(e, t = {}) {
  var ne;
  const n = t.__allowStandalone === !0, i = mh(e);
  if (i && !n) {
    Sr(e);
    return;
  }
  i && Oh(e), e.__panoPreviewMode = String(t.mode || "stickers") === "cutout" ? "cutout" : "stickers", Ci.register(e);
  ...
  const d = String(t.__panoForcedPath || "").trim(), h = a ? gh(e.__panoPreviewMode, e) : {
    chosenPath: "dom",
  ...
  if (hh(), S.className = "pano-node-preview-dom", S.classList.add(a ? "pano-node-preview--stickers" : "pano-node-preview--cutout"), p && S.classList.add("pano-node-preview--no-preview"), S.setAttribute("data-capture-wheel", "true"), S.setAttribute("tabindex", "-1"), S.style.cssText = [
    "width:100%",
    ...
    jn(e), e.__panoDomPreview = { widget: K, root: S, requestDraw: () => {
  ...
  V.style.cssText = [
    ...
    "padding:0 10px",
    "z-index:2"
  ].join(";"), V.textContent = "Open editor and add frame", C.appendChild(M), C.appendChild(V), S.appendChild(C), ph(e, 120, 120), jn(e);
  let R = null;
  try {
    Fh(e, w, () => {
      var K, le;
  ...
  const $ = () => {
    ...
    const K = 3, le = (we) => {
      requestAnimationFrame(() => {
        var De;
        const Ee = !!(S != null && S.isConnected && (C != null && C.isConnected) && (M != null && M.isConnected) && Number(C.clientHeight || 0) > 0 && Number(M.clientHeight || 0) > 0);
        if (!Ee && we < K) {
          le(we + 1);
          return;
        }
        if (e.__panoDomProbePending = !1, e.__panoPreviewMode, Number((C == null ? void 0 : C.clientHeight) || 0), Number((M == null ? void 0 : M.clientHeight) || 0), !Ee) {
          if (c) {
            e.__panoPreviewMode, Number((C == null ? void 0 : C.clientHeight) || 0), Number((M == null ? void 0 : M.clientHeight) || 0);
            return;
          }
    ...
    (D.needsDraw || le) && (D.needsDraw = !1, (we = e.flags) != null && we.collapsed || yb(e, M, null, oe), (Ee = e.setDirtyCanvas) == null || Ee.call(e, !0, !1)), (le || D.needsDraw) && (D.raf = requestAnimationFrame(X)), dh() && (!e.__panoDebugLastTs || K - e.__panoDebugLastTs > 1200) && (e.__panoDebugLastTs = K, e.__panoPreviewMode, _n(e), qi(S), qi(C), qi(M), qi(S.parentElement), qi((De = S.parentElement) == null ? void 0 : De.parentElement), Number(M.width || 0), Number(M.height || 0), void 0);
  }, oe = hs({
    getView: () => (e.__panoPreviewView || (e.__panoPreviewView = { yaw: 0, pitch: 0, fov: 100 }), e.__panoPreviewView),
    setView: (K) => {
  ...
  M.addEventListener("pointerdown", (K) => {
    var le, we;
    Vn(K, C) && f && K.button === 0 && ((le = S.focus) == null || le.call(S), (we = M.setPointerCapture) == null || we.call(M, K.pointerId), M.style.cursor = "grabbing", oe.startDrag(K.clientX, K.clientY, K.pointerId));
  }), M.addEventListener("pointermove", (K) => {
    !f || !oe.state.drag.active || (Vn(K, C), oe.moveDrag(K.clientX, K.clientY, "pano"));
  });
  const ie = (K) => {
    var le;
    !f || !oe.state.drag.active || (Vn(K, C), (le = M.releasePointerCapture) == null || le.call(M, K.pointerId), M.style.cursor = "grab", oe.endDrag(), Pc(e), I());
  };
  ...
  const xe = (K) => {
    ...
    oe.applyWheelEvent(K) && I(), (we = K.preventDefault) == null || we.call(K), (Ee = K.stopPropagation) == null || Ee.call(K), (De = K.stopImmediatePropagation) == null || De.call(K), requestAnimationFrame(() => {
      var Ue, Je;
      Rh(le), (Je = (Ue = nt == null ? void 0 : nt.canvas) == null ? void 0 : Ue.setDirty) == null || Je.call(Ue, !0, !0);
    });
  };
  ["wheel", "mousewheel", "DOMMouseScroll"].forEach((K) => {
    C.addEventListener(K, xe, { passive: !1, capture: !0 }), M.addEventListener(K, xe, { passive: !1, capture: !0 });
  }), ["contextmenu", "mousedown", "mouseup", "mousemove", "click", "dblclick"].forEach((K) => {
    M.addEventListener(K, (le) => Vn(le, C)), C.addEventListener(K, (le) => Vn(le, C));
  });
...
function kb(e, t = {}, n = null) {
  ...
  const c = (h) => {
    ...
    if (Number((v == null ? void 0 : v.clientWidth) || 0), Number((v == null ? void 0 : v.clientHeight) || 0), Number(((C = h == null ? void 0 : h.canvas) == null ? void 0 : C.clientWidth) || 0), Number(((M = h == null ? void 0 : h.canvas) == null ? void 0 : M.clientHeight) || 0), a.frame, h != null && h.widget, (V = h == null ? void 0 : h.root) != null && V.isConnected && ((R = h == null ? void 0 : h.canvas) != null && R.isConnected), !(h != null && h.widget) || !((D = h.root) != null && D.isConnected) || !((I = h.canvas) != null && I.isConnected)) {
      c();
      return;
    }
    if (Mb(h)) {
...
function Pb(e, t = {}) {
  ...
  if (!(e.__panoPreviewAttached === !0 && e.__panoPreviewMountKey === n)) {
    if (Sr(e), e == null || e.id, _n(e), Number(((i = _n(e)) == null ? void 0 : i[0]) || 0), Number(((a = _n(e)) == null ? void 0 : a[1]) || 0), e == null || e.addDOMWidget, Nr(e, { keepMonitor: !1, reason: "attach_standalone_unified_begin" }), ua(e), typeof (e == null ? void 0 : e.addDOMWidget) == "function" && kb(e, t, n)) {
...
function Cb(e, t = {}) {
  ...
  try {
    ...
    h.style.cssText = "position:absolute;inset:0;width:100%;height:100%;display:block;object-fit:cover;touch-action:none;cursor:grab;", d.appendChild(h), f.appendChild(d), Fh(e, 56, () => {
      var B, ne;
    ...
    const p = { raf: 0, needsDraw: !0, dragging: !1, pointerId: null }, w = { listeners: 0, raf: 0, widget: 0 }, S = hs({
      ...
      setView: (B) => {
        const ne = ea(e);
        ne.yaw = Vt(Number(B.yaw || 0)), ne.pitch = q(Number(B.pitch || 0), -89.9, 89.9), ne.fov = q(Number(B.fov || 100), Dv, Lv);
      },
      getViewportSize: () => {
    ...
    const M = (B) => {
      ...
      window.addEventListener("pointermove", B, !0), window.addEventListener("pointerup", ne, !0), window.addEventListener("pointercancel", K, !0), w.listeners += 3, C = () => {
        window.removeEventListener("pointermove", B, !0), window.removeEventListener("pointerup", ne, !0), window.removeEventListener("pointercancel", K, !0), w.listeners = Math.max(0, w.listeners - 3), C = null;
      };
    }, R = () => {
    ...
    const T = (B = performance.now()) => {
      ...
      if (_b(e, B), !p.needsDraw && !le && I > 20) return;
      p.needsDraw = !1;
      ...
      if (!Qe) return;
      Sb(e, Qe, { x: 0, y: 0, w: Ue, h: Je }, i, xa), (Ct = e.setDirtyCanvas) == null || Ct.call(e, !0, !1), (p.needsDraw || le) && (p.raf = requestAnimationFrame(T));
    }, $ = (B) => {
      var ne, K, le;
      Vn(B, d) && B.button === 0 && ((ne = f.focus) == null || ne.call(f), (K = h.setPointerCapture) == null || K.call(h, B.pointerId), p.pointerId = B.pointerId, p.dragging = !0, h.style.cursor = "grabbing", S.startDrag(B.clientX, B.clientY, B.pointerId, performance.now()), (le = h.hasPointerCapture) == null || le.call(h, B.pointerId), V(), R());
    }, X = (B) => {
      if (p.dragging) {
        if (Vn(B, d), !Ef(B)) {
          oe(B);
      ...
      p.dragging && (Vn(B, d), p.dragging = !1, p.pointerId = null, h.style.cursor = "grab", S.endDrag(performance.now()), C == null || C(), R());
    }, ie = (B) => oe(B, (B == null ? void 0 : B.type) || "pointerup"), xe = () => {
      p.dragging && (p.dragging = !1, p.pointerId = null, h.style.cursor = "grab", S.endDrag(performance.now()), C == null || C(), R());
    }, A = (B) => {
      var De, Ue, Je;
      if (!Vn(B, d)) return;
      const ne = Lh(), K = document.activeElement, le = Number(ea(e).fov || 100), we = S.applyWheelEvent(B), Ee = Number(ea(e).fov || 100);
      Number(B.deltaY || 0), we && R(), (De = B.preventDefault) == null || De.call(B), (Ue = B.stopPropagation) == null || Ue.call(B), (Je = B.stopImmediatePropagation) == null || Je.call(B), requestAnimationFrame(() => {
        var Qe, it;
        Rh(ne), (it = (Qe = nt == null ? void 0 : nt.canvas) == null ? void 0 : Qe.setDirty) == null || it.call(Qe, !0, !0);
      });
    };
    ...
    return e.onExecuted = function(B) {
      ro(e, "onExecuted"), Sh(e, B), Sa(e), jn(e), R();
      ...
      var B, ne, K;
      return (ne = (B = e.__panoStandaloneModal) == null ? void 0 : B.dispose) == null || ne.call(B), e.__panoStandaloneModal = null, Bo(e), p.raf && (cancelAnimationFrame(p.raf), w.raf += 1), C == null || C(), h.removeEventListener("pointerdown", $), h.removeEventListener("pointermove", X), h.removeEventListener("pointerup", ie), h.removeEventListener("pointercancel", ie), h.removeEventListener("lostpointercapture", xe), h.removeEventListener("wheel", A, !0), d.removeEventListener("wheel", A, !0), w.listeners = Math.max(0, w.listeners - 7), be.forEach((le) => {
        d.removeEventListener(le, M, !0), h.removeEventListener(le, M, !0), w.listeners = Math.max(0, w.listeners - 2);
      }), Tf(e, v) && (w.widget += 1), (K = D == null ? void 0 : D.disconnect) == null || K.call(D), e.__panoResizeSettleTimer && (clearTimeout(e.__panoResizeSettleTimer), e.__panoResizeSettleTimer = null), e.__panoBootMinHeightTimer && (clearTimeout(e.__panoBootMinHeightTimer), e.__panoBootMinHeightTimer = null), e.__panoBootMinHeightActive = !1, e.__panoDomPreview = null, e.__panoDomRestore = null, e.__panoStandaloneController = null, e.__panoPreviewAttached = !1, e.__panoPreviewMountKey = null, e.onResize = fe, e.onExecuted = H, e.onConnectionsChange = se, Ci.unregister(e), { ...w }, e.onRemoved = he, he ? he.apply(this, arguments) : void 0;
    }, e.__panoDomRestore = () => {
      var B, ne;
      (ne = (B = e.__panoStandaloneModal) == null ? void 0 : B.dispose) == null || ne.call(B), e.__panoStandaloneModal = null, Bo(e), p.raf && (cancelAnimationFrame(p.raf), w.raf += 1), C == null || C(), h.removeEventListener("pointerdown", $), h.removeEventListener("pointermove", X), h.removeEventListener("pointerup", ie), h.removeEventListener("pointercancel", ie), h.removeEventListener("lostpointercapture", xe), h.removeEventListener("wheel", A, !0), d.removeEventListener("wheel", A, !0), w.listeners = Math.max(0, w.listeners - 7), be.forEach((K) => {
        d.removeEventListener(K, M, !0), h.removeEventListener(K, M, !0), w.listeners = Math.max(0, w.listeners - 2);
      }), Tf(e, v) && (w.widget += 1), e.__panoBootMinHeightTimer && (clearTimeout(e.__panoBootMinHeightTimer), e.__panoBootMinHeightTimer = null), e.__panoBootMinHeightActive = !1, e.__panoDomPreview = null, e.__panoDomRestore = null, e.__panoStandaloneController = null, e.__panoPreviewAttached = !1, e.__panoPreviewMountKey = null, e.onResize = fe, e.onExecuted = H, e.onConnectionsChange = se, e.onRemoved = he, { ...w }, ua(e);
...
function Hb(e, t) {
  ...
  const n = Ob(e.targetSpace);
  if (!n) return null;
  const i = String(e.toolKind || "").trim(), a = Vb(e.geometry, n, i, t === "paint");
  if (!a) return null;
...
function fa(e) {
  ...
  return !e || typeof e != "object" ? t : {
    version: 1,
    groups: Rb(e.groups),
    paint: Vf(e.paint, "paint"),
    mask: Vf(e.mask, "mask"),
    raster_objects: Bb(e.raster_objects)
  };
}
function Hf(e = {}) {
  return {
...
function jf(e = {}, t = 0) {
  ...
  return n === "sticker" ? (i.transform = Ub((e == null ? void 0 : e.transform) || e), i.params = {
  ...
  if (e != null && e.objectPass && Array.isArray(e.objectPass.objects))
    return Pi({
      ...
      objectPass: {
        ...
        objects: e.objectPass.objects.map((c, f) => jf(c, f)).filter(Boolean)
      },
      overlay: e != null && e.overlay && typeof e.overlay == "object" ? { ...e.overlay } : {}
    });
  const t = Hf((e == null ? void 0 : e.background) || {}), n = (Array.isArray(e == null ? void 0 : e.objects) ? e.objects : []).map((c, f) => jf(c, f)).filter(Boolean);
  return Pi({
    stateRevision: String((e == null ? void 0 : e.stateRevision) || ""),
    background: t,
    objectPass: {
...
function Yb(e, t, n = {}) {
  ...
  function h() {
    const w = Number((n == null ? void 0 : n.width) || t.clientWidth || i.clientWidth || 1), S = Number((n == null ? void 0 : n.height) || t.clientHeight || i.clientHeight || 1), C = Number((n == null ? void 0 : n.dpr) || window.devicePixelRatio || 1), M = Zo({ width: w, height: S, dpr: C });
...
function Jb({
  ...
  if (!v) return y;
  const p = ((I = t.find(($) => a(e.paintColor, $.color))) == null ? void 0 : I.id) || "", w = !p, S = c(e.customPaintColor), C = Math.round(Math.max(0, Math.min(1, Number(((T = e.customPaintColor) == null ? void 0 : T.a) ?? 1))) * 100), M = d(e.primaryTool === "paint" ? e.paintTool : e.maskTool), V = e.brushSizes[M] ?? 10, R = h(), D = Array.from({ length: 8 }, ($, X) => e.customPaintHistory[X] || null);
  return {
    ...y,
    colorEnabled: e.paintTool !== "eraser",
    activeSwatchId: p,
...
function Qb({ coverage: e, uiSettings: t, normalizeCoverageValue: n }) {
  return {
...
function ty({
  ...
  const C = a.corners.map((I) => I.x), M = a.corners.map((I) => I.y), V = Math.min(...C), R = Math.max(...C), D = Math.max(...M);
  return {
    visible: !0,
    left: (V + R) * 0.5,
    top: D + 18,
...
const Be = {
  ...
  setup(e) {
    ...
    return (i, a) => (Pe(), Ii(M0(e.tag), Zd({
      class: ["pano-btn pano-btn-icon", e.extraClass]
    }, n.value, { innerHTML: e.icon }), null, 16, ["class", "innerHTML"]));
  }
}, ny = { class: "pano-floating-right" }, ry = ["data-settled"], iy = ["data-ready", "data-settled"], ay = ["aria-label", "data-tip", "innerHTML"], oy = {
  key: 1,
    ...
    return (t, n) => (Pe(), Ie(et, null, [
      ...
      cc(ue("div", {
        ...
        ue("div", {
          ...
          e.preview.ready !== !0 && e.preview.settled !== !0 ? (Pe(), Ie("div", oy, Mt(e.preview.label || "Preview unavailable"), 1)) : on("", !0)
        ], 14, iy)
      ], 8, ry), [
        [mc, e.preview.visible]
      ])
    ], 64));
  }
}, ly = ["aria-label"], cy = { class: "pano-canvas-confirm-title" }, uy = { class: "pano-canvas-confirm-text" }, fy = { class: "pano-canvas-confirm-actions" }, dy = {
  ...
  setup(e) {
    ...
    function d() {
      ...
      const C = c()[0] || p;
      (M = C == null ? void 0 : C.focus) == null || M.call(C);
    }
    function h() {
    ...
    function v(p) {
      ...
      const C = w[0], M = w[w.length - 1], V = document.activeElement;
      if (p.shiftKey) {
        (V === C || V === S || !(S != null && S.contains(V))) && (p.preventDefault(), M.focus());
        return;
      }
      (V === M || !(S != null && S.contains(V))) && (p.preventDefault(), C.focus());
    }
    function y(p) {
    ...
    return wi(() => t.model.visible, (p, w) => {
      ...
      ue("div", {
        ...
        ue("div", cy, Mt(e.model.title), 1),
        ue("div", uy, Mt(e.model.text), 1),
        ue("div", fy, [
          w[0] || (w[0] = ue("button", {
            class: "pano-btn",
            type: "button",
          ...
          ue("button", dy, Mt(e.model.confirmLabel || "Confirm"), 1)
        ])
      ], 40, ly)
    ], 512)) : on("", !0);
  }
}, py = ["data-paint-pane"], my = ["hidden"], gy = ["data-paint-color-swatch", "aria-label", "aria-pressed", "disabled"], vy = ["aria-pressed", "disabled"], by = ["hidden"], yy = { class: "pano-paint-color-pop-head" }, _y = { class: "pano-paint-color-field" }, xy = {
  class: "pano-paint-sv-panel",
  "data-paint-color-sv": ""
}, wy = {
  class: "pano-paint-hue-strip",
  "data-paint-hue-strip": ""
}, Sy = { class: "pano-paint-color-field" }, Ny = { class: "pano-paint-alpha-wrap" }, My = ["value"], ky = { "data-paint-alpha-value": "" }, Py = ["hidden"], Cy = {
  class: "pano-paint-color-history-list",
  "data-paint-color-history": ""
}, Ay = ["data-paint-history-index", "aria-label", "disabled"], Ty = ["data-paint-footer"], Iy = ["data-paint-group"], Ey = ["hidden"], Dy = ["value", "disabled"], Ly = {
        ...
        return Pe(), Ie("div", {
            ...
            ue("div", {
              ...
              ue("label", Sy, [
                ...
                ue("div", Ny, [
                  ...
                  ue("span", ky, Mt(e.state.alphaText || "100%"), 1)
                ])
              ]),
              ue("div", {
          ...
          ue("div", {
            ...
            ue("div", {
              ...
              ue("span", Ly, Mt(e.state.sizeText || "10"), 1)
            ], 10, Ey),
            ue("div", {
...
}, Vy = ["innerHTML"], Hy = ["data-aspect"], jy = ["data-action", "aria-label", "data-tip", "disabled", "innerHTML"], zy = {
  ...
  class: "pano-side",
  "data-side": ""
}, By = { class: "pano-side-head" }, Uy = ["innerHTML"], Ky = {
  key: 0,
  class: "pano-side-scroll"
}, Gy = { class: "pano-inspector" }, Wy = { class: "pano-ui-row pano-coverage-row" }, qy = ["data-selected"], Yy = ["aria-pressed", "disabled"], Xy = ["aria-pressed", "disabled"], Zy = {
  key: 0,
...
}, e_ = ["disabled"], t_ = ["innerHTML"], n_ = ["hidden"], r_ = ["data-selection-id", "innerHTML"], i_ = {
  key: 2,
  class: "pano-state-actions"
}, a_ = ["disabled"], o_ = ["innerHTML"], s_ = ["data-key"], l_ = ["min", "max", "step", "value", "disabled", "data-param-key"], c_ = ["min", "max", "step", "value", "disabled", "data-param-key"], u_ = { class: "pano-visibility-section" }, f_ = { class: "pano-visibility-stack" }, d_ = ["data-visibility-row"], h_ = { class: "pano-visibility-name" }, p_ = ["innerHTML"], m_ = ["data-visibility", "aria-label", "aria-pressed", "data-tip", "disabled", "innerHTML"], g_ = ["open"], v_ = ["innerHTML"], b_ = { class: "pano-ui-settings-body" }, y_ = { class: "pano-ui-row" }, __ = ["data-selected"], x_ = ["aria-pressed"], w_ = ["aria-pressed"], S_ = { class: "pano-ui-row" }, N_ = ["data-selected"], M_ = ["aria-pressed"], k_ = ["aria-pressed"], P_ = { class: "pano-ui-row" }, C_ = {
...
}, T_ = { class: "pano-picker-label" }, I_ = ["hidden"], E_ = ["data-quality"], D_ = {
  key: 1,
      ...
      return Pe(), Ie("div", $y, [
        ...
        a.value ? (Pe(), Ie("div", Ky, [
          ue("div", Gy, [
            ...
            e.model.transformTitle !== !1 ? (Pe(), Ie("div", Zy, [...h[2] || (h[2] = [
              ue("span", null, "Transform", -1)
            ])])) : on("", !0),
            e.model.selectionPicker ? (Pe(), Ie("div", Jy, [
              ...
              ue("div", Qy, [
                ...
                ue("div", {
                  ...
                  (Pe(!0), Ie(et, null, Gt(e.model.selectionPicker.items || [], (C) => (Pe(), Ie("button", {
                    key: C.id,
                    type: "button",
                    class: gt(["pano-picker-item", { active: C.active === !0 }]),
            ...
            e.model.copyStateButton ? (Pe(), Ie("div", i_, [
              ue("button", {
            ...
            ue("div", {
              ...
              (e.model.notes || []).length ? (Pe(!0), Ie(et, { key: 0 }, Gt(e.model.notes, (C) => (Pe(), Ie("div", {
                key: C,
                class: "pano-param-note"
              }, Mt(C), 1))), 128)) : (Pe(!0), Ie(et, { key: 1 }, Gt(e.model.params || [], (C) => (Pe(), Ie("div", {
                key: C.key,
                class: "pano-field",
                "data-key": C.key
              }, [
                ue("label", null, Mt(C.label), 1),
                ue("input", {
                  type: "range",
                  min: C.min,
                  max: C.max,
            ...
            (e.model.visibilityRows || []).length ? (Pe(), Ie(et, { key: 3 }, [
              ...
              ue("div", u_, [
                ...
                ue("div", f_, [
                  (Pe(!0), Ie(et, null, Gt(e.model.visibilityRows, (C) => (Pe(), Ie("div", {
                    key: C.key,
                    class: gt(["pano-visibility-row", { "is-hidden": C.visible === !1, "is-disabled": C.enabled === !1 }]),
                    ...
                    ue("span", h_, [
                      ...
                      ue("span", null, Mt(C.label), 1)
                    ]),
                    ue("button", {
                      class: gt(["pano-visibility-toggle", { active: C.visible === !0 }]),
                      type: "button",
                      ...
                      innerHTML: C.visible === !0 ? gi(Be).eye : gi(Be).eye_dashed
                    }, null, 10, m_)
                  ], 10, d_))), 128))
                ])
              ])
            ...
            e.model.uiSettings ? (Pe(), Ie("details", {
              ...
              ue("div", b_, [
                ...
                ue("div", P_, [
                  ...
                  ue("div", C_, [
                    ue("button", A_, [
                      ue("span", T_, Mt(e.model.uiSettings.qualityLabel), 1),
                    ...
                    ue("div", {
                      ...
                      (Pe(!0), Ie(et, null, Gt(e.model.uiSettings.qualityOptions || [], (C) => (Pe(), Ie("button", {
                        key: C.value,
                        type: "button",
                        class: gt(["pano-picker-item", { active: C.active === !0 }]),
                        "data-action": "set-quality",
                        "data-quality": C.value
                      }, Mt(C.label), 11, E_))), 128))
                    ], 8, I_)
                  ])
                ]),
        ...
        (e.model.footerButtons || []).length ? (Pe(), Ie("div", D_, [
          (Pe(!0), Ie(et, null, Gt(e.model.footerButtons, (C) => (Pe(), Ie("button", {
            key: C.action,
            class: gt(["pano-btn", { "pano-btn-primary": C.primary === !0 }]),
            type: "button",
            "data-action": C.action
          }, Mt(C.label), 11, L_))), 128))
        ])) : on("", !0)
      ]);
    };
  }
...
}, H_ = ["data-video-ready"], j_ = { class: "pano-video-transport-shell" }, z_ = { class: "pano-video-controls-left" }, $_ = { class: "pano-video-filmstrip" }, B_ = {
  class: "pano-video-filmstrip-track",
  "aria-hidden": "true"
}, U_ = ["src", "onLoad"], K_ = {
  key: 1,
  class: "pano-video-thumb-placeholder"
}, G_ = ["max", "value", "disabled"], W_ = { class: "pano-video-controls-right" }, q_ = ["data-has-audio"], Y_ = {
  class: "pano-video-volume-pop",
  "aria-hidden": "true"
}, X_ = ["value", "disabled"], Z_ = {
  ...
  setup(e) {
    ...
    }), S = /* @__PURE__ */ Io(/* @__PURE__ */ new Set()), C = (D) => String((D == null ? void 0 : D.id) || (D == null ? void 0 : D.src) || (D == null ? void 0 : D.label) || ""), M = (D) => S.value.has(C(D)), V = (D) => {
      const I = new Set(S.value);
      I.add(C(D)), S.value = I;
    };
    wi(w, (D) => {
      const I = new Set(D.map(C)), T = /* @__PURE__ */ new Set();
...
}, J_ = { class: "pano-floating-top" }, Q_ = ["data-selected", "data-view-count"], ex = ["data-view", "aria-pressed", "aria-label", "disabled"], tx = ["innerHTML"], nx = { class: "label" }, rx = {
...
const ix = ["aria-label"], ax = { class: "pano-stage-wrap" }, ox = {
  __name: "PanoModal",
  props: {
  ...
  setup(e, { emit: t }) {
    const n = e, i = t;
    let a = "", c = !1, f = null;
    const d = /* @__PURE__ */ Io(null), h = Pt(() => n.readOnly === !0), v = Pt(() => n.shellPreset || jh(n.type)), y = Pt(() => {
      var I;
    ...
    function R(D) {
      document.removeEventListener("keydown", C), D ? (f || (f = document.activeElement), M(), document.addEventListener("keydown", C), sc(() => {
        w();
      })) : (V(), S());
    }
    return Cd(() => {
      ...
      V(), document.removeEventListener("keydown", C), S();
    }), wi(() => n.open, (D) => {
      R(D);
    }), (D, I) => e.open ? (Pe(), Ie("div", {
      key: 0,
      class: "pano-modal-overlay",
      onClick: I[0] || (I[0] = nh((T) => i("close"), ["self"]))
    }, [
      ue("section", {
        ref_key: "modalRef",
        ref: d,
...
], Tt = Math.PI / 180, yr = 180 / Math.PI, Qo = 24, sx = 4, lx = 4, co = /* @__PURE__ */ new Map(), zf = /* @__PURE__ */ new Map(), uo = /* @__PURE__ */ new Map(), _r = /* @__PURE__ */ new Map(), cx = 12, Ot = {
...
const $h = "pano_suite.ui_settings.v1", Bh = "pano_suite.node_grid_visibility.v1";
...
function Sx(e) {
  ...
  mi = t;
  try {
    (n = window == null ? void 0 : window.localStorage) == null || n.setItem($h, JSON.stringify(t));
  } catch {
  }
  return t;
}
...
function Bf(e) {
  const { paintCount: t, maskCount: n } = Cx(e), i = Array.isArray(e == null ? void 0 : e.raster_objects) ? e.raster_objects : [];
  let a = 0, c = 0;
  return i.forEach((f) => {
...
function Tx(e, t = 2048, n = "#00ff00", i = 360) {
  const a = wx(), c = {
    version: 1,
    projection_model: "pinhole_rectilinear",
    alpha_mode: "straight",
  ...
  try {
    ...
    return a && (h.ui_settings = da({ ...h.ui_settings, ...a })), h.output_preset = Yl(t, Number(h.output_preset || c.output_preset)), h.bg_color = String(n || h.bg_color || c.bg_color), h.coverage = Ft(i), delete h.editor_history, h;
  } catch {
...
function Ex(e) {
  ...
  const y = c, p = f, w = d;
  t.value = v, (S = t.callback) == null || S.call(t, v), n.value = y, (C = n.callback) == null || C.call(n, y), i.value = p, (M = i.callback) == null || M.call(i, p), a && (a.value = w, (V = a.callback) == null || V.call(a, w)), (R = e.setDirtyCanvas) == null || R.call(e, !0, !0), e.__panoCoverageWidgetOrderMigrated = !0;
}
function Ml(e) {
...
function Ox(e, t, n = null) {
  ...
  return !i && n != null && (i = Rx(e == null ? void 0 : e.graph, n)), i;
}
function Ma(e) {
  var a;
  if (!e || typeof e != "object") return "";
...
function Wh(e) {
  ...
  if (!t) return [];
  if (Fx(t)) return [t];
  const { filename: n, subfolder: i } = Vx(t);
  if (!n) return [t];
...
function $x(e, t) {
  ...
  const d = Kh(e.graph, f), { originId: h, originSlot: v } = Gh(d);
  if (h == null) return { src: "", sourceType: "", inputName: n };
  const y = Ox(e, a, h), p = Number(v || 0);
  ...
  const S = ha((y == null ? void 0 : y.id) ?? h), C = zx(S, p), M = kl(C);
...
function Bx(e, t, n, i = null) {
  ...
  const p = () => {
    ...
    if (y += 1, y >= c.length) {
      try {
        (C = (S = e.__panoLinkedInputImageCache) == null ? void 0 : S.delete) == null || C.call(S, f);
      } catch {
      }
      return;
    }
...
`), d = e.__panoLinkedInputImageCache.get(c);
  ...
  return y.onload = () => {
    ...
    try {
      (M = (C = e.__panoLinkedInputImageCache) == null ? void 0 : C.delete) == null || M.call(C, c);
    } catch {
    }
  }, S(), y;
}
...
function Pl(e, t = [], n = null, i = "") {
  const a = Array.isArray(t) ? t : [t], c = qh(e, a), f = String(i || a.join("|") || "image_exact"), d = Array.isArray(c == null ? void 0 : c.srcCandidates) ? c.srcCandidates : [];
  if (d.length) return Ux(e, f, d, n);
  const h = String((c == null ? void 0 : c.src) || "").trim();
  return h ? Bx(e, f, h, n) : null;
}
async function pa(e, t, n = {}) {
  const i = (n == null ? void 0 : n.readOnly) === !0, a = (n == null ? void 0 : n.hideSidebar) ?? i, c = i, f = Dx(e, t);
  await xx();
  const d = vn(e, "output_preset"), h = vn(e, "coverage"), v = vn(e, "bg_color"), y = vn(e, Jo), p = Tx(
  ...
  })() : null, S = w ? iu(w, !1) : { width: 220, height: 132 }, C = jh(t), M = /* @__PURE__ */ os({
  ...
  const sn = t === "stickers" ? p.active.selected_sticker_id : p.active.selected_shot_id, Kn = JSON.stringify(Uf(p)), u = {
    mode: "pano",
    selectedId: sn,
    viewYaw: 0,
    viewPitch: 0,
    ...
    historyController: Db(80, { entries: [Kn], index: 0 }),
    primaryTool: "cursor",
    paintTool: "pen",
    maskTool: "pen",
    ...
    menuMode: "",
    cutoutAspectOpen: !1,
    showGrid: Nx(e == null ? void 0 : e.id, !0),
    showPanorama: !0,
    showObjects: !0,
    showMask: !0,
  ...
  const ln = () => {
    ...
    if (x < 1 || N < 1) return;
    const P = Math.max(0, Number(_.duration || o || 0)), k = document.createElement("canvas"), L = 46, F = Math.max(72, Math.round(x / N * L));
    ...
    for (let re = 0; re < Se; re += 1) {
      ...
      const pe = re / (Se - 1), ae = P > 0 ? Math.max(0, Math.min(P - Math.max(1e-3, 0.5 / Math.max(1, Number(s || 24))), P * pe)) : 0;
    ...
    j.thumbnailJobId === g && (M.videoTransport.thumbnails = z, M.videoTransport.thumbnailCount = z.length || Se, hx(l, {
      thumbnails: z,
  ...
  if (ke.push(() => {
    ...
    const r = () => {
      ...
      const b = (x, N) => {
        ...
        const P = Number((N == null ? void 0 : N.mediaTime) ?? H.currentTime ?? 0), k = jt(P), L = ft();
        j.mode === "scrub" ? Math.abs(P - Number(j.editorTime || 0)) <= L && (cn(k), Ei(j.editorTime), U.backgroundDirty = !0, U.dirty = !0, Wn({
          ready: !0,
          playing: !1,
          visible: ur(),
          ...
          mode: "scrub"
        }), ge({ cause: "frame_view", localOnly: !0 })) : (j.editorTime = P, j.presentedTime = P, j.requestedTime = null, j.currentFrameNumber = k, cn(k), j.frameCounter += 1, H.dataset.panoFrameIdx = String(j.frameCounter), U.backgroundDirty = !0, U.dirty = !0, Wn({
          ready: !0,
  ...
  function bs(r, o, s = u.viewFov, l = 140, m = 620) {
    const g = Sv(u.viewYaw, r), _ = o - u.viewPitch, b = s - u.viewFov, x = Math.hypot(g, _) + Math.abs(b) * 0.6, N = Math.round(q(l + x * 2.2, l, m));
    u.viewTween = {
      active: !0,
  ...
  function Qh() {
    const r = new Set(Zh()), s = zt().filter((l) => r.has(String((l == null ? void 0 : l.actionGroupId) || "")));
    return r.forEach((l) => {
  ...
  function ep(r, o, s) {
    ...
    let N = 1 / 0, P = -1 / 0, k = 1 / 0, L = -1 / 0;
    m.forEach((W) => {
      const re = l((W == null ? void 0 : W.u) || 0), pe = mn(re, x);
      N = Math.min(N, pe), P = Math.max(P, pe);
    ...
    return {
      centerUv: { u: ((x + (N + P) * 0.5) % 1 + 1) % 1, v: q((k + L) * 0.5, 0, 1) },
      rot_deg: 0,
      halfW: (P - N) * 0.5 + ee,
      halfH: (L - k) * 0.5 + ee,
      uvPad: ee
  ...
  function lr(r, o, s) {
    ...
    if (!m) return null;
    const g = s || xn(l, o);
    return m.frame = ep(l, o, g), m.frame;
  }
  function qr() {
    var l;
  ...
  function _s(r = !0) {
    ...
    if (r) {
      const x = String(((l = (s = u.interaction) == null ? void 0 : s.stroke) == null ? void 0 : l.actionGroupId) || "").trim(), N = String(((g = (m = u.interaction) == null ? void 0 : m.stroke) == null ? void 0 : g.layerKind) || "").trim(), P = String(((b = (_ = u.interaction) == null ? void 0 : _.stroke) == null ? void 0 : b.toolKind) || "").trim();
      x && N === "paint" && P !== "eraser" && !o.includes(x) && o.push(x);
    }
    return o;
  }
  function xs(r = !0) {
    ...
    const o = qr();
    if (!r) return o;
    const s = String(((x = (b = u.interaction) == null ? void 0 : b.stroke) == null ? void 0 : x.actionGroupId) || "").trim(), l = String(((P = (N = u.interaction) == null ? void 0 : N.stroke) == null ? void 0 : P.layerKind) || "").trim(), m = String(((L = (k = u.interaction) == null ? void 0 : k.stroke) == null ? void 0 : L.toolKind) || "").trim();
  ...
  function rp() {
    ...
    let r = null;
    try {
      const g = _s(), _ = ((m = (l = (s = (o = u.paintEngine) == null ? void 0 : o.getErpTarget) == null ? void 0 : s.call(o, g)) == null ? void 0 : l.displayPaint) == null ? void 0 : m.canvas) || null;
      _ && (r = {
        source: _,
        revision: `${ii()}:${Ta()}`
      });
  ...
  function Ta() {
    ...
    const s = String(((x = r == null ? void 0 : r.item) == null ? void 0 : x.actionGroupId) || ""), l = String(((N = r == null ? void 0 : r.item) == null ? void 0 : N.rasterObjectId) || ((P = r == null ? void 0 : r.item) == null ? void 0 : P.id) || "");
  ...
  function ip(r, o = "paint") {
    var g, _, b;
    const s = String(r || "").trim(), m = `geomv5:${String(o || "paint").trim() || "paint"}:${s}:${u.mode}:${ji()}`;
    if (u.mode === "frame") {
      const x = Ke(), N = String((x == null ? void 0 : x.id) || ""), P = x ? Lt(x) : null;
  ...
  function Ss(r, o = null, s = null) {
    ...
    if (m.forEach((P) => {
      const k = (P == null ? void 0 : P.geometry) || null, L = (k == null ? void 0 : k.geometryKind) === "lasso_fill" ? k == null ? void 0 : k.points : (k == null ? void 0 : k.processedPoints) || (k == null ? void 0 : k.rawPoints) || (k == null ? void 0 : k.points) || [];
      Array.isArray(L) && g.push(...L);
    }), !g.length) return { u: 0.5, v: 0.5 };
    const _ = Number(((N = g[0]) == null ? void 0 : N.u) || 0);
    let b = 0, x = 0;
    return g.forEach((P) => {
      b += _ + mn(Number((P == null ? void 0 : P.u) || 0), _), x += Number((P == null ? void 0 : P.v) || 0);
    }), {
      u: (b / g.length % 1 + 1) % 1,
      v: q(x / g.length, 0, 1)
    };
  ...
  function Ea(r, o, s = 1, l = 0) {
    ...
    const m = Number((o == null ? void 0 : o.u) || 0), g = Number((o == null ? void 0 : o.v) || 0), _ = mn(Number(r.u || 0), m), b = Number(r.v || 0) - g, x = Number(l || 0) * Tt, N = Math.cos(x), P = Math.sin(x), k = Math.max(0.02, Number(s || 1)), L = (_ * N - b * P) * k, F = (_ * P + b * N) * k;
    return {
      ...r,
      u: ((m + L) % 1 + 1) % 1,
      v: q(g + F, 0, 1)
  ...
  function Ec(r, o, s, l = null, m = null, g = null) {
    ...
    if (x.forEach((k) => {
      ...
      !F || !ee || (Array.isArray(ee.points) && (F.points = ee.points.map((z) => Ia(z, o, s)), P = !0), Array.isArray(ee.rawPoints) && (F.rawPoints = ee.rawPoints.map((z) => Ia(z, o, s)), P = !0), Array.isArray(ee.processedPoints) && (F.processedPoints = ee.processedPoints.map((z) => Ia(z, o, s)), P = !0));
    }), P && g) {
  ...
  function Dc(r, o = 1, s = 0, l = null, m = null, g = null) {
    const _ = Ri(r, m), b = String(_.actionGroupId || "").trim();
    if (!b) return !1;
    const x = si(_.layerKind), N = Array.isArray(l) ? l : xn(b, _.layerKind), P = Array.isArray(N) ? new Map(N.map((F) => [String((F == null ? void 0 : F.id) || ""), F])) : null, k = (g == null ? void 0 : g.centerUv) ?? Ss(b, _.layerKind, N);
    let L = !1;
    if (x.forEach((F) => {
      if (String((F == null ? void 0 : F.actionGroupId) || "").trim() !== b) return;
      const ee = (P == null ? void 0 : P.get(String((F == null ? void 0 : F.id) || ""))) || F, z = F == null ? void 0 : F.geometry, W = ee == null ? void 0 : ee.geometry;
  ...
  function Lc(r, o, s, l = null) {
    ...
    if (!g) return !1;
    const _ = l && typeof l == "object" ? l : g, b = (_ == null ? void 0 : _.transform) || {}, x = Number(b.du || 0) + Number(o || 0), N = q(Number(b.dv || 0) + Number(s || 0), -1, 1);
    return g.transform || (g.transform = { du: 0, dv: 0, rot_deg: 0, scale: 1 }), g.transform.du = x, g.transform.dv = N, !0;
  }
  function ap(r, o = 1, s = null) {
    const l = At(r);
    if (!l) return !1;
    const m = en().find((N) => String((N == null ? void 0 : N.id) || "").trim() === l);
    if (!m) return !1;
  ...
  function lt() {
    ...
    if (o) return o;
    const s = Yr(r);
    return s || (t === "cutout" ? ws().find((l) => String((l == null ? void 0 : l.id) || "") === r) || null : Gn().find((l) => String((l == null ? void 0 : l.id) || "") === r) || null);
  }
  function wn() {
    ...
    return r.forEach((l) => {
      ...
      if (!m || s.has(m)) return;
      s.add(m);
      const g = m === String(u.selectedId || "") ? lt() : Xr(m) || Yr(m) || (t === "cutout" ? ws().find((_) => String((_ == null ? void 0 : _.id) || "") === m) : Gn().find((_) => String((_ == null ? void 0 : _.id) || "") === m));
      g && o.push(g);
    }), o;
  }
  function Ns(r = null) {
    ...
    const l = s.flatMap((N) => N.corners.map((P) => Number((P == null ? void 0 : P.x) || 0))), m = s.flatMap((N) => N.corners.map((P) => Number((P == null ? void 0 : P.y) || 0))), g = Math.min(...l), _ = Math.max(...l), b = Math.min(...m), x = Math.max(...m);
    return {
      kind: "multiSelection",
      visible: !0,
  ...
  function Rc() {
    const r = (Array.isArray(p.shots) ? p.shots : []).map((s, l) => ({
      ...
      var g, _;
      const m = It(s) ? String(s.id || Or) : String(((_ = (g = p.assets) == null ? void 0 : g[s.asset_id]) == null ? void 0 : _.name) || s.asset_id || s.id || `Image ${l + 1}`);
      return {
        kind: "image",
        item: s,
        label: m
  ...
  function Oc(r) {
    return !r || !r.item ? Ml(String((r == null ? void 0 : r.label) || "")) : `<span class="pano-picker-item-icon" aria-hidden="true">${up(r.kind)}</span><span>${Ml(String(r.label || ""))}</span>`;
  }
  function Fc() {
    return ys();
  }
  ...
  function fp(r) {
    return It(r) && Zr(r) ? uh : 1;
  }
  function dp() {
    return u.primaryTool === "mask" ? u.maskTool : u.paintTool;
  }
  function hp() {
    return String(dp() || "") === "lasso_fill";
  }
  function pp() {
    if (i) return;
    const r = lt();
    !r || !It(r) || (r.visible = Zr(r), Dt(), ut(), yt(), ze(), $e(), ge());
  }
  function mp() {
  ...
  function ei() {
    ...
    const { videoKey: r } = Hc(), o = ks(r)[0] || null, s = o && typeof o == "object" ? Ma(o) : Gr(o), l = bp(), m = Math.max(0, Number((l == null ? void 0 : l.frames) || 0)), g = Math.max(1, Number((l == null ? void 0 : l.fps) || 24)), _ = Number((l == null ? void 0 : l.duration) || (m > 0 ? m / g : 0)), b = !!(l != null && l.has_audio) || Ce(H);
  ...
  function As(r, o = null) {
    const s = ks(r), l = Array.isArray(s) && s.length ? s[0] : null, m = Gr(l);
    if (!m) return null;
  ...
  function xp(r) {
    ...
    try {
      ...
      const _ = Number(g.yaw_deg), b = Number(g.pitch_deg), x = Number(g.roll_deg), N = Number(g.hFOV_deg);
  ...
  function wp(r) {
    ...
    if (Number.isFinite(m) && Number.isFinite(g)) {
      const x = q(m, 0.1, 179) * Tt, N = q(g, 0.1, 179) * Tt, P = Math.tan(N * 0.5);
      if (Math.abs(P) > 1e-6) {
        const k = Math.tan(x * 0.5) / P;
        Number.isFinite(k) && k > 0 && (_ = k);
      }
    }
    if (r != null && r.asset_id && ((b = p == null ? void 0 : p.assets) != null && b[r.asset_id])) {
      const x = p.assets[r.asset_id], N = Number((x == null ? void 0 : x.w) || 0), P = Number((x == null ? void 0 : x.h) || 0);
      N > 0 && P > 0 && (_ = N / P);
    }
    return {
      kind: "pano_sticker_state",
  ...
  function Sp(r) {
    ...
    if (s != null) {
      const x = Kh(e.graph, s), { originId: N, originSlot: P } = Gh(x), k = ha(N), L = [
  ...
  function Uc(r = "sync") {
    ...
    }), m = _p(Vc("pano_sticker_input_pose"), null), g = Sp("sticker_state"), _ = $c(m && typeof m == "object" ? JSON.stringify(m) : g), b = Array.isArray(p.stickers) ? p.stickers : p.stickers = [], x = b.findIndex((F) => String((F == null ? void 0 : F.id) || "") === Or);
    if (s == null) {
    ...
    P || (P = {
      id: Or,
      source_kind: _l
    }, b.push(P)), P.id = Or, P.source_kind = _l, P.source_link_id = Number(s), P.source_state_hash = _, P.visible = P.visible !== !1;
    let L = !1;
    if (k) {
      const F = Np(m, g, l);
      Object.assign(P, F, {
  ...
  function Is() {
    ...
    let o = zn(0, 1, 0);
    Math.abs(Pn(r, o)) > 0.999 && (o = zn(0, 0, 1));
    const s = fi(po(o, r)), l = fi(po(r, s));
    return { right: s, up: l, fwd: r };
  }
  function Oi(r) {
    const { right: o, up: s, fwd: l } = Is(), m = Pn(r, o), g = Pn(r, s), _ = Pn(r, l);
    if (_ <= 1e-5) return null;
    const b = T.width, x = T.height, N = u.viewFov * Tt, P = 2 * Math.atan(Math.tan(N / 2) * (x / b)), k = b / 2 / Math.tan(N / 2), L = x / 2 / Math.tan(P / 2);
    return {
      x: b / 2 + m / _ * k,
      y: x / 2 - g / _ * L,
      z: _
  ...
  function Es(r, o) {
    const { right: s, up: l, fwd: m } = Is(), g = T.width, _ = T.height, b = u.viewFov * Tt, x = 2 * Math.atan(Math.tan(b / 2) * (_ / g)), N = (r - g / 2) / (g / 2) * Math.tan(b / 2), P = (_ / 2 - o) / (_ / 2) * Math.tan(x / 2), k = fo(fo(ho(s, N), ho(l, P)), m);
    return fi(k);
  }
  function fr() {
  ...
  function Kc(r) {
    ...
    const s = Q.get(o);
    if (s) return s;
    const l = (_ = p.assets) == null ? void 0 : _[o], m = jx(l);
    if (!m) return null;
    const g = new Image();
  ...
  function Pp(r) {
    ...
    const x = b.getImageData(0, 0, m, g).data, N = { canvas: _, width: m, height: g, alpha: x, ready: !0 };
    return E.set(o, N), N;
  }
  function Cp(r, o, s = 1, l = 0) {
    if (!r || typeof r != "object") return r;
    const m = Number((o == null ? void 0 : o.u) || 0), g = Number((o == null ? void 0 : o.v) || 0), _ = mn(Number(r.u || 0), m), b = Number(r.v || 0) - g, x = Math.max(0.02, Number(s || 1)), N = Number(l || 0) * Tt, P = Math.cos(N), k = Math.sin(N), L = _ / x, F = b / x, ee = L * P + F * k, z = -L * k + F * P;
    return {
      ...r,
      u: ((m + ee) % 1 + 1) % 1,
      v: g + z
  ...
  function Ap(r, o) {
    ...
    const N = mn(Number(_.u || 0), Number(s.u0 || 0)) / b, P = (Number(_.v || 0) - Number(s.v0 || 0)) / x;
    if (N < 0 || N > 1 || P < 0 || P > 1) return 0;
    const k = Pp(r);
    if (!k) return null;
    const L = q(Math.floor(N * k.width), 0, k.width - 1), F = q(Math.floor(P * k.height), 0, k.height - 1);
    return Number(k.alpha[(F * k.width + L) * 4 + 3] || 0);
  }
  function Wc(r, o, s, l = null) {
    if (!(o != null && o.visible) || !Zn(s, o.corners)) return !1;
    const m = l || Mn(s, performance.now()), g = Ap(r, m);
    return g === null ? !0 : g > 8;
  }
  function Tp() {
    var l, m, g, _, b, x, N, P;
    const r = ((m = (l = u.paintEngine) == null ? void 0 : l.getErpTarget) == null ? void 0 : m.call(l, _s(!1))) || null, o = Math.max(1, Number(((g = r == null ? void 0 : r.descriptor) == null ? void 0 : g.width) || ((b = (_ = r == null ? void 0 : r.displayPaint) == null ? void 0 : _.canvas) == null ? void 0 : b.width) || 2048)), s = Math.max(1, Number(((x = r == null ? void 0 : r.descriptor) == null ? void 0 : x.height) || ((P = (N = r == null ? void 0 : r.displayPaint) == null ? void 0 : N.canvas) == null ? void 0 : P.height) || 1024));
  ...
  function Ip() {
    ...
    const s = Nn(), l = `${Ta()}:${s.width}:${s.height}`;
  ...
  function Ep(r, o, s) {
    ...
    if (r.type === "rasterObject" && ((l = r.item) != null && l.bbox)) {
      const g = r.item.bbox, _ = ((m = r.item) == null ? void 0 : m.transform) || {}, b = Number(g.u0 || 0) + Number(_.du || 0), x = Number(g.u1 || 0) + Number(_.du || 0), N = Number(g.v0 || 0) + Number(_.dv || 0), P = Number(g.v1 || 0) + Number(_.dv || 0);
      return {
    ...
    if (r.type === "strokeGroup") {
      ...
      if (!_) return null;
      const b = _.centerUv.u - _.halfW, x = _.centerUv.u + _.halfW, N = _.centerUv.v - _.halfH, P = _.centerUv.v + _.halfH;
      return {
        minX: Math.floor((b % 1 + 1) % 1 * o),
        maxX: Math.ceil((x % 1 + 1) % 1 * o),
        minY: Math.floor(q(N, 0, 1) * s),
  ...
  function qc(r, o = null) {
    ...
    const { width: g, height: _ } = Tp(), b = (r == null ? void 0 : r.transform) || {}, x = [
      s,
      g,
      _,
      l.u0,
    ...
    if (!k) return null;
    const L = Number(l.u0 || 0) * g, F = Number(l.v0 || 0) * _, ee = Math.max(1, (Number(l.u1 || 0) - Number(l.u0 || 0)) * g), z = Math.max(1, (Number(l.v1 || 0) - Number(l.v0 || 0)) * _), W = L + ee * 0.5 + Number(b.du || 0) * g, re = F + z * 0.5 + Number(b.dv || 0) * _, pe = Number(b.rot_deg || 0) * Tt, ae = Math.max(0.01, Number(b.scale || 1));
  ...
  function Yc(r, o, s, l, m = "modal_object_view") {
    if (!r || !o || !s) return !1;
  ...
  function Xc() {
    ...
    if (Ra && o) return o;
    const s = (async () => {
      var g, _, b, x, N, P, k, L, F, ee, z, W;
      const l = ii(), m = Bf(p.painting);
      if (m.totalPaintCount <= 0 && m.totalMaskCount <= 0) {
        p.painting_layer !== null && (p.painting_layer = null, Rs = l, gn());
        return;
      }
      if (Rs !== l && !Ra) {
        Ra = !0;
        try {
          ...
          if (m.totalPaintCount > 0) {
            ce = await Ls(Me, `pano_paint_${r}.png`);
            for (const Le of re) {
              const Re = String(Le || "").trim();
              if (!Re) continue;
              const Ve = ((W = (z = u.paintEngine) == null ? void 0 : z.getGroupDisplayCanvas) == null ? void 0 : W.call(z, Re)) || null;
              if (!Ve) continue;
              const We = Re.replace(/[^a-zA-Z0-9_-]+/g, "_"), Ge = await Ls(Ve, `pano_group_${r}_${We}.png`);
              Ge && Ne.push({
                id: Re,
                actionGroupId: Re,
                image: Ge
          ...
          m.totalMaskCount > 0 && (ye = await Ls(Z, `pano_mask_${r}.png`)), l === ii() && (p.painting_layer = {
            paint: ce,
            mask: ye,
            groups: Ne,
            revision: l
  ...
  function Ir() {
    if (t === "cutout") {
      ...
      return x || Gf(e, "pano_input_images", Q, () => ge()) || null;
    }
    const r = jc();
    if (r) return r;
    const o = Gf(e, "pano_input_images", Q, () => ge());
    if (o) return o;
    ...
    let g = [];
    return i && (l || m) ? g = l ? ["erp_image", "bg_erp"] : ["bg_erp", "erp_image"] : g = t === "stickers" ? ["bg_erp", "erp_image"] : ["erp_image", "bg_erp"], Pl(e, g, () => ge(), `background:${g.join("|")}`);
  }
  function dr(r) {
  ...
  function Oa(r) {
    ...
    let s = zn(0, 1, 0);
    Math.abs(Pn(o, s)) > 0.999 && (s = zn(0, 0, 1));
    const l = fi(po(s, o)), m = fi(po(o, l)), g = Math.tan(q(Number(r.hFOV_deg || 20), 0.1, 179) * 0.5 * Tt), _ = Math.tan(q(Number(r.vFOV_deg || 20), 0.1, 179) * 0.5 * Tt), b = Number(r.rot_deg || r.roll_deg || 0) * Tt, x = Math.cos(b), N = Math.sin(b);
    return {
      centerDir: o,
      right: l,
      up: m,
  ...
  function hr(r, o, s) {
    ...
    return fi(fo(fo(r.centerDir, ho(r.right, l)), ho(r.up, m)));
  }
  function Zc(r) {
    const o = Oa(r);
    return [
  ...
  function Hp(r) {
    ...
    }, l = Math.max(0.01, Number(((x = r == null ? void 0 : r.transform) == null ? void 0 : x.scale) || 1)), m = Number(((N = r == null ? void 0 : r.transform) == null ? void 0 : N.rot_deg) || 0), g = Number(((P = r == null ? void 0 : r.transform) == null ? void 0 : P.du) || 0), _ = Number(((k = r == null ? void 0 : r.transform) == null ? void 0 : k.dv) || 0);
    return [
  ...
  function Fa() {
    return u.showObjects ? Rp() : { stickers: [], selectedId: null, hoveredId: null };
  }
  function Va(r) {
    return !u.showObjects || !Array.isArray(r == null ? void 0 : r.stickers) || r.stickers.length === 0 ? [] : Op(r);
  }
  function nu() {
    var r, o;
  ...
  function Vi(r) {
    ...
    const o = nu();
    if (!o) return r;
    const s = Bp(), l = r.reduce((_, b) => Math.max(_, Number((b == null ? void 0 : b.zIndex) || 0)), -1), m = (Array.isArray(p.stickers) ? p.stickers : []).reduce((_, b) => Math.max(_, Number((b == null ? void 0 : b.z_index) || 0)), -1), g = Math.max(l, m);
    return r.push({
      id: "mask_display",
      source: o,
      revision: s,
  ...
  function Ha() {
    ...
    for (const g of r) {
      ...
      if ((g == null ? void 0 : g.type) === "rasterObject") {
        ...
        const x = qc(_, () => ge());
        if (!x) continue;
        const N = Lp(x, g, o), P = (_ == null ? void 0 : _.transform) || {};
        s.push({
          id: `raster:${b}`,
          source: N,
          revision: [
  ...
  function Up(r, o = "modal_bg_gl") {
    const s = Fa(), l = Va(s), m = dr(r), g = m ? Jr(r) : "none", _ = u.showObjects ? Ha() : Vi([]), b = null, x = [
      o,
      g,
  ...
  function Kp(r, o, s, l = "modal_bg_gl") {
    var N;
    if (!tu(r, o)) return !1;
    if (!U.backgroundDirty && U.backgroundWasVisible) return !0;
    const { descriptor: m, hasContent: g } = Up(s, l);
    if (!g || !be.syncState(m))
      return Vs(), !1;
  ...
  function Wp(r = !1) {
    ...
    if (r || (eu() ? A.clearRect(0, 0, o, s) : (A.fillStyle = "#070707", A.fillRect(0, 0, o, s))), Ba(), Yc(
      ...
      for (let m = -180; m <= 180; m += 15) {
        ...
        ru(g, "#3f3f46", m % 90 === 0 ? 1.3 : 1);
      }
      for (let m = -75; m <= 75; m += 15) {
        const g = [];
        for (let _ = -180; _ <= 180; _ += 4) g.push(En(_, m));
        ru(g, m === 0 ? "rgba(250, 250, 250, 0.86)" : "#3f3f46", m === 0 ? 1.5 : 1);
      }
      const l = [
  ...
  function qp(r, o = null, s = null, l = null) {
    if (u.mode === "frame") {
      const m = o || Ke();
      if (!m) return [];
      const g = s || Lt(m);
  ...
  function Yp(r, o) {
    const s = String(r.actionGroupId || r.id || "").trim(), l = xn(s, r.layerKind), m = lr(s, r.layerKind, l), g = (m == null ? void 0 : m.centerUv) || Ss(s, r.layerKind, l), _ = u.mode === "unwrap" ? Number((g == null ? void 0 : g.u) || 0) : null, b = [], x = u.mode === "frame" ? Ke() : null, N = x ? Lt(x) : null;
    for (const ae of l) {
      const ve = (ae == null ? void 0 : ae.geometry) || null, Ae = (ve == null ? void 0 : ve.geometryKind) === "lasso_fill" ? ve == null ? void 0 : ve.points : (ve == null ? void 0 : ve.processedPoints) || (ve == null ? void 0 : ve.rawPoints) || (ve == null ? void 0 : ve.points) || [], He = qp(Ae, x, N, _).filter((ce) => Number.isFinite(ce == null ? void 0 : ce.x) && Number.isFinite(ce == null ? void 0 : ce.y));
    ...
    const P = ja(g, null, x, N, _);
    if (!P) {
      const ae = { visible: !1, kind: "strokeGroup" };
      return u._strokeGeomCache.set(o, ae), ae;
    }
    const L = Jh(m).map((ae) => ja(ae, P.x, x, N, _)).filter((ae) => Number.isFinite(ae == null ? void 0 : ae.x) && Number.isFinite(ae == null ? void 0 : ae.y)).map((ae) => ({ x: Number(ae.x || 0), y: Number(ae.y || 0) }));
    if (L.length < 4) {
      const ae = { visible: !1, kind: "strokeGroup" };
      return u._strokeGeomCache.set(o, ae), ae;
    }
  ...
  function Xp(r, o) {
    const s = u.mode === "frame" ? Ke() : null, l = s ? Lt(s) : null, m = Qc(r), g = u.mode === "unwrap" ? Number((m == null ? void 0 : m.u) || 0) : null, _ = ja(m, null, s, l, g), x = Hp(r).map((L) => ja(L, (_ == null ? void 0 : _.x) ?? null, s, l, g)).filter((L) => Number.isFinite(L == null ? void 0 : L.x) && Number.isFinite(L == null ? void 0 : L.y));
  ...
  function qn(r, o = null, s = null, l = null) {
    ...
    const { right: m, up: g, fwd: _ } = Is(), b = Pn(r, m), x = Pn(r, g), N = Pn(r, _), P = T.width, k = T.height, L = u.viewFov * Tt, F = 2 * Math.atan(Math.tan(L / 2) * (k / Math.max(P, 1))), ee = P / 2 / Math.tan(L / 2), z = k / 2 / Math.tan(F / 2), W = Math.max(N, 1e-4), re = Math.max(P, k) * 2;
    return {
      x: q(P / 2 + b / W * ee, -re, P + re),
      y: q(k / 2 - x / W * z, -re, k + re),
      z: W
    };
  }
  function Zp(r) {
    const o = En(Number(r.yaw_deg || 0), Number(r.pitch_deg || 0)), s = u.mode === "frame" ? Ke() : null, l = s ? Lt(s) : null, m = qn(o, null, s, l);
    if (!m) return { visible: !1 };
    const g = Oa(r), b = Zc(r).map((Ae) => qn(Ae, m.x, s, l)).filter((Ae) => Number.isFinite(Ae == null ? void 0 : Ae.x) && Number.isFinite(Ae == null ? void 0 : Ae.y));
    if (b.length < 4) return { visible: !1 };
    const x = hr(g, 0, g.tanY), N = hr(g, 0, g.tanY + Math.max(g.tanY * 0.43, 0.053)), P = qn(x, m.x, s, l);
    if (!P) return { visible: !1 };
    const k = qn(N, (P == null ? void 0 : P.x) ?? m.x, s, l), L = ((k == null ? void 0 : k.x) ?? P.x) - P.x, F = ((k == null ? void 0 : k.y) ?? P.y) - P.y, ee = Math.hypot(L, F) || 1, z = {
      x: P.x + L / ee * 30,
      y: P.y + F / ee * 30
  ...
  function Et(r) {
    if (kt(r)) {
      const m = String(r.actionGroupId || r.id || "").trim(), g = ip(m, r.layerKind), _ = u._strokeGeomCache.get(g);
      return _ || (u._strokeGeomCache.size > 256 && u._strokeGeomCache.clear(), Yp(r, g));
    }
    if ($t(r)) {
      const m = jp(r), g = u._strokeGeomCache.get(m);
      return g || (u._strokeGeomCache.size > 256 && u._strokeGeomCache.clear(), Xp(r, m));
    }
  ...
  function za(r, o, s, l = null) {
    ...
    for (let g = 0; g <= s; g += 1) {
      ...
      const N = Jc(r, b, x), P = u.mode === "unwrap" ? Fs(N, l) : Oi(N);
      P && m.push(P);
    }
    return m;
  }
  ...
  function em(r, o, s) {
    ...
    N.forEach((L) => {
      const F = P.x - L.x, ee = P.y - L.y, z = Math.hypot(F, ee) || 1;
  ...
  function tm(r, o, s, l) {
    ...
    if (bt(r)) {
      ...
      A.globalAlpha = fp(r), u.mode === "frame" ? (A.strokeStyle = s ? "rgba(250, 250, 250, 0.9)" : l ? "rgba(255, 89, 89, 0.72)" : "#71717a", A.lineWidth = s ? 2 : 1, $a(A, o.corners), A.stroke()) : Jp(r, s), A.globalAlpha = m;
      return;
    }
  ...
  function nm(r, o, s) {
    A.fillStyle = s, o.corners.forEach((l) => {
      ...
      var P, k, L, F;
      const m = (((P = l.b) == null ? void 0 : P.x) ?? l.x) - (((k = l.a) == null ? void 0 : k.x) ?? l.x), g = (((L = l.b) == null ? void 0 : L.y) ?? l.y) - (((F = l.a) == null ? void 0 : F.y) ?? l.y), _ = Math.hypot(m, g) || 1, b = m / _, x = g / _, N = 10;
  ...
  function rm() {
    var b;
    const [r, o] = $p(), s = wn(), l = s.length > 1, m = t === "cutout" ? Qp() : Gn(), g = m.map((x) => `${String((x == null ? void 0 : x.id) || "")}:${un(x) ? "frame" : Number((x == null ? void 0 : x.z_index) || 0)}`).join("|");
    ...
    for (const x of _) {
      ...
      const P = bt(x), k = un(x), L = cr(x);
      if (!P && !k)
        continue;
      const F = Et(x);
      if (!(t !== "stickers" && !F.visible) && (tm(x, F, N, L), N && F.visible)) {
        const ee = L ? "#ff4d4f" : P && It(x) ? "#f59e0b" : "#0070f3";
        nm(x, F, ee);
      }
    }
    if (l) {
      ...
      if (x != null && x.visible) {
        ...
        for (let P = 1; P < x.corners.length; P += 1) A.lineTo(x.corners[P].x, x.corners[P].y);
        A.closePath(), A.stroke(), A.setLineDash([]), A.fillStyle = N, x.corners.forEach((P) => {
      ...
      s.forEach((x) => {
        ...
        A.closePath(), A.stroke(), A.setLineDash([]), A.fillStyle = P, N.corners.forEach((k) => {
          A.beginPath(), A.arc(k.x, k.y, 6.5, 0, Math.PI * 2), A.fill();
        }), A.restore();
      });
    if (((b = u.interaction) == null ? void 0 : b.kind) === "marquee_select") {
      const x = wu(u.interaction.start, u.interaction.current);
  ...
  function sm(r, o = {}) {
    if (!r) return "";
    const s = Ir(), l = s && dr(s) ? Jr(s) : "no_bg", m = im(r);
    return [
  ...
  function lm() {
    ...
    const l = Fa(), m = Va(l), g = dr(o), _ = g ? Jr(o) : "none", b = u.showObjects ? Ha() : Vi([]), x = Qi({
      stateRevision: [
    ...
    const P = am(s), k = P ? O.present() : !1;
    P || O.requestRender(), M.cameraPreview.ready = !0, M.cameraPreview.label = P && k ? "" : "Loading preview", M.cameraPreview.settled = P && k && U.pendingStableLayoutFrames <= 0 && U.hasPresentedFrame;
  }
  function cm(r, o, s, l = {}) {
    if (!he || !s) return !1;
    const m = Ir(), g = Fa(), _ = Va(g), b = dr(m), x = u.showObjects ? Ha() : Vi([]);
    return b || _.length > 0 || x.length > 0 ? (he.syncScene(Qi({
      stateRevision: sm(s, l),
  ...
  function zs(r, o, s = !1) {
    ...
    const g = (z) => !z || typeof z != "object" ? { x: 0, y: 0 } : m.get(z) || um(z), _ = (z, W, re, pe = {}) => {
      const ae = l ? (Number(W) % 1 + 1) % 1 : Number(W), ve = fm(z, ae, re, pe);
    ...
    const x = dm(o, s), N = (z, W) => {
      const re = [0];
      for (let ce = 1; ce < z.length; ce += 1) {
        const ye = g(z[ce - 1]), Ne = g(z[ce]);
        re.push(re[ce - 1] + Math.hypot(Ne.x - ye.x, Ne.y - ye.y));
      }
      ...
      for (let ce = 0; ce <= pe + 1e-9; ce += W) {
        ...
        const ye = re[ve], Ne = re[ve + 1], Le = Math.max(1e-8, Ne - ye);
        ae.push(b(z[ve], z[ve + 1], q((ce - ye) / Le, 0, 1)));
      }
  ...
  function Dt() {
    u.objectVisualRevision = Number(u.objectVisualRevision || 0) + 1, gm(), U.backgroundDirty = !0, U.dirty = !0;
  }
  ...
  function vm(r, o, s, l, m = null) {
    const g = hm(r), _ = Bt(o, "widthScale", 1) * Bt(o, "pressureLike", 1);
  ...
  function _m(r, o, s, l, m = {}) {
    ...
    for (let b = 0; b < o.length - 1; b += 1) {
      const x = o[b], N = o[b + 1];
      if (!x || !N) continue;
      const P = Number(x.x || 0), k = Number(x.y || 0), L = Number(N.x || 0), F = Number(N.y || 0), ee = Math.max(0.5, Math.min(g, Number(x.radiusPx || 0.5))), z = Math.max(0.5, Math.min(g, Number(N.radiusPx || 0.5)));
      if (!Number.isFinite(P) || !Number.isFinite(k) || !Number.isFinite(L) || !Number.isFinite(F) || !Number.isFinite(ee) || !Number.isFinite(z)) continue;
      const W = L - P, re = F - k, pe = Math.hypot(W, re);
  ...
  function wm(r, o, s, l, m) {
    ...
    for (let k = 1; k < o.length; k += 1)
      r.lineTo(Number(((N = o[k]) == null ? void 0 : N[g]) || 0) * l.w, Number(((P = o[k]) == null ? void 0 : P[_]) || 0) * l.h);
  ...
  function Sm(r, o) {
    ...
    return !Array.isArray(s) || !s.length ? [] : s.map((l) => ({
      ...
      radiusPx: vm(r, l, Number((o == null ? void 0 : o.w) || 1), Number((o == null ? void 0 : o.h) || 1))
    }));
  }
  function su(r, o, s = null) {
    ...
    if (String(((P = o == null ? void 0 : o.geometry) == null ? void 0 : P.geometryKind) || "") === "lasso_fill")
      return wm(r.ctx, ou(m), m, l), !0;
    const _ = Sm(m, l);
    return _.length ? (xm(r.ctx, _, m, l), !0) : !1;
  }
  function Nm(r, o, s, l = 8) {
  ...
  function km(r, o, s = {}) {
    var N;
    const l = Number((r == null ? void 0 : r.width) || 0), m = Number((r == null ? void 0 : r.height) || 0), g = (N = r == null ? void 0 : r.getContext) == null ? void 0 : N.call(r, "2d");
    if (!g || l < 1 || m < 1) return [];
    const _ = g.getImageData(0, 0, l, m), b = new Uint8Array(l * m);
    for (let P = 0; P < b.length; P += 1) b[P] = _.data[P * 4 + 3];
    return Nm(b, l, m, 8).map((P, k) => {
      const L = Mm(P, l);
      if (!L) return null;
      const F = Number(L.widthPx || 0), ee = P.maxY - P.minY + 1, z = Number(L.startX || 0), W = document.createElement("canvas");
      W.width = F, W.height = ee;
      const re = W.getContext("2d");
      if (!re) return null;
      const pe = re.createImageData(F, ee);
      return P.pixels.forEach(({ x: ae, y: ve }) => {
        const Ae = (ve * l + ae) * 4, He = (Number(ae || 0) - z + l) % l, Me = ((ve - P.minY) * F + He) * 4;
  ...
  function zi(r, o) {
    if (!r || !o) return null;
    const s = Oa(r), l = Pn(o, s.centerDir);
    if (!Number.isFinite(l) || l <= 1e-6) return null;
    const m = Pn(o, s.right) / l, g = Pn(o, s.up) / l, _ = m * s.cr + g * s.sr, b = -m * s.sr + g * s.cr;
    return {
  ...
  function Am(r, o, s) {
    ...
    return Cm(l, Math.max(80, Math.max(s.w, s.h) * 0.75)) ? l : [];
  }
  function Tm(r, o, s) {
  ...
  function Im() {
    ...
    return cm(A, o, r, { quality: s }) === !0 || (A.fillStyle = "rgba(255, 255, 255, 0.03)", A.fillRect(o.x, o.y, o.w, o.h)), A.restore(), A.save(), A.strokeStyle = "rgba(255, 255, 255, 0.12)", A.lineWidth = 1, A.strokeRect(o.x + 0.5, o.y + 0.5, o.w - 1, o.h - 1), A.restore(), !0;
  }
  function Em() {
    var x, N;
  ...
  function Dm() {
    u.mode === "frame" ? Im() : u.mode === "unwrap" ? Gp(!1) : Wp(!1), t === "cutout" && lm(), rm(), Em(), M.fovValue = `${Math.round(u.viewFov)}°`, Math.abs(Number(u.outputPreviewAnim || 0) - Number(u.outputPreviewAnimTo || 0)) < 1e-6 && $e(), U.hasPresentedFrame || (U.hasPresentedFrame = !0, $.style.opacity = "1"), t === "cutout" && M.cameraPreview && (M.cameraPreview.settled = U.pendingStableLayoutFrames <= 0 && U.hasPresentedFrame && u.mode !== "frame");
    const r = Vp();
  ...
  function Rm() {
    e.__panoLiveStateOverride = p, e.__panoLiveStateVersion = Number(e.__panoLiveStateVersion || 0) + 1, e.__panoLivePaintSurface = rp();
  }
  function ge(r = {}) {
    var b, x, N, P, k, L, F, ee, z, W;
    const o = !!r.localOnly, s = r.externalSync === !0, l = String(r.cause || ""), m = String(((b = u.interaction) == null ? void 0 : b.kind) || "");
    (!o || m === "view" || m === "pan_frame" || Lm() || !!((x = u.viewTween) != null && x.active) || l === "mode" || l === "frame_view" || l === "cutout_frame") && (U.backgroundDirty = !0), o && Ic() && (u.livePaintInteractionRevision += 1, U.backgroundDirty = !0), (!o || l === "selection" || l === "mode" || l === "cutout_frame") && (Ts(), La()), Rm(), s && ((P = (N = e.__panoDomPreview) == null ? void 0 : N.requestDraw) == null || P.call(N), (k = e.setDirtyCanvas) == null || k.call(e, !0, !1)), s && !o && ((F = (L = e.graph) == null ? void 0 : L.setDirtyCanvas) == null || F.call(L, !0, !0), (W = (z = (ee = wr) == null ? void 0 : ee.canvas) == null ? void 0 : z.setDirty) == null || W.call(z, !0, !0)), U.dirty = !0;
  }
  function cu() {
  ...
  function Bs(r = performance.now()) {
    ...
    if (U.running) {
      if (U.lastTickTs = r, u.outputPreviewAnim !== u.outputPreviewAnimTo) {
        const s = Math.max(1, Number(u.outputPreviewAnimDurationMs)), l = q((r - Number(u.outputPreviewAnimStartTs || 0)) / s, 0, 1), g = u.outputPreviewAnimTo > u.outputPreviewAnimFrom ? fx(l) : px(l);
      ...
      if ((o = u.viewTween) != null && o.active) {
        const s = u.viewTween, l = q((r - s.startTs) / s.durationMs, 0, 1), m = ux(l);
  ...
  function ut() {
    i || (u.historyController.commitActionGroup(JSON.stringify(Uf(p))), Ys());
  }
  function Us(r) {
    if (i) return;
    ...
    if (Ys(), !o) return;
    const s = JSON.parse(o);
    Object.keys(p).forEach((l) => delete p[l]), Object.assign(p, s), u.selectedId = t === "stickers" || t === "cutout" ? p.active.selected_sticker_id : p.active.selected_shot_id, u.selectedIds = u.selectedId ? [u.selectedId] : [], Sn(), tn(), ze(), gn(), ge({ cause: "cutout_frame" });
  }
  function uu() {
    var s, l;
  ...
  function tn() {
    ...
    const r = Jb({
      ...
      isActiveLassoTool: hp
    });
    if (Object.assign(M.paintDock, r), yp(), !r.visible) {
      we && (we.hidden = !0);
      return;
    }
  ...
  function ze() {
    ...
    if (t === "stickers" || t === "cutout") {
      ...
      t === "stickers" ? Gn().forEach((Ne, Le) => {
        var We, Ge;
        const Re = It(Ne) ? String(Ne.id || Or) : String(((Ge = (We = p.assets) == null ? void 0 : We[Ne.asset_id]) == null ? void 0 : Ge.name) || Ne.asset_id || Ne.id), Ve = `${Le + 1}. ${Re}${It(Ne) && Zr(Ne) ? " (hidden)" : ""}`;
        Z.push({ id: Ne.id, labelHtml: Oc({ item: Ne, label: Ve, kind: "image" }), item: Ne, kind: "image" });
      }) : Rc().forEach((Ne) => {
        Z.push({ id: Ne.item.id, labelHtml: Oc(Ne), item: Ne.item, kind: Ne.kind });
      });
      const ce = (g == null ? void 0 : g.id) || "", ye = Z.find((Ne) => Ne.id === ce) || Z[0];
      x = {
        label: "Selection",
        open: !1,
        disabled: Z.length <= 1,
        currentLabelHtml: ye.labelHtml,
        items: Z.map((Ne) => ({ id: Ne.id, labelHtml: Ne.labelHtml, active: Ne.id === ce }))
      };
    }
    const N = [], P = (Z, ce, ye, Ne, Le) => {
      const Re = q(Number(_[Z] || 0), ye, Ne);
      N.push({
        key: Z,
        label: ce,
        min: ye,
        ...
        value: Re,
        displayValue: bx(Re),
        fillPct: q((Re - ye) / Math.max(1e-6, Ne - ye) * 100, 0, 100),
        enabled: b && !i
      });
    }, k = [];
    ...
    const L = Array.isArray((Ae = (ve = p == null ? void 0 : p.painting) == null ? void 0 : ve.paint) == null ? void 0 : Ae.strokes) ? p.painting.paint.strokes.length : 0, F = Array.isArray((Me = (He = p == null ? void 0 : p.painting) == null ? void 0 : He.mask) == null ? void 0 : Me.strokes) ? p.painting.mask.strokes.length : 0, ee = Array.isArray(e == null ? void 0 : e.inputs) ? e.inputs.map((Z) => String((Z == null ? void 0 : Z.name) || "")) : [], z = qh(
      e,
      ee.includes("erp_image") ? ["erp_image", "bg_erp"] : ["bg_erp", "erp_image"]
    ), W = !!String((z == null ? void 0 : z.src) || "").trim() || ks("pano_input_images").length > 0, re = Array.isArray(Gn()) && Gn().length > 0 || L > 0, pe = F > 0, ae = [
  ...
  async function fu(r) {
    ...
    try {
      ...
      const g = (async () => {
        ...
        (Array.isArray(p.stickers) ? p.stickers : []).filter((N) => String((N == null ? void 0 : N.asset_id) || "") === o).length && (p.assets[o] = _, ni(), yt(), ze(), $e(), ge());
      })();
      uo.set(o, g);
      try {
        await g;
  ...
  async function Vm(r) {
    ...
    const s = String(o.id || ""), l = String(o.asset_id || ""), m = l ? Ut(((N = p.assets) == null ? void 0 : N[l]) || null) : null, g = Number(o.vFOV_deg || 0), _ = o.crop && typeof o.crop == "object" ? { ...o.crop } : null, b = yo("asset"), x = URL.createObjectURL(r);
    try {
      const P = await new Promise((L, F) => {
        const ee = new Image();
        ee.onload = () => L(ee), ee.onerror = () => F(new Error("image load failed")), ee.src = x;
      });
      Q.set(b, P), o.asset_id = b, o.vFOV_deg = Tr(
        Number(o.hFOV_deg || 30),
        Number(P.naturalWidth || P.width || 1),
        Number(P.naturalHeight || P.height || 1)
      ), o.crop = { x0: 0, y0: 0, x1: 1, y1: 1 }, Dt(), ut(), ze(), $e(), ge();
      const k = (async () => {
      ...
      const P = (Array.isArray(p.stickers) ? p.stickers : []).find((k) => String((k == null ? void 0 : k.id) || "") === s) || null;
      P && String(P.asset_id || "") === b && (l && m && (p.assets[l] = m), P.asset_id = l, P.vFOV_deg = g, P.crop = _ ? { ..._ } : null), Dt(), ze(), $e(), ge();
    } finally {
  ...
  async function jm() {
    ...
    for (const [l, m] of o)
      try {
        ...
        if (!g) continue;
        const _ = await fetch(g).then((k) => k.blob()), b = String(_.type || "image/png").split("/")[1] || "png", x = String((m == null ? void 0 : m.name) || `${l}.${b}`), N = new File([_], x, { type: _.type || "image/png" }), P = await Ds(N, x);
        p.assets[l] = {
          ...P,
  ...
  function zm() {
    ...
    )), g = Math.max(0.1, l / m), _ = q(Number(u.viewFov || 90), 1, 179), b = q(Math.min(42, _ * 0.42), 8, 96), x = q(yr * (2 * Math.atan(Math.tan(b * Tt * 0.5) / Math.max(0.1, g))), 6, 72), N = zh({
    ...
    p.shots = [N], Ar(N), Gs(), u.mode = "pano", ut(), yt(), ze(), $e(), ge({ cause: "cutout_frame" });
  }
  function $m() {
  ...
  async function Km(r) {
    ...
    if (!(!l.length && !(((g = u.interaction) == null ? void 0 : g.kind) === "draw" && ((_ = u.interaction) == null ? void 0 : _.layerKind) === o) || !await hu(
      `Clear ${s}`,
      ...
      l.length = 0, p.painting.raster_objects = en().filter((N) => String((N == null ? void 0 : N.layerKind) || "paint") !== o), o === "paint" && (zt().length = 0), Sn(), ut(), yt(), ze(), $e(), tn(), ge();
    }
  }
  function Gm() {
    if (i) return;
    ...
    o.id = yo("st"), o.yaw_deg = Vt((o.yaw_deg || 0) + 8), o.z_index = Fc(), p.stickers.push(o), p.active.selected_sticker_id = o.id, u.selectedId = o.id, u.selectedIds = [o.id], Dt(), ut(), yt(), $e(), ze(), ge();
  }
  function pu() {
    var s, l, m, g, _, b;
    if (i) return;
    ...
    if (!(!o && r.length === 0)) {
      if (r.length > 1) {
        const x = new Set(r.filter((k) => kt(k)).map((k) => String(k.actionGroupId || k.id || ""))), N = new Set(r.filter((k) => $t(k)).map((k) => At(k.rasterObjectId || k.id || ""))), P = new Set(r.filter(bt).map((k) => String(k.id || "")));
        x.size > 0 && (p.painting.paint.strokes = (Array.isArray((l = (s = p.painting) == null ? void 0 : s.paint) == null ? void 0 : l.strokes) ? p.painting.paint.strokes : []).filter((k) => !x.has(String((k == null ? void 0 : k.actionGroupId) || ""))), p.painting.groups = zt().filter((k) => !x.has(String((k == null ? void 0 : k.actionGroupId) || (k == null ? void 0 : k.id) || ""))), Sn()), N.size > 0 && (p.painting.raster_objects = en().filter((k) => !N.has(String((k == null ? void 0 : k.id) || ""))), ai()), P.size > 0 && (p.stickers = (Array.isArray(p.stickers) ? p.stickers : []).filter((k) => P.has(String((k == null ? void 0 : k.id) || "")) ? It(k) ? (Zr(k) || (k.visible = !1), !0) : !1 : !0), ni(), Dt()), u.selectedId = null, u.selectedIds = [], ut(), yt(), ze(), $e(), ge();
        return;
      }
      if (kt(o)) {
        const x = String(o.actionGroupId || o.id || "").trim();
        p.painting.paint.strokes = (Array.isArray((g = (m = p.painting) == null ? void 0 : m.paint) == null ? void 0 : g.strokes) ? p.painting.paint.strokes : []).filter((N) => String((N == null ? void 0 : N.actionGroupId) || "").trim() !== x), p.painting.groups = zt().filter((N) => String((N == null ? void 0 : N.actionGroupId) || (N == null ? void 0 : N.id) || "").trim() !== x), Sn(), u.selectedId = null, u.selectedIds = [], ut(), yt(), ze(), $e(), ge();
        return;
      }
      if ($t(o)) {
        const x = At(o.rasterObjectId || o.id || "");
        p.painting.raster_objects = en().filter((N) => String((N == null ? void 0 : N.id) || "").trim() !== x), ai(), u.selectedId = null, u.selectedIds = [], ut(), yt(), ze(), $e(), ge();
        return;
      }
      if (t === "stickers" || bt(o)) {
        if (It(o)) {
          if (Zr(o)) return;
          o.visible = !1, Dt(), ut(), yt(), ze(), $e(), ge();
          return;
        }
        p.stickers = p.stickers.filter((x) => x.id !== o.id), ni(), Dt(), u.selectedId = ((_ = p.stickers[0]) == null ? void 0 : _.id) || null, u.selectedIds = u.selectedId ? [u.selectedId] : [], p.active.selected_sticker_id = ((b = p.stickers[0]) == null ? void 0 : b.id) || null, ut(), yt(), ze(), $e(), ge();
        return;
      }
      $m();
    }
  ...
  function Wm(r, o) {
    ...
    m >= g !== l && ([m, g] = [g, m]);
    const _ = m / g, b = q(Number(r.hFOV_deg || 64), 1, 179), x = q(Number(r.vFOV_deg || 40), 1, 179), N = Math.sqrt(Math.max(1, b * x)), P = q(N * Math.sqrt(_), 1, 179), k = q(N / Math.sqrt(_), 1, 179);
  ...
  function Ym() {
    ...
    if (s.forEach((b) => {
      var N, P;
      const x = b.type === "sticker" ? `sticker:${String(((N = b.item) == null ? void 0 : N.id) || "")}` : b.type === "rasterObject" ? `rasterObject:${String(((P = b.item) == null ? void 0 : P.id) || b.id || "")}` : `strokeGroup:${String(b.actionGroupId || "")}`;
  ...
  function Zm() {
    i || (p.projection_model = "pinhole_rectilinear", p.alpha_mode = "straight", d && (p.output_preset = Yl(d.value, Number(p.output_preset || 2048))), h && (p.coverage = Ft(h.value)), v && (p.bg_color = String(v.value || p.bg_color || "#00ff00")), gn(), e.setDirtyCanvas(!0, !0));
  }
  function gn() {
    var o;
    if (i) return;
  ...
  function Ga() {
    p.ui_settings = Sx(p.ui_settings), i || gn();
  }
  function yt() {
    var r;
  ...
  function Qm(r = {}) {
    var l, m, g, _, b, x, N, P, k, L;
    const o = r.syncPreview !== !1, s = r.syncGraph !== !1;
    o && ((m = (l = e.__panoPreviewNodeRuntime) == null ? void 0 : l.requestDraw) == null || m.call(l), (_ = (g = e.__panoDomPreview) == null ? void 0 : g.requestDraw) == null || _.call(g), (b = e.setDirtyCanvas) == null || b.call(e, !0, !1)), s && ((N = (x = e.graph) == null ? void 0 : x.setDirtyCanvas) == null || N.call(x, !0, !0), (L = (k = (P = wr) == null ? void 0 : P.canvas) == null ? void 0 : k.setDirty) == null || L.call(k, !0, !0));
  }
  function Gs() {
  ...
  function Mn(r, o = performance.now()) {
    ...
    const s = Es(r.x, r.y), { lon: l, lat: m } = Os(s);
    return {
      targetKind: "ERP_GLOBAL",
  ...
  function eg(r, o) {
    ...
    const s = Ke(), l = Lt(s);
    if (!s || !l) return !1;
    const m = Math.max(0.1, Number(((N = u.frameView) == null ? void 0 : N.zoom) || 1)), g = q(m * Number(o), 0.25, 12);
  ...
  function vu() {
    return (u.primaryTool === "paint" || u.primaryTool === "mask") && (gu() || Ws());
  }
  function bu() {
    var r;
  ...
  function rg() {
    ...
    if (r.toolKind === "lasso_fill")
      o = Qo, s = Qo, l = "0", _ = "0", b = "none", P = sx, k = lx, g = gx(r.fillStyle, N, x);
    ...
    oe.style.display = "block", oe.style.width = `${Math.round(o)}px`, oe.style.height = `${Math.round(s)}px`, oe.style.borderRadius = l, oe.style.border = _, oe.style.boxShadow = b, oe.style.background = g, oe.style.backgroundRepeat = "no-repeat", oe.style.backgroundPosition = "center", oe.style.backgroundSize = "contain", oe.style.transform = `translate(${Math.round(r.x - P)}px, ${Math.round(r.y - k)}px) rotate(${m}deg)`;
  }
  function ig() {
    var pe;
    if (!ie || !xe) return;
    ...
    const s = pr(o), l = nn[s] || nn[Xn], m = Number(u.brushSizes[s] ?? 10), g = Math.max(1, m) * Math.max(0.1, Number(l.sizeScale ?? 1)), _ = Math.max(6, g * 0.5), b = o === "eraser", x = r === "mask" ? { r: 34 / 255, g: 197 / 255, b: 94 / 255, a: 0.82 } : b ? { r: 1, g: 1, b: 1, a: 0.22 } : fn(u.paintColor), N = r === "mask" ? Dn(x, 0.22) : b ? "rgba(255,255,255,0.14)" : Dn(x, q(Math.max(0.18, Number(x.a ?? 1) * 0.34), 0.18, 0.56)), P = r === "mask" ? Dn(x, 0.96) : b ? "rgba(255,255,255,0.72)" : Dn(x, q(Math.max(0.56, Number(x.a ?? 1) * 0.96), 0.56, 1));
    ...
    } else o === "brush" ? z = `radial-gradient(circle at 50% 50%, ${P} 0%, ${N} 48%, rgba(0,0,0,0) 100%)` : o === "lasso_fill" ? (k = Math.max(18, _ * 1.8), L = k, z = `radial-gradient(circle at 50% 50%, rgba(0,0,0,0) 42%, ${P} 43%, ${P} 58%, rgba(0,0,0,0) 59%)`) : b && (z = "rgba(255,255,255,0.12)");
  ...
  function yu(r, o, s, l) {
    const m = pr(o), g = nn[m] || nn[Xn], _ = u.brushSizes[m] ?? 10, b = Math.max(1, _) * Math.max(0.1, g.sizeScale ?? 1), x = tg(l, b), N = s.map((k) => ({
      ...k,
    ...
    return Ff(P, g), Number(g.aspect ?? 1), Number(P.aspect ?? 1), String(P.stampKind || ""), Number(P.size || 0), String(P.radiusModel || ""), Number(P.radiusValue || 0), { ...P.targetSpace }, P;
  }
  function ag(r, o, s, l) {
    const m = s.map((x) => ({
      ...x,
  ...
  function og(r, o, s = performance.now()) {
    ...
    if (u.mode === "frame") {
      const N = Ke();
      if (!N || (l = kn(o, N, s), !l)) return !1;
    } else
      l = Mn(o, s);
    if (!l) return !1;
    const m = r.stroke.geometry.rawPoints || r.stroke.geometry.points, g = r.stroke.geometry.points, _ = m[m.length - 1];
    if (_) {
      const N = Math.abs(Number(l.u ?? l.x ?? 0) - Number(_.u ?? _.x ?? 0)), P = Math.abs(Number(l.v ?? l.y ?? 0) - Number(_.v ?? _.y ?? 0));
      if (N < 15e-4 && P < 15e-4) return !1;
    }
    const b = {
      ...l,
  ...
  function sg(r, o, s = performance.now()) {
    ...
    if (g) {
      const x = Math.abs(Number(l.u ?? l.x ?? 0) - Number(g.u ?? g.x ?? 0)), N = Math.abs(Number(l.v ?? l.y ?? 0) - Number(g.v ?? g.y ?? 0));
  ...
  function lg(r) {
    ...
    Ba();
    const s = Nn(), l = Hi(s.width, s.height);
    ...
    let N = !1, P = qr().reduce((Z, ce) => Math.max(Z, Number((ce == null ? void 0 : ce.z_index) || 0)), -1) + 1;
    function k(Z, ce, ye, Ne = 8) {
      let Le = ce, Re = ye, Ve = -1, We = -1;
      for (let Ge = 0; Ge < ye; Ge += 1)
        for (let Ye = 0; Ye < ce; Ye += 1)
          Z[(Ge * ce + Ye) * 4 + 3] <= Ne || (Ye < Le && (Le = Ye), Ge < Re && (Re = Ge), Ye > Ve && (Ve = Ye), Ge > We && (We = Ge));
      return Ve < Le || We < Re ? null : { minX: Le, minY: Re, maxX: Ve, maxY: We };
    }
    ...
    function ee(Z, ce) {
      ...
      if (!ye) return null;
      const Ne = ye.centerUv.u - ye.halfW, Le = ye.centerUv.u + ye.halfW, Re = ye.centerUv.v - ye.halfH, Ve = ye.centerUv.v + ye.halfH, We = s.width, Ge = s.height;
      return {
        minX: Math.floor((Ne % 1 + 1) % 1 * We),
        maxX: Math.ceil((Le % 1 + 1) % 1 * We),
        minY: Math.floor(q(Re, 0, 1) * Ge),
        maxY: Math.ceil(q(Ve, 0, 1) * Ge),
        wraps: Le - Ne >= 1 || Ne < 0 || Le > 1
      };
    }
    function z(Z) {
      const ce = (Z == null ? void 0 : Z.bbox) || null;
      if (!ce) return null;
      const ye = (Z == null ? void 0 : Z.transform) || {}, Ne = s.width, Le = s.height, Re = Number(ce.u0 || 0) + Number(ye.du || 0), Ve = Number(ce.u1 || 0) + Number(ye.du || 0), We = Number(ce.v0 || 0) + Number(ye.dv || 0), Ge = Number(ce.v1 || 0) + Number(ye.dv || 0);
      return {
        minX: Math.floor((Re % 1 + 1) % 1 * Ne),
        maxX: Math.ceil((Ve % 1 + 1) % 1 * Ne),
        minY: Math.floor(q(We, 0, 1) * Le),
        maxY: Math.ceil(q(Ge, 0, 1) * Le),
        wraps: Ve - Re >= 1 || Re < 0 || Ve > 1
      };
    }
    function W(Z) {
    ...
    function re(Z) {
      ...
      const Ne = ce.ctx.getImageData(0, 0, s.width, s.height);
      for (let Le = 0; Le < s.width * s.height; Le += 1) {
        if (m[Le * 4 + 3] <= 8) continue;
        const Ve = ye.data[Le * 4 + 3], We = Ne.data[Le * 4 + 3];
        if (Ve > We)
    ...
    function pe(Z, ce, ye) {
      const Ne = Number(ye == null ? void 0 : ye.z_index), Le = km(Z, ce, ye).map((Re, Ve) => ({
        ...Re,
        z_index: Number.isFinite(Ne) ? Ne + Ve * 1e-3 : P + Ve * 1e-3
      }));
      return Le.length && (P = Math.max(P, ...Le.map((Re) => Number((Re == null ? void 0 : Re.z_index) || 0))) + 1), Le;
    }
    for (const Z of zt()) {
      ...
      const Ne = ((He = (Ae = u.paintEngine) == null ? void 0 : Ae.getGroupTarget) == null ? void 0 : He.call(Ae, ce)) || null, Le = ((Me = Ne == null ? void 0 : Ne.committedPaint) == null ? void 0 : Me.canvas) || null;
      if (!Le) {
        b.push(Z), _.push(...ye);
        continue;
      }
      ...
      N = !0;
      const Ve = pe(Re.canvas, "paint", g.get(ce) || Z || {});
      x.push(...Ve);
    }
  ...
  function cg(r) {
    var _, b, x, N, P;
    if ((((b = (_ = r.stroke) == null ? void 0 : _.geometry) == null ? void 0 : b.rawPoints) || ((N = (x = r.stroke) == null ? void 0 : x.geometry) == null ? void 0 : N.points) || []).length >= 1) {
      _u(r);
      const k = Nn();
    ...
    const s = r.stroke, l = { kind: "ERP_GLOBAL", viewMode: String(u.mode || "frame") }, m = yu(r.layerKind, s.toolKind, [], l);
  ...
  function _u(r) {
    ...
    if (r.layerKind === "paint" && s === "eraser")
      return o.geometryKind !== "lasso_fill" && (o.processedPoints = zs(o.rawPoints || o.points || [], r.stroke.targetSpace, !0)), lg(r);
    ...
    return m.length < 1 ? !1 : (o.processedPoints = zs(m, r.stroke.targetSpace, !0), l && Tc((x = r.stroke) == null ? void 0 : x.actionGroupId), si(r.layerKind).push(r.stroke), !0);
  }
  function xu(r) {
    var s;
    if (t === "cutout" && u.mode === "frame") {
      ...
      const _ = kn(r, l, performance.now()), b = _ ? ri(_) : null;
      if (b)
        for (const N of Hs()) {
          if (!bt(N)) continue;
          const P = zi(N, b);
      ...
      const x = xs(!1).slice().sort((N, P) => Number((P == null ? void 0 : P.z_index) || 0) - Number((N == null ? void 0 : N.z_index) || 0));
      for (const N of x) {
    ...
    const o = [
      ...xs(!1).slice().sort((l, m) => Number((m == null ? void 0 : m.z_index) || 0) - Number((l == null ? void 0 : l.z_index) || 0)).map((l) => {
        var m;
      ...
      if (kt(l)) {
        ...
        for (const b of _) {
          ...
          for (let P = 0; P < x.length - 1; P += 1)
            if (wl(r, x[P], x[P + 1]) <= N * N) return { item: l, geom: g };
          if (x.length === 1 && vr(r, x[0]) <= N * N) return { item: l, geom: g };
        }
        continue;
      }
      if ($t(l)) {
        const g = Et(l);
        if (!(g != null && g.visible)) continue;
        if (Wc(l, g, r)) return { item: l, geom: g };
        continue;
      }
      const m = Et(l);
  ...
  function fg(r, o) {
    ...
    if (o.corners.some((m) => ug(r, m))) return !0;
  ...
  function pt(r) {
    ...
    const o = lt(), s = o ? Et(o) : null, l = o ? cr(o) : !1, m = l ? { kind: "none", cursor: "default" } : qs(s, r);
    if (!l && m.kind !== "none") {
      te(m.cursor);
      return;
    }
    if (u.primaryTool === "cursor" && xu(r)) {
      te("default");
      return;
    }
  ...
  function $e() {
    ...
    const s = Da(), l = ty({
      ...
      isStickerHidden: Zr,
      canRestoreSelectedToInitial: vp,
      iconSet: Ot
    });
    if (!l.visible) {
      M.selectionMenu = { visible: !1, left: 0, top: 0, items: [] };
    ...
    M.selectionMenu = {
      ...
      let P = q((Number(((L = l.anchor) == null ? void 0 : L.minX) || 0) + Number(((F = l.anchor) == null ? void 0 : F.maxX) || 0)) * 0.5 - b * 0.5, N, T.width - b - N), k = Number(((ee = l.anchor) == null ? void 0 : ee.maxY) || 0) + 18;
      if (!Number.isFinite(P) || !Number.isFinite(k) || k + x > T.height - N) {
        M.selectionMenu.visible = !1;
        return;
      }
      M.selectionMenu.left = P, M.selectionMenu.top = k;
    });
  }
  function Xa() {
  ...
  function dg(r) {
    ...
    requestAnimationFrame(() => {
      ...
      const l = X.getBoundingClientRect(), m = s.getBoundingClientRect(), g = 8, _ = 12, b = Math.round(Number(((ee = ne.getBoundingClientRect()) == null ? void 0 : ee.width) || 0)) || 100, x = Math.round(Number(((z = ne.getBoundingClientRect()) == null ? void 0 : z.height) || 0)) || 24, N = !!s.closest(".pano-floating-left"), P = !!s.closest(".pano-paint-footer") || !!s.closest(".pano-paint-color-float");
  ...
  T.onpointerdown = (r) => {
    ...
    if (i) {
      if (u.mode === "pano") {
        const b = Wa(r);
        u.interaction = { kind: "view", last: b, lastTs: performance.now() }, Rt.startDrag(b.x, b.y, r.pointerId, performance.now()), pt(o), T.setPointerCapture(r.pointerId);
      }
      return;
    }
    if (we && !we.hidden)
      return;
    if ((u.primaryTool === "paint" || u.primaryTool === "mask") && (gu() || Ws())) {
      const b = u.primaryTool === "mask" ? "mask" : "paint", x = u.primaryTool === "mask" ? u.maskTool : u.paintTool, N = u.mode === "frame" && Ws() ? Ke() : null, P = { kind: "ERP_GLOBAL" }, k = N ? kn(o, N, performance.now()) : Mn(o, performance.now());
      u.interaction = {
        kind: x === "lasso_fill" ? "paint_lasso_fill" : "paint_stroke",
        layerKind: b,
        _livePreviewToken: di("live"),
        stroke: x === "lasso_fill" ? ag(b, x, [k], P) : yu(b, x, [k], P)
      }, Fi();
      const L = Nn();
      if (L)
      ...
      pt(o), T.setPointerCapture(r.pointerId), ge();
      return;
    }
    const s = wn(), l = lt(), m = s.length > 1 ? Ns(s) : l ? Et(l) : null;
    if (u.primaryTool === "cursor" && (r.ctrlKey || r.metaKey)) {
      u.interaction = { kind: "marquee_select", start: o, current: o }, pt(o), T.setPointerCapture(r.pointerId), ge({ localOnly: !0 });
      return;
    }
    if (s.length > 1 && (m != null && m.visible)) {
      if ((s.some((x) => cr(x)) ? { kind: "none" } : qs(m, o)).kind === "move") {
        u.interaction = {
          kind: "move_multi",
          items: s.map((x) => x),
          ...
          stickerSnapshots: s.filter((x) => bt(x)).map((x) => ({
            ...
            center: (() => {
              var P, k;
              const N = Et(x);
              return N != null && N.visible ? { x: Number(((P = N.center) == null ? void 0 : P.x) || 0), y: Number(((k = N.center) == null ? void 0 : k.y) || 0) } : { x: o.x, y: o.y };
            })()
          })),
      ...
      if (b.kind === "move") {
        if (kt(l)) {
          const x = u.mode === "frame" ? (() => {
            const N = Ke();
            return N ? kn(o, N, performance.now()) : null;
    ...
    if (g) {
      ...
      if (b && u.selectedId && (ut(), gn()), Ar(g.item), t === "cutout" && b && (u.cutoutAspectOpen = !1), b && ze(), $e(), ge(), cr(g.item)) {
        pt(o);
        return;
      }
      u.interaction = {
    ...
    if (_ && (ut(), gn()), ti(), _ && ze(), $e(), ge(), u.mode === "pano") {
      const b = Wa(r);
      u.interaction = { kind: "view", last: b, lastTs: performance.now() }, Rt.startDrag(b.x, b.y, r.pointerId, performance.now()), pt(o), T.setPointerCapture(r.pointerId);
    }
  }, T.onpointermove = (r) => {
    var l, m, g, _, b, x, N, P, k, L, F, ee, z, W, re, pe, ae, ve, Ae, He;
    const o = oi(r);
    ...
    if (s.kind === "paint_stroke") {
      ...
      Me.forEach((ce) => {
        const ye = oi(ce);
        if (u.mode === "frame") {
          const Ne = Ke(), Le = Ne ? Lt(Ne) : null;
          if (Le) {
            const Re = (ye.x - Le.x) / Math.max(1, Le.w), Ve = (ye.y - Le.y) / Math.max(1, Le.h);
            if (!(Re >= 0 && Re <= 1 && Ve >= 0 && Ve <= 1)) {
              s._outOfFrame = !0;
              return;
            }
            s._outOfFrame && (s._outOfFrame = !1, cg(s));
          }
        }
    ...
    if (s.kind === "move") {
      ...
      if (u.mode === "frame" && t === "cutout") {
        ...
        const ce = fr(), ye = q((Me - ce.x) / Math.max(ce.w, 1), 0, 1), Ne = q((Z - ce.y) / Math.max(ce.h, 1), 0, 1);
        s.item.yaw_deg = Vt(ye * 360 - 180), s.item.pitch_deg = q(90 - Ne * 180, -90, 90);
      } else {
        const ce = Es(Me, Z), ye = mo(ce);
    ...
    if (s.kind === "move_stroke_group") {
      ...
      const Z = mn(Number(Me.u || 0), Number(s.startUv.u || 0)), ce = Number(Me.v || 0) - Number(s.startUv.v || 0);
      Ec((l = s.item) == null ? void 0 : l.actionGroupId, Z, ce, s.snapshot, (m = s.item) == null ? void 0 : m.layerKind, s.frameSnapshot) && (Sn({ rebuildPaintEngine: !1 }), ge({ localOnly: !0 }));
      return;
    }
    if (s.kind === "move_raster_object") {
      ...
      if (!Me || !s.startUv) return;
      const Z = mn(Number(Me.u || 0), Number(s.startUv.u || 0)), ce = Number(Me.v || 0) - Number(s.startUv.v || 0);
      Lc(((g = s.item) == null ? void 0 : g.rasterObjectId) || ((_ = s.item) == null ? void 0 : _.id) || "", Z, ce, s.snapshot) && (ai(), ge({ localOnly: !0 }));
      return;
    }
    if (s.kind === "scale_raster_object") {
      const Z = Math.max(1, Math.hypot(o.x - s.center.x, o.y - s.center.y)) / Math.max(1, Number(s.startDist || 1));
      ap(((b = s.item) == null ? void 0 : b.rasterObjectId) || ((x = s.item) == null ? void 0 : x.id) || "", Z, s.snapshot) && (ai(), ge({ localOnly: !0 }));
      return;
    }
    if (s.kind === "move_multi") {
      const Me = o.x - Number(((N = s.offset) == null ? void 0 : N.x) || 0), Z = o.y - Number(((P = s.offset) == null ? void 0 : P.y) || 0);
      let ce = !1, ye = !1, Ne = !1;
      const Le = Me - Number(((k = s.startCenter) == null ? void 0 : k.x) || Me), Re = Z - Number(((L = s.startCenter) == null ? void 0 : L.y) || Z);
      for (const Ve of Array.isArray(s.stickerSnapshots) ? s.stickerSnapshots : []) {
        const We = (t === "cutout" ? ws() : Gn()).find((Ye) => String((Ye == null ? void 0 : Ye.id) || "") === String(Ve.id || ""));
        if (!We || !bt(We)) continue;
        const Ge = {
          x: Number(((F = Ve.center) == null ? void 0 : F.x) || 0) + Le,
          y: Number(((ee = Ve.center) == null ? void 0 : ee.y) || 0) + Re
        };
        if (u.mode === "frame" && t === "cutout") {
          const Ye = Ke(), St = Lt(Ye);
          if (!Ye || !St) continue;
          const Er = {
          ...
          if (!Ou) continue;
          const Fu = mo(Ou);
          We.yaw_deg = Fu.yaw, We.pitch_deg = Fu.pitch;
        } else if (u.mode === "unwrap") {
          const Ye = fr(), St = q((Ge.x - Ye.x) / Math.max(Ye.w, 1), 0, 1), Er = q((Ge.y - Ye.y) / Math.max(Ye.h, 1), 0, 1);
          We.yaw_deg = Vt(St * 360 - 180), We.pitch_deg = q(90 - Er * 180, -90, 90);
        } else {
          const Ye = Es(Ge.x, Ge.y), St = mo(Ye);
          We.yaw_deg = St.yaw, We.pitch_deg = St.pitch;
        }
        ce = !0;
      }
      for (const Ve of Array.isArray(s.strokeSnapshots) ? s.strokeSnapshots : []) {
        const We = {
          x: Number(((z = Ve.center) == null ? void 0 : z.x) || 0) + Le,
          y: Number(((W = Ve.center) == null ? void 0 : W.y) || 0) + Re
        }, Ge = u.mode === "frame" ? (() => {
          const St = Ke();
          return St ? kn(We, St, performance.now()) : null;
        })() : Mn(We, performance.now()), Ye = Ve.centerUv || null;
        if (Ge && Ye) {
          const St = mn(Number(Ge.u || 0), Number(Ye.u || 0)), Er = Number(Ge.v || 0) - Number(Ye.v || 0);
          Ec(Ve.id, St, Er, Ve.snapshot, Ve.layerKind, Ve.frameSnapshot) && (ce = !0, ye = !0);
        }
      }
      for (const Ve of Array.isArray(s.rasterSnapshots) ? s.rasterSnapshots : []) {
        const We = {
          x: Number(((re = Ve.center) == null ? void 0 : re.x) || 0) + Le,
          y: Number(((pe = Ve.center) == null ? void 0 : pe.y) || 0) + Re
        }, Ge = u.mode === "frame" ? (() => {
          const St = Ke();
          return St ? kn(We, St, performance.now()) : null;
        })() : Mn(We, performance.now()), Ye = Ve.centerUv || null;
        if (Ge && Ye) {
          const St = mn(Number(Ge.u || 0), Number(Ye.u || 0)), Er = Number(Ge.v || 0) - Number(Ye.v || 0);
          Lc(Ve.id, St, Er, Ve.snapshot) && (ce = !0, Ne = !0);
        }
      }
      ce && (ye ? Sn({ rebuildPaintEngine: !1 }) : Ne ? ai() : Dt(), ge({ localOnly: !0 }));
      return;
    }
    if (s.kind === "scale_stroke_group") {
      const Z = Math.max(1, Math.hypot(o.x - s.center.x, o.y - s.center.y)) / Math.max(1, Number(s.startDist || 1));
      Dc((ae = s.item) == null ? void 0 : ae.actionGroupId, Z, 0, s.snapshot, (ve = s.item) == null ? void 0 : ve.layerKind, s.frameSnapshot) && (Sn({ rebuildPaintEngine: !1 }), ge({ localOnly: !0 }));
      return;
    }
    if (s.kind === "rotate_stroke_group") {
      let Me = (Math.atan2(o.y - s.center.y, o.x - s.center.x) - Number(s.startAng || 0)) * yr;
      r.shiftKey && (Me = Math.round(Me / 45) * 45), Dc((Ae = s.item) == null ? void 0 : Ae.actionGroupId, 1, Me, s.snapshot, (He = s.item) == null ? void 0 : He.layerKind, s.frameSnapshot) && (Sn({ rebuildPaintEngine: !1 }), ge({ localOnly: !0 }));
      return;
    }
    ...
    if (s.kind === "scale") {
      ...
      s.item.hFOV_deg = q(s.startHFOV * Z, 1, 179), s.item.vFOV_deg = q(s.startVFOV * Z, 1, 179), s.item.aspect_id = Hr(s.item), bt(s.item) && Dt(), ge({ localOnly: !0 });
      return;
    }
    if (s.kind === "scale_x") {
      const Z = Math.max(1, Math.hypot(o.x - s.center.x, o.y - s.center.y)) / s.startDist;
      s.item.hFOV_deg = q(s.startHFOV * Z, 1, 179), s.item.aspect_id = Hr(s.item), bt(s.item) && Dt(), ge({ localOnly: !0 });
      return;
    }
    if (s.kind === "scale_y") {
      const Z = Math.max(1, Math.hypot(o.x - s.center.x, o.y - s.center.y)) / s.startDist;
      s.item.vFOV_deg = q(s.startVFOV * Z, 1, 179), s.item.aspect_id = Hr(s.item), bt(s.item) && Dt(), ge({ localOnly: !0 });
      return;
    }
    if (s.kind === "rotate") {
    ...
    if (((o = u.interaction) == null ? void 0 : o.kind) === "paint_stroke" || ((s = u.interaction) == null ? void 0 : s.kind) === "paint_lasso_fill") {
      Fi();
      const b = _u(u.interaction), x = !!u.interaction._hasCommittedSegments;
      if (b || x) {
        Sn();
        const N = String(((l = u.interaction.stroke) == null ? void 0 : l.actionGroupId) || "").trim();
        if (N) {
          const k = zt().find((L) => String((L == null ? void 0 : L.actionGroupId) || "") === N);
          k && (k.frame = null);
        }
        const P = Nn();
        P && (b ? String(((m = u.interaction.stroke) == null ? void 0 : m.toolKind) || "") === "eraser" ? (u.paintEngine.cancelActiveStroke(P), au()) : u.paintEngine.commitActiveStroke(u.interaction.stroke, P) : u.paintEngine.cancelActiveStroke(P)), ut(), gn(), ze(), $e(), e.setDirtyCanvas(!0, !0), ge();
      } else {
        const N = Nn();
        N && u.paintEngine.cancelActiveStroke(N);
      }
    } else if (((g = u.interaction) == null ? void 0 : g.kind) === "marquee_select") {
      const b = wu(u.interaction.start, u.interaction.current), N = [
        ...t === "cutout" ? Hs().filter((P) => !un(P)) : [...Gn()],
        ...tp(),
        ...np()
      ].filter((P) => fg(b, Et(P)));
      cp(N, ((_ = N[N.length - 1]) == null ? void 0 : _.id) || null), t === "cutout" && N.length && (u.cutoutAspectOpen = !1), ze(), $e(), ge();
    } else if (u.interaction && u.interaction.kind !== "view" && u.interaction.kind !== "pan_frame") {
      let b = !1;
      (u.interaction.kind === "move_stroke_group" || u.interaction.kind === "scale_stroke_group" || u.interaction.kind === "rotate_stroke_group") && (b = !0), (u.interaction.kind === "move_raster_object" || u.interaction.kind === "scale_raster_object") && (b = !0), u.interaction.kind === "move_multi" && Array.isArray(u.interaction.strokeSnapshots) && u.interaction.strokeSnapshots.length && (b = !0), u.interaction.kind === "move_multi" && Array.isArray(u.interaction.rasterSnapshots) && u.interaction.rasterSnapshots.length && (b = !0), b && (["move_stroke_group", "scale_stroke_group", "rotate_stroke_group"].includes(u.interaction.kind) || u.interaction.kind === "move_multi" && Array.isArray(u.interaction.strokeSnapshots) && u.interaction.strokeSnapshots.length ? Sn({ rebuildPaintEngine: !0 }) : ai()), ut(), gn(), e.setDirtyCanvas(!0, !0), Ks(), u.hqFrames = 1, $e(), ge();
    }
    u.interaction = null, Fi(), r && r.kind === "view" && Rt.endDrag(performance.now()), La(), $e(), pt(u.pointerPos), ge();
  }, T.onpointercancel = () => {
    var r, o, s;
    ...
    u.interaction = null, Fi(), La(), pt(u.pointerPos), ge({ localOnly: !0 });
  }, T.onauxclick = (r) => {
    ...
    if (u.mode === "frame") {
      ...
      eg(o, s) && ge({ localOnly: !0 }), r.preventDefault();
      return;
    }
    ...
    const s = Array.from(((l = r.dataTransfer) == null ? void 0 : l.files) || []).find((m) => Ka(m));
    s && fu(s);
  };
  const Su = (r) => {
  ...
  window.addEventListener("dragenter", Su, !0), window.addEventListener("dragover", Nu, !0), window.addEventListener("dragleave", Mu, !0), window.addEventListener("drop", ku, !0);
  function Ys() {
  ...
  fe == null || fe.addEventListener("click", async (r) => {
    ...
    if (s === "coverage-set") {
      ...
      p.coverage = L, u.coverage = L, h && (h.value = String(L)), c ? U.backgroundDirty = !0 : (gn(), Qm({
    ...
    if (s === "select-picker-item") {
      ...
      let F = null;
      L && (t === "stickers" ? F = Gn().find((ee) => String((ee == null ? void 0 : ee.id) || "") === L) || null : F = ((g = Rc().find((ee) => {
        var z;
    ...
    if (s === "copy-state-inline") {
      ...
      const ee = JSON.stringify(t === "cutout" && F !== "image" ? Bc(L) : wp(L));
      try {
    ...
    if (s === "set-invert-x") {
      p.ui_settings.invert_view_x = o.getAttribute("data-value") === "1", Ga(), ze(), (b = e.setDirtyCanvas) == null || b.call(e, !0, !0), ge();
      return;
    }
    if (s === "set-invert-y") {
      p.ui_settings.invert_view_y = o.getAttribute("data-value") === "1", Ga(), ze(), (x = e.setDirtyCanvas) == null || x.call(e, !0, !0), ge();
      return;
    }
    ...
    if (s === "set-quality") {
      ...
      p.ui_settings.preview_quality = L === "draft" || L === "high" ? L : "balanced", Ga(), ze(), (P = e.setDirtyCanvas) == null || P.call(e, !0, !0), ge();
      return;
    }
    if (s === "ui-reset-defaults") {
      p.ui_settings.invert_view_x = !1, p.ui_settings.invert_view_y = !1, p.ui_settings.preview_quality = "balanced", Ga(), ze(), (k = e.setDirtyCanvas) == null || k.call(e, !0, !0), ge();
      return;
    }
    if (s === "close-preview") {
      ci();
    ...
    o && Pu(String(o.getAttribute("data-param-key") || ""), o.value, !1);
  }), fe == null || fe.addEventListener("change", (r) => {
    const o = r.target.closest("[data-action='param-input']");
    o && Pu(String(o.getAttribute("data-param-key") || ""), o.value, !0);
  });
  const Xs = () => {
    const r = !!u.showGrid;
  ...
  Xs(), I.addEventListener("click", (r) => {
    ...
    if (s && !i) {
      ...
      if (s.matches("[data-tool-ui-action]")) {
        ...
        k === "undo" ? Us(-1) : k === "redo" ? Us(1) : k === "clear" ? Um() : k === "add" || k === "add-image" ? Fm() : k === "add-or-look" && zm();
        return;
      }
    ...
    if (!i) {
      ...
      if (l === "aspect-set") {
        ...
        Wm(k, L), u.cutoutAspectOpen = !1, u.menuSize.measured = !1, Ks(), ut(), yt(), $e(), ge();
        return;
      }
      if (l === "rotate-90") {
        const k = lt();
        if (!k) return;
        qm(k), u.cutoutAspectOpen = !1, u.menuSize.measured = !1, Ks(), ut(), yt(), $e(), ge();
        return;
      }
      if (l === "bring-front") {
        Ym();
    ...
    if (l === "toggle-grid") {
      u.showGrid = !u.showGrid, Mx(e == null ? void 0 : e.id, u.showGrid), Xs(), ge();
      return;
    }
    if (l === "toggle-fullscreen") {
      r.preventDefault(), r.stopPropagation(), mg();
      return;
    }
    if (l === "toggle-output-preview-size") {
      r.preventDefault(), r.stopPropagation();
      const k = !u.outputPreviewExpanded;
      u.outputPreviewExpanded = k, u.outputPreviewAnimFrom = u.outputPreviewAnim, u.outputPreviewAnimTo = k ? 1 : 0, u.outputPreviewAnimStartTs = performance.now(), Eu(), ge();
      return;
    }
    ...
    var l, m;
    const o = r.target.closest("[data-tip]");
    !o || J.target !== o || (r.relatedTarget instanceof Element ? (m = (l = r.relatedTarget).closest) == null ? void 0 : m.call(l, "[data-tip]") : null) === o || Xa();
  ...
  const hg = (r, o) => {
    var b;
    if (!Ee) return;
    const s = Ee.getBoundingClientRect(), l = q((r - s.left) / Math.max(1, s.width), 0, 1), m = 1 - q((o - s.top) / Math.max(1, s.height), 0, 1), g = Nl(u.customPaintColor), _ = { ...Sl(g.h, l, m), a: Number(((b = u.customPaintColor) == null ? void 0 : b.a) ?? 1) };
    u.customPaintColor = fn(_), u.paintColor = fn(_), tn();
  }, pg = (r) => {
    var g;
    if (!Ue) return;
    const o = Ue.getBoundingClientRect(), s = q((r - o.left) / Math.max(1, o.width), 0, 1), l = Nl(u.customPaintColor), m = { ...Sl(s, l.s, l.v), a: Number(((g = u.customPaintColor) == null ? void 0 : g.a) ?? 1) };
  ...
  Ee && (Ee.onpointerdown = (r) => {
    r.preventDefault(), r.stopPropagation(), Cu(r, (o) => hg(o.clientX, o.clientY));
  }), Ue && (Ue.onpointerdown = (r) => {
    r.preventDefault(), r.stopPropagation(), Cu(r, (o) => pg(o.clientX));
  ...
  const Au = () => {
    ...
    const o = !!r;
    u.fullscreen !== o && (u.fullscreen = o, I.classList.toggle("pano-modal-fullscreen", o), o ? (u.fullscreenPrevShowGrid = !!u.showGrid, u.showGrid = !1) : u.fullscreenPrevShowGrid !== null && (u.showGrid = !!u.fullscreenPrevShowGrid, u.fullscreenPrevShowGrid = null), Xs(), Au(), ge());
  }, Tu = () => document.fullscreenElement === D, mg = async () => {
    var r, o;
    try {
      ...
      Tu() ? await ((o = document.exitFullscreen) == null ? void 0 : o.call(document)) : await ((r = D.requestFullscreen) == null ? void 0 : r.call(D));
    } catch {
      Za(!u.fullscreen);
    }
  }, Iu = () => {
    document.fullscreenEnabled && Za(Tu());
  };
  document.addEventListener("fullscreenchange", Iu), Au();
  const Eu = () => {
  ...
  }, e.onConnectionsChange = el), i || zf.set(String(e.id ?? "0"), () => Xc());
  let li = null;
  const ci = async () => li || (li = (async () => {
    var r, o, s, l, m, g, _, b, x, N, P;
    return zf.delete(String(e.id ?? "0")), i || gn(), document.fullscreenElement === D && ((r = document.exitFullscreen) == null || r.call(document).catch(() => {
    })), document.removeEventListener("fullscreenchange", Iu), e.__panoLiveStateOverride = null, e.__panoLivePaintSurface = null, (s = (o = e.__panoDomPreview) == null ? void 0 : o.requestDraw) == null || s.call(o), (m = (l = e.graph) == null ? void 0 : l.setDirtyCanvas) == null || m.call(l, !0, !0), (b = (_ = (g = wr) == null ? void 0 : g.canvas) == null ? void 0 : _.setDirty) == null || b.call(_, !0, !0), Xa(), Om(), H instanceof HTMLVideoElement && H.pause(), ke.forEach((k) => {
      try {
        k();
      } catch {
      }
    }), (x = be == null ? void 0 : be.dispose) == null || x.call(be), (N = O == null ? void 0 : O.unmount) == null || N.call(O), (P = he == null ? void 0 : he.dispose) == null || P.call(he), Cr(!1), window.removeEventListener("keydown", Du, !0), window.removeEventListener("keydown", Lu, !0), window.removeEventListener("keydown", Ja, !0), window.removeEventListener("keyup", Ja, !0), window.removeEventListener("keydown", Ru, !0), window.removeEventListener("dragenter", Su, !0), window.removeEventListener("dragover", Nu, !0), window.removeEventListener("dragleave", Mu, !0), window.removeEventListener("drop", ku, !0), !i && t === "stickers" && (e.onExecuted === Qs && (e.onExecuted = Zs), e.onConnectionsChange === el && (e.onConnectionsChange = Js), e.__panoExternalStickerSync === tl && (e.__panoExternalStickerSync = null)), R.unmount(), V.remove(), Jm(), li = null, !0;
  })().catch((r) => (console.error("[PanoramaCutoutSync] closeEditor failed", r), li = null, !1)), li), Du = (r) => {
    var o, s, l, m;
    if (r.key === "Escape") {
    ...
    const { canUndo: g, canRedo: _ } = uu();
    r.shiftKey && !_ || !r.shiftKey && !g || (Us(r.shiftKey ? 1 : -1), r.preventDefault(), r.stopPropagation());
  };
  window.addEventListener("keydown", Du, !0), window.addEventListener("keydown", Lu, !0), window.addEventListener("keydown", Ja, !0), window.addEventListener("keyup", Ja, !0), window.addEventListener("keydown", Ru, !0), D.addEventListener("pointerdown", (r) => {
    r.target === D && ci();
  }), Mp(), !i && t === "stickers" && Uc("open"), jm(), ut(), Ys(), tn(), ze(), Ts(), ei(), cu(), pt(u.pointerPos), ge(), U.rafId = requestAnimationFrame(Bs);
}
function Wf(e, t, n, i) {
  ...
  function c(v) {
    ...
    a(v), n === "PanoramaStickers" && Ex(v), Ac(v), Lx(v, Jo);
    const w = vn(v, Jo);
    ...
    if (S && (S.value == null || String(S.value).trim() === "" || String(S.value).toLowerCase() === "#000000") && (S.value = "#00ff00", (C = S.callback) == null || C.call(S, "#00ff00")), n === "PanoramaStickers") {
...
function Gx(e) {
  ...
  const t = () => {
    ...
    Ac(e), ql(e, "Open Preview", () => pa(e, "stickers", { readOnly: !0, hideSidebar: !1 })), Ib(e, {
...
wr.registerExtension({
  ...
  beforeRegisterNodeDef(e, t) {
    ...
    (n === "PanoramaStickers" || n === "Panorama Stickers") && Wf(e, t, "PanoramaStickers", "Open Stickers Editor"), (n === "PanoramaCutout" || n === "Panorama Cutout") && Wf(e, t, "PanoramaCutout", "Open Cutout Editor"), zo(n) && Kx(e);
  },
  nodeCreated(e) {
